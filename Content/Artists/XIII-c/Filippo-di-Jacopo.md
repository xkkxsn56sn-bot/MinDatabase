---
layout: entry
title: "Filippo di Jacopo"
subtitle: "Florentine Duecento painter, tentatively identified with the Master of the Magdalene"
dates: "active c. 1265-1290; documented 1271"

meta:
  - title: Identity
    pairs:
      - label: Full name
        value: Filippo di Jacopo
      - label: Alternative identification
        value: Possibly identifiable with the Master of the Magdalene (Miklós Boskovits hypothesis)
      - label: Birth
        value: Unknown; likely Florence, probably late 1240s or early 1250s (inferred)
      - label: Death
        value: Unknown; possibly late 13th or early 14th century (inferred)
      - label: Nationality
        value: Italian (Florentine)
      - label: Active period
        value: c. 1265-1290 (inferred from stylistic chronology and documentary context)
      - label: Media
  ...
  - title: Documentary Record
    pairs:
      - label: Secure document
        value: Volterra, 1271 - co-tenant of a workshop with Grifo di Tancredi
      - label: Workshop context
        value: Bottega rented opposite the cathedral/canonical area in Volterra
      - label: Biographical limits
        value: No surviving testament, guild matriculation, or family archive

  - title: Patrons and Milieu
    list:
      - Florentine religious institutions with likely Franciscan devotional orientation
      - Ecclesiastical patrons in Volterra, possibly linked to the cathedral chapter
      - Lay devotional patrons in urban Tuscany (inferred from attributed Marian panel production)
      - Confraternal and mendicant contexts promoting penitential iconography

  - title: Key Works and Attributions
    list:
      - Penitent Magdalen with Eight Scenes from Her Life, c. 1280-1285, Galleria dell'Accademia, Florence (attributed under the Magdalene Master identification)
      - Madonna and Child Enthroned with Angels, Acton Collection, Florence (attributed)
      - Additional workshop production inferred through stylistic links with Grifo di Tancredi

  - title: Artistic Influences
    list:
      - Byzantine and Italo-Byzantine panel traditions in Florence and Pisa
      - Pisan sculptural classicism, especially the post-Nicola Pisano environment
      - Coppo di Marcovaldo and mid-Duecento Florentine monumental figuration
      - Franciscan devotional culture centered on affective penitential imagery

  - title: Style and Significance
    list:
      - Synthesis of hieratic Byzantine frontality and more animated narrative storytelling
      - Monumental devotional central figures with expressive lateral narrative episodes
      - Strong contour drawing, saturated chromatic range, and controlled tempera handling
      - Important role in shaping workshop language later visible in Grifo di Tancredi

  - title: Geographic Activity
    pairs:
      - label: Primary center
        value: Florence
      - label: Documented relocation
        value: Volterra (1271 workshop tenancy)
      - label: Probable radius
        value: Tuscany, with potential wider central Italian circulation through commissions

  - title: Related Entries
    links:
      - title: "Grifo di Tancredi"
        url: "/Content/Artists/XIII-c/Grifo-di-Tancredi.html"
      - title: "Maestro della Maddalena"
        url: "/Content/Artists/XIII-c/Maestro-della-Maddalena.html"
