...
subtitle: "Roman mosaicist and painter, principal author of the façade mosaic of Santa Maria Maggiore, Rome"
dates: "c. 1255 – c. 1325"
...
meta:
  ...
  - title: "ROLE"
    list:
      - "Roman mosaicist and painter"
      - "Pictor regis at the French court of Philip IV and successors"
      - "Principal author of the façade mosaic of Santa Maria Maggiore, Rome"
      - "Active in Rome, Assisi, France (Poitiers), and Naples"

  - title: "LOCATION"
    list:
      - "Rome (birthplace and principal early activity)"
      - "Assisi (early career, Upper Basilica of San Francesco)"
      - "Poitiers and France (c. 1304–1317, Capetian royal court)"
      - "Naples (c. 1319–1325, Angevin court)"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Rome, c. 1255 (precise date and family unattested)"
      - label: "Death"
        value: "c. 1325, possibly France (exact location unknown)"

  - title: "KEY WORKS"
    list:
      - "Façade mosaic (upper register: Enthroned Christ / Pantocrator), Basilica of Santa Maria Maggiore, Rome, c. 1294–1308"
      - "Madonna di San Luca (signed), Santa Maria del Popolo, Rome, c. 1297 (signature recovered in 2018 restoration)"
      - "Frescoes, Prophets, Santa Maria Donnaregina Vecchia, Naples, c. 1319–1320"
      - "Frescoes, Life of Christ, Brancacci Chapel, San Domenico Maggiore, Naples, c. 1320"
      - "Decoration of the Grande Salle, royal palace, Poitiers, c. 1308 (lost)"

  - title: "SIGNATURE"
    pairs:
      - label: "Santa Maria Maggiore mosaic"
        value: "PHILIPP(VS) RVSVTI FECIT HOC O(P)VS — inscribed beneath the enthroned Christ"
      - label: "Madonna di San Luca"
        value: "Signature recovered during 2018 restoration, Santa Maria del Popolo, Rome"

  - title: "ARTISTIC PROFILE"
    list:
      - "Mosaic technique: gold tesserae, varied angle and density for optical shimmer; deep blue celestial grounds"
      - "Monumental hieratic figures rooted in Byzantine Maiestas Domini tradition"
      - "Naturalistic drapery with gravitational fall exceeding standard Byzantine workshop production"
      - "Individual characterisation of faces and gestures beyond stereotyped physiognomic formulas"
      - "Narrative clarity in multi-figure lower-register scenes drawing on Assisi conventions"
      - "Late fresco work integrates Byzantine dignity with Cavallinian pathos and spatial recession"

  - title: "PATRONS"
    list:
      - "Cardinal Pietro Colonna — principal commissioner, Santa Maria Maggiore façade mosaic"
      - "Cardinal Giacomo (Jacopo) Colonna — co-commissioner, Santa Maria Maggiore; later archpresbyter of the basilica"
      - "Pope Nicholas IV (r. 1288–1292) — institutional sponsor of the Santa Maria Maggiore renovation programme"
      - "Philip IV of France (Philip the Fair) — appointed Rusuti and his son Giovanni as pictores regis, c. 1304"
      - "Louis X and Philip V of France — successors continuing the royal appointment"
      - "Angevin court of Naples — patron of the Donnaregina and Brancacci Chapel cycles"
      - "Brancacci family, Naples — patrons of the funerary chapel in San Domenico Maggiore"

  - title: "KEY PHASES"
    list:
      - "Formation in Rome within the late Duecento workshop tradition of Jacopo Torriti"
      - "Early Roman phase: Upper Basilica of San Francesco, Assisi (probable)"
      - "Mature Roman phase: façade mosaic of Santa Maria Maggiore (c. 1294–1308, interrupted by Colonna–Boniface VIII conflict)"
      - "Interruption: Colonna excommunication by Boniface VIII (1297); lower register suspended"
      - "Resumption: Giacomo Colonna restored as archpresbyter (1306); lower register completed"
      - "French phase: pictor regis, court of Philip IV and successors, Poitiers (c. 1304–1317)"
      - "Neapolitan phase: with Pietro Cavallini, Santa Maria Donnaregina Vecchia and San Domenico Maggiore (c. 1319–1325)"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Jacopo Torriti — master and probable trainer; gold-ground mosaic tradition and spatial programme"
      - "Byzantine tradition — Maiestas Domini, symmetrical angel hierarchies, gold tesserae theology"
      - "Early Christian mosaic cycles of Rome — fifth- and sixth-century patriarchal basilicas"
      - "Pietro Cavallini — Roman contemporary; naturalistic light and spatial recession in late fresco work"
      - "Upper Basilica of Assisi — Franciscan narrative mode, human emotion and biographical detail"
      - "Cosmati tradition — decorative and geometric framework, ornament–figure dialogue"
      - "Classical antiquity — drapery naturalism and sculptural grandeur via direct Roman exposure"
      - "French Gothic court style — elegance and linear refinement absorbed during the Capetian period"
      - "Roman renovatio of the late XIII century — broader movement toward classical recovery and naturalism"
  ...
  - title: "THEMATIC KEYWORDS"
    list:
      ...
      - "Byzantine tradition and proto-Renaissance naturalism"
      - "Façade mosaic programme"
      - "Late Duecento Roman school"

  - title: "RELATED ENTRIES"
    links:
      - title: "Jacopo Torriti"
        url: "/Content/Artists/XIII%20century/Jacopo-Torriti.md"
      - title: "Pietro Cavallini"
        url: "/Content/Artists/XIII%20century/Pietro-Cavallini.md"
      - title: "Cimabue"
...
This composition reflects the transition from the rigid Italo-Byzantine style toward a greater Roman naturalism, typical of Rusuti, a master also active in the mosaics of Santa Maria Maggiore.
 The panel, made of three walnut planks with chestnut crossbars, shows traces of a pre-existing adapted support, with nails perhaps for relics (milk and veils of the Virgin), and a preparatory layer reinforced during restoration to preserve the underlying drawing.
...
The mosaic extends over two registers, of which only the upper part is universally attributed to Rusuti, while the lower band features later extensions and additions, though these can still be traced back to his workshop.
The entire decoration, originally exposed to the open air on the exterior façade, was later partially obscured by the 18th-century loggia but is still visible today when ascending to the spaces behind it, where it retains its programmatic role as an iconographic proclamation of the basilica and its Marian foundation.
...
Directly beneath Christ’s feet, engraved within the frame of the clipeus, appears the artist’s signature: *Philippo Rusuti fecit hoc opus*, which identifies him as the creator of the entire central composition.
Four angels are arranged around the tondo: two at the top incensing Christ with censers, and two others in a more lateral position, acting as visual mediators between the observer and the sacred image, directing the gaze toward adoration.
