...
subtitle: Anonymous Sienese painter
dates: active c. 1215 – c. 1240
meta:
  - title: Identity
    pairs:
      - label: Name
        value: Anonymous — conventional *notname* established by Edward B. Garrison (1949)
      - label: Named after
        value: Church of Santa Maria a Tressa, Sienese contado
      - label: Born
        value: Unknown; presumably late XII century, Siena or surroundings
      - label: Died
        value: Unknown; presumably c. 1240–1250
      - label: Nationality
        value: Italian (Sienese)
      - label: Active period
        value: c. 1215 – c. 1240
      - label: Media
        value: Tempera and gold leaf on panel; pastiglia relief

  - title: Patrons
    list:
      - Cathedral Chapter of Siena — Opera del Duomo (Madonna dagli occhi grossi, c. 1225)
      - Benedictine or canonical community, Siena (Paliotto del Salvatore, 1215)
      - Church of Santa Maria a Tressa, Sienese contado (Madonna di Tressa, c. 1230–40)
      - Chigi Saracini noble family, Siena (Madonna and Child with Angels and Saints, c. 1240)
      - Confraternity or canonical community devoted to the cult of Saint John the Baptist (Storie di san Giovanni Battista, location unknown)

  - title: Key Works
    list:
      - Paliotto del Salvatore (Savior Blessing and Stories of the True Cross), 1215 — Pinacoteca Nazionale, Siena (98 × 198 cm)
      - Madonna dagli occhi grossi (Madonna with the Big Eyes), c. 1225 — Museo dell'Opera del Duomo, Siena (97 × 67 cm)
      - Madonna di Tressa, c. 1230–1240 — Museo Diocesano, Siena (75.5 × 56.5 cm)
      - Madonna and Child with Angels and Saints, c. 1240 — Chigi Saracini Collection, Siena (93 × 52 cm)
      - Two panels with Storie di san Giovanni Battista — location unknown

  - title: Artistic Influences
    list:
      - Byzantine art — frontal figures, hierarchical scaling, gold ground, linear drapery highlights, Hodegetria type
      - Central Italian Romanesque — material weight, sculptural drapery quality, robust corporeality
      - Roman Early Christian and Paleo-Christian art — Maiestas Domini iconography, mandorla tradition
      - Carolingian and Ottonian illuminated manuscripts — compositional models for multi-scene narrative panels
      - Roman late-twelfth-century altar panels (Lazio and Umbrian workshops) — multi-scene retable format
      - Berlinghiero Berlinghieri and Lucchese tradition — influence visible in the Madonna di Tressa

  - title: Innovations
    list:
      - Founding visual language of the Sienese school — earliest coherent pictorial personality in Duecento Siena
      - Systematic use of pastiglia three-dimensional relief technique for halos and crowns
      - Synthesis of Romanesque corporeality with Byzantine iconic conventions
      - Narrative multi-scene compositional format adapted to the Tuscan altarpiece tradition
      - Paliotto del Salvatore (1215) remains the oldest dated work of the Sienese school

  - title: Related Artists
    list:
      - Guido da Siena (principal successor in the Sienese school)
      - Duccio di Buoninsegna (indirect successor — inherits the Sienese Marian tradition)
      - Berlinghiero Berlinghieri (contemporary influence from Lucca)
      - Coppo di Marcovaldo (Florentine contemporary whose style later supplanted his)

  - title: Scholarly References
    list:
      - Edward B. Garrison — Italian Romanesque Panel Painting (1949); established the notname and core corpus
...
<figure>
  <img src="/Images/Maestro-Tressa/maestro-tressa-01.jpg" alt="The Savior Blessing and Stories of the True Cross">
...
<figure>
  <img src="/Images/Maestro-Tressa/maestro-tressa-02.jpg" alt="Madonna with the Big Eyes">
...
<figure>
  <img src="/Images/Maestro-Tressa/maestro-tressa-03.jpg" alt="Madonna di Tressa">
...
<figure>
  <img src="/Images/Maestro-Tressa/maestro-tressa-04.jpg" alt="Madonna and Child with Angels and Saints">
