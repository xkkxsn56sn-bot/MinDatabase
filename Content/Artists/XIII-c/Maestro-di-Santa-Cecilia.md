---
layout: entry
title: "Maestro di Santa Cecilia"
subtitle: "Anonymous Florentine painter of the early Trecento; principal figure of the transition from *maniera greca* to proto-naturalism"
dates: "Active c. 1290–1320, Florence"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Maestro di Santa Cecilia (Master of Saint Cecilia; conventional notname)"
      - label: "True identity"
        value: "Unknown; identification with Buonamico Buffalmacco (active 1315–1336) proposed but unproven"
      - label: "Primary role"
        value: "Panel painter and fresco painter"
      - label: "Training tradition"
        value: "Florentine; possible secondary formation in Rome in contact with Pietro Cavallini"
      - label: "Guild"
      ...
      - label: "Primary center"
        value: "Florence"
      - label: "Other documented sites"
        value: "Assisi (Upper Basilica of San Francesco); Rome (proposed, not confirmed)"
      - label: "Scholarly foundation"
        value: "Corpus defined by Richard Offner, A Critical and Historical Corpus of Florentine Painting, vol. I (1931)"

  - title: "IDENTITY AND BIOGRAPHICAL LIMITS"
    list:
      - "True name, birthplace, and dates entirely unknown; no surviving documentary record"
      - "Archival sources for Franciscan commissions at Assisi largely destroyed by Napoleonic troops c. 1800"
      - "Notname derived from the altarpiece of Santa Cecilia, Uffizi, Florence"
      - "Florentine origin established by stylistic and contextual evidence"
      - "Roman formation proposed by Parronchi (1939) and Gnudi (1959) on the basis of formal affinities with Pietro Cavallini"
      - "Identification with Buonamico Buffalmacco unverifiable from surviving documentation"
  ...
  - title: "CHRONOLOGY"
    pairs:
      - label: "Documented activity window"
        value: "c. 1290–1320"
      - label: "Namesake work"
        value: "Altarpiece of Santa Cecilia e storie della sua vita, datable shortly after 1304"
      - label: "Assisi frescoes"
        value: "Final three scenes of the Stories of Saint Francis cycle, Upper Basilica, c. late 1290s–early 1300s"
      - label: "Late panel"
        value: "Madonna and Child Enthroned with Saint Francis, Norton Simon Museum, c. 1315"
      - label: "Terminus post quem"
        value: "c. 1320; no further attributable works identified after this date"

  - title: "ARTISTIC PRACTICE"
    list:
      - "Panel painting in egg tempera over gessoed poplar wood support"
      - "Gold leaf applied by bole gilding and burnished to high reflective sheen"
      - "Dossal format: central enthroned figure flanked by paired hagiographic narrative scenes"
      - "Fresco painting in buon fresco at the Upper Basilica of San Francesco, Assisi"
      - "Workshop training apprentices and establishing a recognizable school of followers"
      - "Systematic underdrawing before paint application, consistent with Florentine workshop practice"

  - title: "STYLE"
    list:
      - "Intermediate pictorial zone between Byzantine hieratism and Giottesque naturalism"
      - "Cool, luminous palette: soft reds, pale blues, ivory whites, warm ochres"
      - "Crisp, clearly articulated drapery folds following underlying bodily form"
      - "Refined facial types: almond eyes, straight noses, mouths of precise tender definition; slightly melancholic sweetness"
      - "Compositional clarity and sequential narrative legibility in hagiographic scenes"
      - "Shallow stage-like architectural settings with pitched roofs and colored marble incrustation"
      - "Gold ground activating pictorial field as luminous transcendent space"

  - title: "ATTRIBUTED WORKS"
    list:
      - "Santa Cecilia e storie della sua vita, c. 1304–1310, tempera and gold on panel, 85 × 181 cm, Galleria degli Uffizi, Florence (namesake work)"
      - "Santa Margherita d'Antiochia e storie della sua vita, 1300s, 130 × 163 cm, Santa Margherita a Montici, Arcetri, Florence (in situ)"
      - "Stories of Saint Francis cycle (final three scenes on the left wall), Upper Basilica of San Francesco, Assisi (fresco, in situ)"
      - "Madonna and Child Enthroned with Saint Francis, c. 1315, Norton Simon Museum, Pasadena"
      - "Possible collaboration in the decoration of Santa Cecilia in Trastevere, Rome (with Pietro Cavallini; unconfirmed)"

  - title: "PATRONAGE CONTEXT"
    list:
      - "Church of Santa Cecilia, Florence: altarpiece for the high altar, probably commissioned by the parish canons or a lay donor confraternity"
      - "Church of Santa Margherita a Montici, Arcetri: modest suburban commission demonstrating reach beyond major urban centers"
      - "Upper Basilica of San Francesco, Assisi: Franciscan Order patronage; the most prestigious artistic commission in central Italy of the period"
      - "Franciscan devotional panel (Norton Simon Madonna) likely for a convent, confraternity, or lay patron with Franciscan affiliation"
      - "Hospital of Santa Cecilia in Trastevere, Rome (proposed)"

  - title: "GEOGRAPHY AND MOBILITY"
    pairs:
      - label: "Primary production center"
        value: "Florence"
      - label: "Documented extraFlorentine activity"
        value: "Assisi, Upper Basilica of San Francesco (scholarly consensus)"
      - label: "Proposed activity"
        value: "Rome; contact with Pietro Cavallini's workshop (proposed, unconfirmed)"
      - label: "Mobility evidence"
        value: "Physical presence at Assisi required for fresco campaign; travel along Florence–Umbria route implied"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Most important anonymous personality in early Trecento Florentine painting"
      - "Key intermediary figure between the Byzantine *maniera greca* and the new naturalism of Giotto"
      - "Participated in the decoration of the Upper Basilica of Assisi, the supreme Italian artistic enterprise of c. 1300"
      - "Founder of a recognizable school; formative influence on Bernardo Daddi (c. 1280–1348)"
      - "Systematic corpus definition by Richard Offner (1931) as a model for the criticism of anonymous medieval masters"

  - title: "THEMATIC KEYWORDS"
    list:
      - "Maestro di Santa Cecilia"
      - "Florentine early Trecento"
      - "Maniera greca"
      - "Proto-naturalism"
      - "Hagiographic altarpiece"
      - "Dossal format"
      - "Assisi Upper Basilica"
      - "Arte dei Medici e Speziali"
      - "Anonymous medieval master"
      - "Richard Offner corpus"
      - "Egg tempera gold ground panel painting"
