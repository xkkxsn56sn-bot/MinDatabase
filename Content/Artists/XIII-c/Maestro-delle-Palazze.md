---
layout: entry
title: "Maestro delle Palazze"
subtitle: "Anonymous Umbrian painter of the late Duecento"
dates: "active c. 1270s-1300"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Conventional name"
        value: "Maestro delle Palazze (anonymous master)"
      - label: "Identity"
        value: "Unidentified Italian painter, Umbrian school"
      - label: "Primary role"
        value: "Fresco painter of Christological and Marian cycles"
      - label: "Main area"
        value: "Spoleto and its environs (Umbria)"
      - label: "Active period"
        value: "Second half of the XIII century, with activity extending to around 1300"
      - label: "Media"
        value: "Wall fresco (later detached and transferred in part to canvas)"

  - title: "IDENTITY AND BIOGRAPHICAL LIMITS"
    list:
      - "No archival document preserves a personal name, patronymic, date of birth, or date of death"
      - "Conventional name derives from the monastery of Santa Maria inter Angelos, known locally as Le Palazze"
      - "Probably born in the first half of the XIII century, likely in the Spoleto area or broader Umbria"
      - "Family background, marital status, and descendants remain undocumented"
      - "Biography is reconstructed primarily through stylistic analysis and commission context"

  - title: "CHRONOLOGY"
    pairs:
      - label: "c. 1229-1232"
        value: "Foundation and settlement of the Clarissan community at Santa Maria inter Angelos, later principal context for the painter's cycle"
      - label: "c. 1270s-1280s"
        value: "Probable contact with Assisi visual culture, especially Cimabue-related innovations"
      - label: "c. 1290-1300"
        value: "Execution of the main fresco cycle associated with Le Palazze"
      - label: "1914"
        value: "Palazze frescoes recognized as of national interest by the Ministry of Public Instruction"
      - label: "1921"
        value: "Many frescoes detached and sold on the art market"
      - label: "1957"
        value: "Discovery of sinopie and additional remains in the Spoleto context"
      - label: "1982"
        value: "Commune of Spoleto acquires Derision of Christ and associated sinopie"

  - title: "PATRONAGE"
    list:
      - "Clarissan nuns of Santa Maria inter Angelos (Le Palazze), Monteluco near Spoleto"
      - "Franciscan-Clarissan devotional framework centered on Christ's Passion and on Saints Francis and Clare"
      - "Likely commissioning by abbess or senior monastic leadership for contemplative and liturgical use"
      - "Secondary urban ecclesiastical context in Spoleto, including Santi Giovanni e Paolo"
      - "Modern custodial patronage by the Comune di Spoleto and the Museo Nazionale del Ducato di Spoleto"

  - title: "PRINCIPAL WORKS"
    list:
      - "The Last Supper and Christ in the Garden of Gethsemane, c. 1290-1300, fresco transferred to canvas, Worcester Art Museum"
      - "Crucifixion, c. 1290-1300, fresco transferred to canvas, Worcester Art Museum"
      - "Madonna and Child with Saints Francis and Clare, c. 1290-1300, detached fresco, Museo Nazionale del Ducato di Spoleto"
      - "Derision of Christ, c. 1290-1300, detached fresco, Museo Nazionale del Ducato di Spoleto"
      - "Last Judgment, c. 1290-1300, detached fresco, Glencairn Museum"
      - "Annunciation, c. 1290-1300, detached fresco, Glencairn Museum"
      - "Fragments including Annunciation and Flagellation in the context of Santi Giovanni e Paolo, Spoleto"

  - title: "STYLE"
    list:
      - "Umbrian Duecento language rooted in Byzantine conventions and transformed by late XIII-century central Italian developments"
      - "Strong Cimabuesque accent with expressive narrative energy"
      - "Alternation between linear chrysography and emerging volumetric drapery treatment"
      - "Predominantly shallow pictorial space with careful rhythmic grouping of figures"
      - "Decorative emphasis in haloes, fabrics, and liturgical objects within emotionally charged Passion scenes"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Cimabue and the Assisi campaigns as the dominant formative horizon"
      - "The Maestro della Cattura current in the Upper Church at Assisi, especially for dramatic Passion scenes"
      - "Roman painting, especially Pietro Cavallini, in plastic treatment of drapery and faces"
      - "Local Umbrian duecento workshop tradition as the technical and iconographic base layer"

  - title: "GEOGRAPHIC RANGE"
    pairs:
      - label: "Primary base"
        value: "Spoleto and Monteluco (Santa Maria inter Angelos / Le Palazze)"
      - label: "Key artistic destination"
        value: "Assisi, likely visited for direct study of major fresco cycles"
      - label: "Possible secondary horizon"
        value: "Rome, or indirect Roman influence through central Italian workshop exchange"
      - label: "Documented local spread"
        value: "Monastic and urban ecclesiastical settings within the Spoleto area"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Major witness to late Duecento Umbrian painting between Byzantine inheritance and proto-naturalistic experiment"
      - "Key case for understanding Clarissan patronage and monastic image programs in central Italy"
      - "Important testimony to the dispersal and musealization of medieval fresco cycles in the twentieth century"
      - "Critical rediscovery and framing strongly shaped by postwar scholarship"
...
The *Maestro delle Palazze* is the conventional name assigned to an anonymous Italian painter of the Umbrian school, active in and around the city of Spoleto during the second half of the thirteenth century, with his known activity extending to the turn of the fourteenth century. Like many artists of his era, he left no documentary trace under a personal name; the sobriquet derives from the monastery of Santa Maria inter Angelos, located on the slopes of Monteluco outside Spoleto, whose Clarissan<a href="/endnotes.html#fn-chiara-assisi" class="footnote"><sup>1</sup></a> community was popularly known as *Le Palazze*, a nickname that became attached to the anonymous master through the medium of his most significant surviving cycle of frescoes.
...
The last in the row, at the very edge, turns almost completely inward, emphasizing how the event closes in on itself, holding within the apostolic group the drama that is about to spill over into the story of the Passion.
The abundance of round loaves, chalices, and jugs should not be read merely as a touch of domestic realism, but also as an emphasis on the sacramental signs of bread and wine, a foreshadowing of the Eucharistic rite that the nuns celebrated spiritually in their choir.
