...
<figure class="figure--right">
  <img src="/Images/Maestro-Consolo/maestro-consolo-02.jpg" alt="Sacro Speco at Subiaco">
...
The identification of these documentary "Consoli" with the painter himself was advanced by the scholar G. Salvi in a seminal 1960 article in the *Bollettino d'Arte*, who argued that the discrepancy between the archival spelling "Consulus" and the autograph inscription "Conxolus" on the fresco could be explained by the painter's own orthographic irregularity, while the notaries who drafted the documents transcribed the name in its more correct Latin form. This hypothesis, while widely discussed, has not been universally accepted, and the distinguished paleographer [Vincenzo Federici](/scholars.html#federici-vincenzo) preferred to read the archival form as "Console," a variant that further complicates the identification. 
...
Salvi debunked Federici’s error with a precise grammatical observation: Consulus belongs to the second Latin declension (like dominus), while Consul belongs to the third; the two forms could not and should not have been confused by an educated medieval notary. Thus, the “Benedictus Consuli” in the documents was “Benedetto son of Consulo”—not “Benedetto di Console.” Having established this correction, Salvi addressed the remaining discrepancy: the autograph reads Conxolus, while the notaries write Consulus. The proposed explanation is clear: the painter, less educated than the notaries who drafted the legal documents, signed his name incorrectly—the x instead of the s—while the notaries recorded the correct Latin form. “The painter wrote it wrong; the notaries, being more educated, wrote it right.

However, even the painter, in that incorrect spelling, intended to write Consulus. In fact, Conxolus can only correspond to Consulus.”
...
<figure>
  <img src="/Images/Maestro-Consolo/maestro-consolo-01.jpg" alt="Vergine e bambino tra due angeli - Sacro Speco, Subiaco">
...
<figure>
  <img src="/Images/Maestro-Consolo/maestro-consolo-03.jpg" alt="Miracle of the Servant - Sacro Speco, Subiaco">
...
<figure>
  <img src="/Images/Maestro-Consolo/maestro-consolo-04.jpg" alt="Bust of Pope Innocent III - Sacro Speco, Subiaco">
