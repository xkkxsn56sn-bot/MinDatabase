...
meta:
  - title: "CORE DATA"
    pairs:
      ...
      - label: "Primary roles"
        value: "Panel painters; makers of painted crucifixes and Marian dossals"
      - label: "Period"
        value: "Italian Duecento, Italo-Byzantine / late Comnenian matrix"
      - label: "Documented activity"
        value: "1230 (lost Ancona panel) to 1257 (Barberini crucifix), with activity likely through c. 1258"

  - title: "IDENTITY AND BIOGRAPHICAL LIMITS"
    list:
      - "No known surnames, family records, or securely documented personal biographies"
      - "No archival records for parents, marriage, guild membership, or exact dates of death"
  ...
  - title: "CHRONOLOGY"
    pairs:
      ...
      - label: "Earliest secure date"
        value: "1230 (signed panel for the Cathedral of San Ciriaco, Ancona; now lost)"
      - label: "Latest secure date"
        value: "1257 (signed and dated painted crucifix, Palazzo Barberini, Rome)"
  ...
  - title: "PRINCIPAL WORKS"
    list:
      - "Painted Crucifix, 1257, tempera on panel, Galleria Nazionale d'Arte Antica, Palazzo Barberini, Rome"
      - "Dossal with Madonna and Child Enthroned and Scenes from the Life of the Virgin, c. 1258, Museum Mayer van den Bergh, Antwerp"
      - "Madonna and Child Enthroned, c. 1270-75 (attributed), Museo dell'Opera del Duomo, Orvieto"
      - "Signed work for Ancona Cathedral, 1230 (lost; known through documentary testimony)"
...
The influence of the Sienese pictorial environment, particularly as filtered through the dossal tradition, is perceptible in the Antwerp panel, which [Millard Meiss](/scholars.html#meiss-millard) — the first modern scholar to study the work in detail, in a 1937 article in the *Burlington Magazine* — attributed on stylistic and iconographic grounds to the Sienese milieu before the discovery of the inscription that confirmed its Spoletine authorship. The possibility that the Spoletine painters had direct contact with the evolving Sienese tradition during the central decades of the thirteenth century is supported by the general pattern of artistic exchange between Umbria and Tuscany in this period, which saw considerable movement of painters, models, and pictorial ideas across the Apennine passes. The iconographic connections identified by Ada Labriola between the Antwerp dossal and the dossale of Margarito and [Restoro d'Arezzo](/Content/Artists/XIII-c/Restoro-di-Arezzo.html) in the church of Santa Maria delle Vertighe at Monte San Savino further suggest a network of reciprocal influence linking the Spoletine workshop to the Aretine and Sienese pictorial tradition.
