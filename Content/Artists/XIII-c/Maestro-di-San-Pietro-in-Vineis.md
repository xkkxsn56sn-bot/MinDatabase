...
subtitle: "Anonymous central Italian fresco master active in Anagni in the first half of the XIII century"
dates: "active c. 1225-1255 (attribution-based chronology)"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Maestro di San Pietro in Vineis (conventional notname)"
      - label: "Primary role"
        value: "Anonymous fresco painter in the Romano-Campanian orbit"
      - label: "Primary center"
        value: "Anagni (Lazio), with links to the cathedral and San Pietro in Vineis"
      - label: "Period"
        value: "XIII century"
      - label: "Documentary status"
        value: "Identity unknown; corpus defined by stylistic reconstruction and monument context"

  - title: "IDENTITY AND ATTRIBUTION"
    list:
      - "Notname derived from the church of San Pietro in Vineis, Anagni"
      - "No known contract or archival personal name securely linked to the painter"
      - "Connected by scholarship to the Anagni cathedral painting milieu"
      - "Sometimes discussed in relation to the so-called Third Master of Anagni"
      - "Attribution framework based on fresco technique, figure style, and narrative construction"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Activity range"
        value: "Generally placed in the first half of the XIII century"
      - label: "Main phase"
        value: "c. 1225-1255, corresponding to major artistic campaigns in Anagni"
      - label: "Historical context"
        value: "Pontifical age of Honorius III, Gregory IX, and Innocent IV"
      - label: "Chronology basis"
        value: "Stylistic comparison and monument-phase analysis rather than signed documents"

  - title: "FAMILY AND WORKSHOP CONTEXT"
    list:
      - "Likely trained in a workshop system typical of central Italy"
      - "Probable overlap with painters active in the Anagni cathedral crypt campaigns"
      - "Evidence of assistant participation in parts of the fresco execution"
      - "Possible ties to broader Roman and Campanian artisanal networks"

  - title: "PATRONAGE AND COMMISSIONS"
    list:
      - "Poor Clares community connected to San Pietro in Vineis"
      - "Ecclesiastical circles linked to Anagni cathedral"
      - "Patronage environment shaped by papal and episcopal presence in Anagni"
      - "Commission profile oriented toward Passion devotion and mendicant spirituality"

  - title: "ARTISTIC PRACTICE"
    list:
      - "Buon fresco execution with rapid intonaco-stage brush handling"
      - "Narrative wall painting cycles for liturgical and devotional spaces"
      - "Layered earth-pigment modeling with selective high-light accents"
      - "Compositions adapted to architectural viewing distance and chapel scale"
      - "Figural storytelling focused on emotional clarity in Passion episodes"

  - title: "STYLE"
    list:
      - "Romano-Campanian matrix with Byzantine inheritance"
      - "Greater bodily plasticity than strictly linear Italo-Byzantine formulas"
      - "Expressive physiognomy and affective gestures in narrative scenes"
      - "Warm palette: ochres, greens, cinnabar reds, azurite blues"
      - "Shallow spatial registers animated by strong dramatic rhythm"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Byzantine maniera greca"
      - "Roman monumental and early Christian visual traditions"
      - "Romano-Campanian mural conventions"
      - "Franciscan devotional emphasis on Christ's Passion"
      - "Encyclopedic theological-scientific imagery circulating in central Italian ecclesiastical culture"

  - title: "TRAVELS AND GEOGRAPHIC HORIZON"
    list:
      - "Core activity documented by works in Anagni"
      - "Possible contact with Roman artistic workshops"
      - "Possible southward links to Campanian monastic visual culture"
      - "No secure evidence of direct activity in Florence or Siena"

  - title: "KEY WORKS"
    list:
      - "Passion cycle, church of San Pietro in Vineis, Anagni"
      - "Deposizione nel Sepolcro (Deposition in the Tomb), c. 1255, fresco, San Pietro in Vineis"
      - "Kiss of Judas, c. 1255, fresco, San Pietro in Vineis"
      - "Related passages discussed in connection with the broader Anagni cathedral milieu"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Major witness to central Italian mural painting before Cimabue and Cavallini"
      - "Key figure in defining the expressive turn of mid-Duecento Passion imagery"
      - "Important case for attribution methodology in anonymous medieval art"
      - "Links papal-era Anagni patronage to broader transformations in Italian painting"
