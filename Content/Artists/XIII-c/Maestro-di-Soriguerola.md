---
layout: entry
title: Master of Soriguerola
subtitle: Anonymous Catalan Pyrenean painter linking Romanesque inheritance and early Gothic lineal language
dates: c. 1230 - active c. 1275-1320
meta:
  - title: Identity
    pairs:
      - label: Conventional name
        value: Master of Soriguerola (Maestro di Soriguerola)
      - label: Named after
        value: Altar panel from Sant Miquel de Soriguerola (Cerdanya)
      - label: Born
        value: c. 1230 (scholarly reconstruction), probably in the Cerdanya area
      - label: Died
        value: Unknown; activity likely extends into the early fourteenth century
      - label: Nationality
        value: Catalan (Crown of Aragon / Kingdom of Mallorca context)
      - label: Active period
        value: Late 13th century to early 14th century
      - label: Media
        value: Tempera on wood, painted/engraved metal leaf, gesso ground

  - title: Family and Workshop
    list:
      - No secure personal documents survive; identity remains anonymous
      - Production indicates a stable workshop with multiple hands and internal hierarchy
      - Workshop likely operated in the Cerdanya-Ripolles zone, possibly near Puigcerda
      - Stylistic continuity suggests transmission across at least one generation

  - title: Patrons and Commissions
    list:
      - Rural parishes of Cerdanya, Ripolles, and Conflent
      - Ecclesiastical institutions linked to monastic and episcopal networks (including Urgell sphere)
      - Sant Miquel de Soriguerola (eponymous commission context)
      - Sant Cristofol de Toses, Santa Eugenia de Saga, Sant Vicenc de La Llaguna, and Ribes Valley churches

  - title: Key Works
    list:
      - Altar Panel of Sant Miquel de Soriguerola (MNAC, Barcelona)
      - Altar Frontal of Sant Cristofol de Toses (MNAC, Barcelona)
      - Supplicant Soul between Saint Peter and Saint Paul (MNAC, from Ribes area)
      - Saint Michael Weighing Souls (MNAC / related Ribes panels at MEV, Vic)
      - Altar Frontal of Santa Eugenia de Saga (Musee des Arts Decoratifs, Paris)
      - Altar Frontal of Sant Vicenc de La Llaguna (attributed)

  - title: Style and Technique
    list:
      - Strong linear contour and compact, expressive figures
      - Flat chromatic fields (reds, yellows, greens) with decisive black outlines
      - Persistent Romanesque compositional order combined with early Gothic dynamism
      - Frequent use of psychostasia and intercessory eschatological iconography
      - Tempera layers over gesso on local fir/scots pine supports

  - title: Materials and Pigments
    pairs:
      - label: Wood support
        value: Primarily fir and Scots pine from Pyrenean zones
      - label: Main pigments
        value: Cinnabar, orpiment, carbon black, and local aerinite blues
      - label: Surface enrichment
        value: Painted and engraved metal leaf (often tin-based)

  - title: Artistic Influences
    list:
      - Catalan Romanesque wall and panel painting traditions
      - Byzantine-derived iconographic schemata transmitted in the western Mediterranean
      - Franco-Languedoc lineal Gothic currents crossing the Pyrenees
      - Mendicant devotional culture emphasizing legible narrative theology

  - title: Geography and Mobility
    pairs:
      - label: Core activity zone
        value: Cerdanya plain and adjacent Pyrenean valleys
      - label: Extended range
        value: Ripolles, Conflent, and Ribes Valley
      - label: Political frame
        value: Late 13th-century Crown of Aragon and Kingdom of Mallorca cross-Pyrenean networks

  - title: Historical Significance
    list:
      - Key transitional master between Catalan Romanesque and first Gothic linear formulations
      - Essential witness to the visual culture of small Pyrenean ecclesiastical communities
      - Central case study for workshop-based authorship in medieval Iberian painting

  - title: Documentary Status
    pairs:
      - label: Direct archival record
        value: No secure notarial identification of the master by personal name
      - label: Historiographic construction
        value: Corpus defined through stylistic comparison and regional provenance

scholars:
  - title: Joan Ainaud de Lasarte
    url: /scholars.html#ainaud-de-lasarte-joan
  - title: Chandler Rathfon Post
    url: /scholars.html#post-chandler-rathfon
  - title: Rosa Alcoy i Pedros
    url: /scholars.html#alcoy-rosa-i-pedros
---
...
The psychostasis<a href="/endnotes.html#fn-psychostasis" class="footnote"><sup>3</sup></a> as rendered by this master in the Soriguerola panel and in the Ribes lateral is one of the most theatrically compelling images in all of medieval Catalan art: the naked soul balanced in the scales, the hook-wielding demon attempting to drag the pan toward damnation, and the great archangel presiding over the scene with both authority and concern, his intervention subtly tipping the balance toward salvation.
...
It is part of a diptych: the other panel depicts Saint Michael weighing souls, emphasizing the iconographic link between judgment, intercession, and salvation.
...
The upper, wider band functions almost as a visual lintel and establishes a strong sense of horizontality that balances the verticality of the main figures. The result is a rigorously organized structure, where every element—from the repetition of the marginal motifs to the arrangement of the figures—contributes to guiding the gaze toward the center, that is, toward the soul, the true theological and spiritual focus of the image.
The Master of Soriguerola is documented by a small but coherent group of works, including several altarpieces with subjects related to the Last Judgment and the protection of souls, often originating from the Pyrenean region itself.
...
Beneath that pan stands a demon with a dark body and prominent horns, clinging with one hand to the edge of the scales and holding a hook or some sort of hook with the other, in an attempt to pull the pan downward and tip the judgment against the soul.
One of the most significant elements is the archangel’s gesture: with one hand he holds the scales, while with the other—raised—he places a finger on the beam, pushing slightly in favor of the pan containing the praying soul.
...
The background is a slightly mottled gold, now partially worn away, which creates a continuous field without architectural or landscape features; this focuses all attention on the figures and their attributes.
...
Michael’s wings are rendered with great decorative attention, in blackish and blue fields, enriched by gilded plant or floral motifs that break the monotony and confer upon the archangel an almost heraldic dignity.
