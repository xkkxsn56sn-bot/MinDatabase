...
subtitle: "Sienese Duecento painter and illuminator identified with the Maestro delle Clarisse"
dates: "Active c. 1260-1281 (XIII century)"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Rinaldo da Siena"
      - label: "Latin documentary form"
        value: "Ranaldus pittor de Senis"
      - label: "Also known as"
        value: "Maestro delle Clarisse (convention name in earlier scholarship)"
      - label: "Primary role"
        value: "Panel painter and manuscript illuminator"
      - label: "Main centers"
        value: "Siena, San Gimignano, and Florence orbit"
      - label: "Period"
        value: "Duecento Tuscany; transition from Italo-Byzantine idiom to early Sienese naturalizing tendencies"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Birth"
        value: "Unknown, probably Siena area, first half of XIII century (undocumented)"
      - label: "Death"
        value: "Unknown, probably late XIII century (after last documented payment in 1281)"
      - label: "Documented activity"
        value: "1274, 1277, 1278, 1281"
      - label: "Secure archival anchors"
        value: "San Gimignano civic payment (1274); Siena Biccherna and related communal commissions (1277-1281)"

  - title: "IDENTITY AND ATTRIBUTION"
    list:
      - "Historically reconstructed identity tied to the convention name Maestro delle Clarisse"
      - "Attribution path: Edward B. Garrison (1949), refined by James H. Stubblebine (1964), historically named as Rinaldo by Luciano Bellosi (1991), anticipated by Miklos Boskovits"
      - "Career profile combines monumental panel painting with advanced manuscript illumination"
      - "One of the key pre-Duccio figures for the formation of the Sienese school"

  - title: "DOCUMENTARY RECORD"
    pairs:
      - label: "1274"
        value: "Comune of San Gimignano pays Ranaldus pittor de Senis for a pittura infamante on a church exterior"
      - label: "1277-1278"
        value: "Payments from Siena communal authorities (including Biccherna context)"
      - label: "1278 (surviving object)"
        value: "Biccherna tablet of Don Bartolomeo Alessi (Gemaldegalerie, Berlin)"
      - label: "1281"
        value: "Further communal payment attesting continued activity"

  - title: "PATRONS AND CLIENTS"
    list:
      - "Comune of San Gimignano (civic commission, 1274)"
      - "Comune dei Quindici of Siena / Biccherna administration (1277-1281)"
      - "Cistercian milieu linked to San Galgano (through named officials in Biccherna commissions)"
      - "Poor Clares of Siena (context for the panel linked to the Maestro delle Clarisse identity)"
      - "Franciscan patrons in Florence (manuscript production attributed to his workshop in the 1270s)"

  - title: "ARTISTIC PROFILE"
    list:
      - "Base language in Italo-Byzantine Sienese conventions: gold grounds, hieratic frontal structures, codified physiognomies"
      - "Progressive softening of contour and emotional register under Coppo di Marcovaldo and broader Cimabuesque pressure"
      - "Frequent small-scale refinement in brushwork consistent with miniaturist practice"
      - "Palette characterized by restrained, soft tonalities rather than aggressively primary contrasts"
      - "Notable role in transmitting devotional intimacy into late Duecento Sienese imagery"

  - title: "MEDIA AND TECHNIQUES"
    list:
      - "Tempera and gold on wood panel"
      - "Painted Biccherna wooden covers"
      - "Tempera and gold on parchment in historiated initials and manuscript cycles"
      - "Fresco (attributed contexts)"

  - title: "KEY WORKS (ATTRIBUTED / DOCUMENTED)"
    list:
      - "Biccherna: Don Bartolomeo Alessi, monk of San Galgano, camarlengo (1278), Gemaldegalerie, Berlin"
      - "Christ and Mary on the Throne (Madonna della Palla), c. 1270 (or later dating proposals), Museo Diocesano, Siena"
      - "Triptych with Madonna and Child, Crucifixion, and Deposition, c. 1265, National Museum, Krakow"
      - "Virgin and Child, c. 1265-68, National Gallery, London (Master of the Clarisse / Rinaldo attribution orbit)"
      - "Madonna and Child with Four Saints, c. 1265-70, Memphis Brooks Museum of Art"
      - "Historiated Initial G with Stigmatization of St. Francis, c. 1275, J. Paul Getty Museum"
      - "Miniatures for the Livre du Gouvernement des princes (before 1285), BnF, Paris, ms. Italien 233"
      - "Miniatures of Vegetius Mulomedicina manuscript tradition (attribution orbit)"
  ...
  - title: "GEOGRAPHY AND MOBILITY"
    pairs:
      ...
      - label: "Documented movement"
        value: "San Gimignano (1274 civic commission)"
      - label: "Attributed external orbit"
        value: "Florence and broader Tuscan manuscript patronage networks"
      - label: "Mobility profile"
        value: "Regional Tuscan mobility typical of late Duecento craft workshops"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Byzantine icon tradition mediated through Tuscany"
      - "Coppo di Marcovaldo"
      - "Cimabue and early Florentine reform currents"
      - "Mendicant (Franciscan/Clarissan) devotional aesthetics"
      - "Sienese panel-painting tradition prior to Duccio"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Crucial transitional artist between strict Italo-Byzantine formulae and the more affective language later consolidated by Duccio"
      - "Important witness to the permeability between panel painting and manuscript illumination in XIII-century Tuscany"
      - "Key case for attributional scholarship in the reconstruction of anonymous Sienese masters"
      - "Documented contributor to Siena's civic visual culture via Biccherna production"
  ...
  - title: "THEMATIC KEYWORDS"
    list:
      ...
      - "Duecento Sienese painting"
      - "Biccherna"
      - "Italo-Byzantine"
      - "Duccio prehistory"
      - "Manuscript illumination"
      - "Tuscan civic patronage"
...
The religious community of the Poor Clares<a href="/endnotes.html#fn-chiara-assisi" class="footnote"><sup>2</sup></a> (*Clarisse*) of Siena provided the institutional context for the most important devotional panel attributed to him: the *Cristo e la Vergine in trono*, which gave rise to his conventional designation as the *Maestro delle Clarisse*. The attribution was first systematized by [Edward B. Garrison](/scholars.html#garrison-edward) in 1949, refined by [James H. Stubblebine](/scholars.html#stubblebine-james-h) in 1964, and definitively associated with the historical name "Rinaldo" by [Luciano Bellosi](/scholars.html#bellosi-luciano) in 1991, building on an earlier intuition by [Miklós Boskovits](/scholars.html#boskovits-miklos) in 1985. Recent scholarship has significantly expanded Rinaldo's Florentine patronage by attributing to him two liturgical manuscripts produced for religious communities in Florence as early as the 1270s — a finding that predates by over a decade the conventionally assumed beginning of Sienese artistic presence in Florence with Duccio's Rucellai Madonna of 1285. One of these manuscripts was produced for the Franciscan basilica of Santa Croce in Florence, demonstrating that Rinaldo's activity crossed the political boundaries between the rival communes of Siena and Florence during a period of acute inter-urban tension. Beyond the institutional patrons, the commission of the *Livre du Gouvernement des princes* illuminations preserved in the Bibliothèque nationale de France suggests that by the 1280s, Rinaldo's atelier was capable of producing luxury books for sophisticated courtly or ecclesiastical audiences whose tastes extended to French vernacular literature.
...
The Franciscan<a href="/endnotes.html#fn-francis-assisi" class="footnote"><sup>3</sup></a> spiritual reform was not merely a theological but also a profoundly aesthetic movement; its insistence on the humanity of Christ and the affective engagement of the faithful with the image of the suffering Savior created a new kind of patron who wanted images that spoke to the heart as well as the intellect, and this pressure shaped the direction of Rinaldo's stylistic evolution. Sienese painting of the period was also influenced by the Pisan tradition, and the close artistic interchange between the two cities — documented in the shared circulation of painted panels and the movement of craftsmen — is reflected in certain structural features of Rinaldo's *Crocifissi* that recall Pisan models. The strong devotional culture of the Cistercian<a href="/endnotes.html#fn-cistercian-order" class="footnote"><sup>4</sup></a> and mendicant orders for whom Rinaldo worked was itself a shaping influence on his style, since the liturgical functions of his works — from the *biccherna* tablets to the choir manuscripts — required an art that was simultaneously beautiful, legible, and spiritually efficacious within specific contexts of monastic use.
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-01.jpg" alt="Trittico della Madonna col Bambino, Crocifissione e Deposizione">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-02.jpg" alt="Christ and Mary on the throne">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-03.jpg" alt="Miniatures of the *Mulomedicina* of Vegetius">
...
Its very small dimensions immediately define the work’s function: not a church altarpiece, but a portable devotional panel (imago devotionis), intended for individual prayer in a convent or domestic setting.
 The wooden support, likely walnut as the attribution suggests, is prepared with a layer of chalk and glue (fine and coarse chalk) onto which the gold leaf for the background is applied, followed by egg tempera, a medium typical of 13th-century Sienese painting. The elongated vertical format concentrates the two figures within a narrow, intimate space, which facilitates close visual contact between the devotee and the sacred images.
Mary occupies the central and dominant part of the composition, depicted full-length or in half-length according to the Italo-Byzantine tradition.
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-05.jpg" alt="Madonna and Child with Four Saints">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-06.jpg" alt="Tavoletta di Biccherna di Don Bartolomeo Alessi, Monaco di San Galgano, camarlingo">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-07.jpg" alt="The Virgin and Child">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-08.jpg" alt="The Crucified Christ with the Sorrowing Virgin Mary and Saint John the Evangelist, and the Prophets">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-09.jpg" alt="The Descent from the Cross">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-10.jpg" alt="Initial G: The Stigmatization of St. Francis">
...
<figure>
  <img src="/Images/Rinaldo-da-Siena/rinaldo-da-siena-10.jpg" alt="Miniatures of the Livre du Gouvernement des princes">
