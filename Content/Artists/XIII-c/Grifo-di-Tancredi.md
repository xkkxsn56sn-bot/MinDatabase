...
dates: "ca. 1250 – ca. 1315"

meta:
  - title: "IDENTITY"
    pairs:
      - label: "Name variants"
        value: "Grifo di Tancredi, Grifa Tancredi (payment record, Perugia 1281)"
      - label: "Former attribution"
        value: "Master of San Gaggio (Longhi, 1948; identity recovered by Boskovits, 1988)"
      - label: "Identifying inscription"
        value: "\"H(oc) op(us) q(uod) fec(it) m(agister) Grifus Florentinus\" — Crawford triptych"
      - label: "Field"
        value: "Panel painting, fresco"
      - label: "Attribution status"
        value: "Documented; core corpus established by Boskovits (1988) and Tartuferi"

  - title: "PERIOD"
    list:
      - "XIII–XIV century (Duecento–early Trecento)"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Birth"
        value: "ca. 1250, Florence (inferred from first document, 1271)"
      - label: "Earliest document"
        value: "1271 — rents workshop in Volterra alongside Filippo di Jacopo"
      - label: "Perugia"
        value: "1281 — probable participation in Fontana Maggiore project"
      - label: "Florentine workshop"
        value: "By 1295 — takes on an apprentice; settled bottega in Florence"
      - label: "Guild enrollment"
        value: "Between 1297 and 1312 — Arte dei Medici e Speziali"
      - label: "Latest document"
        value: "30 September 1303 — payment for frescoes, Palazzo Vecchio, Florence"
      - label: "Death"
        value: "ca. 1315 (scholarly estimate; no documentary confirmation)"
  ...
  - title: "MEDIA"
    list:
      ...
      - "Gold ground (bole and mordant technique)"
      - "Fresco"
      - "Portable altarpieces and tabernacles"
      - "Large-format altarpieces (dossale, polyptych)"

  - title: "LOCATION"
    list:
      - "Florence (primary base and city of origin)"
      - "Volterra, Tuscany (documented, 1271)"
      - "Perugia, Umbria (probable, 1281)"
      - "Rome (possible visit; undocumented)"

  - title: "KEY WORKS"
    list:
      - "Crawford Triptych (The Death of St Ephraim; Passion scenes), 1280–90 — National Gallery of Scotland, Edinburgh (on loan)"
      - "Maestà from San Gaggio (Virgin and Child Enthroned with Four Saints), ca. 1290 — Galleria dell'Accademia, Florence"
      - "Artaud de Montor polyptych (Christ Blessing; Saints Peter, James, John the Baptist), ca. 1310 — National Gallery of Art, Washington, and Musée des beaux-arts de Chambéry"
      - "Tabernacle (Madonna and Child; Passion scenes), 1300–05 — Gemäldegalerie, Berlin"
      - "Dossale with Passion Scenes (with Magdalen Master), ca. 1310 — Timken Art Gallery, San Diego"
      - "Tabernacle with kneeling donor, ca. 1300–10 — Brooks Memorial Art Gallery, Memphis"
      - "Tabernacle (Madonna with Saints; nine Passion scenes), ca. 1295–1305 — Christ Church Picture Gallery, Oxford"
      - "Frescoes in the Palazzo Vecchio, Florence, 1303 — lost"
      - "Frescoes, chapel of San Giacomo at Castelpulci — fragmentary"

  - title: "PATRONAGE"
    list:
      - "Commune of Florence (Palazzo Vecchio fresco, 1303)"
      - "Commune of Perugia (Fontana Maggiore, 1281 — probable)"
      - "Commune of Volterra (ecclesiastical context, 1271 — probable)"
      - "Benedictine convent of San Gaggio, Florence (Maestà from San Gaggio)"
      - "Private lay patrons (portable altarpieces and tabernacles)"
      - "Minor ecclesiastical establishments (portable devotional objects)"

  - title: "FORMATION AND INFLUENCES"
    list:
      - "Magdalen Master — primary workshop formation; Italo-Byzantine tempera technique"
      - "Cimabue — decisive stylistic influence; bold chiaroscuro, expressive weight, psychological gravity"
      - "Byzantine art — direct source for iconographic types and gold-ground convention"
      - "Giovanni Pisano — probable influence during Perugian sojourn, 1281"
      - "Giotto — late selective absorption of proto-Giottesque spatial vocabulary"
      - "Master of Santa Cecilia (Gaddo Gaddi) — detectable influence in very late works"
      - "Roman pictorial tradition (Jacopo Torriti, Cavallini circle) — Cosmatesque decorative elements in late panels"

  - title: "STYLE"
    list:
      - "Transitional: Duecento Byzantine-Florentine tradition evolving toward proto-Giottesque Trecento"
      - "Cimabuesque formal language mastered to the point of near-indistinguishability (Artaud de Montor polyptych)"
      - "Distinctive narrative energy in small-scale Passion sequences; lively gestural expression"
      - "Persistent difficulty with optically convincing spatial environments (Boskovits)"
      - "Late phase: increasing volumetric solidity, monumental sobriety, Cosmatesque décor"
      - "Characteristic palette: saturated azurite blue, warm ochre, vermilion"
      - "Original synthesis of Duecento Byzantine culture and Giottesque innovation (Tartuferi)"

  - title: "GUILD AND PROFESSIONAL STATUS"
    pairs:
      - label: "Guild"
        value: "Arte dei Medici e Speziali, Florence (enrolled between 1297 and 1312)"
      - label: "Workshop"
        value: "Stable Florentine bottega attested by 1295; apprentice taken on that year"
      - label: "Documented collaborations"
        value: "Filippo di Jacopo (Volterra, 1271); Magdalen Master (Timken dossale)"
...
<figure>
  <img src="/Images/Grifo-di-Tancredi/grifo-di-tancredi-01.jpg" alt="The Death of St Ephraim and Scenes from the Lives of the Hermits (central panel); Scenes from the Passion of Christ (in the wings)">
...
<figure>
  <img src="/Images/Grifo-di-Tancredi/grifo-di-tancredi-03.jpg" alt="Saint Peter">
...
<figure>
  <img src="/Images/Grifo-di-Tancredi/grifo-di-tancredi-04.jpg" alt="Saint James Major">
...
<figure>
  <img src="/Images/Grifo-di-Tancredi/grifo-di-tancredi-06.jpg" alt="Saint John the Baptist">
...
<figure>
  <img src="/Images/Grifo-di-Tancredi/grifo-di-tancredi-07.jpg" alt="Tabernacle">
...
<figure>
  <img src="/Images/Grifo-di-Tancredi/grifo-di-tancredi-08.jpg" alt="Dossale with Passion Scenes">
