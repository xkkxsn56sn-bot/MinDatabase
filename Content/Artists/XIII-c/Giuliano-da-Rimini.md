...
subtitle: Painter of the Rimini School; transitional master between Byzantine solemnity and Giottesque naturalism
dates: c. 1280/1290 – c. 1324
meta:
  - title: Identity
    pairs:
      - label: Born
        value: c. 1280–1290, Rimini
      - label: Died
        value: c. 1324, Rimini (probable)
      - label: Nationality
        value: Italian (Riminese)
      - label: Active period
        value: c. 1305 – c. 1324
      - label: Media
        value: Tempera and gold on panel; fresco

  - title: Family background
    pairs:
      - label: Father
        value: Small trader in fabrics and cereals, Rimini
      - label: Maternal family
        value: Scribes and assistants to ecclesiastical institutions in and around Rimini
      - label: Notable relative
        value: Great-uncle, parish priest; early spiritual and iconographic mentor

  - title: Patrons
    list:
      - Minor nobility affiliated with the Malatesta clan, Rimini
      - Franciscan and Dominican monastic communities
      - Local parish churches and ecclesiastical institutions
      - Wealthy merchants and guild halls of Rimini
      - Travelling dignitaries seeking portable altarpieces and diptychs
      - Civic councils and local government bodies

  - title: Key Works
    list:
      - "Coronation of the Virgin and the Saints, 1320 — tempera and gold on panel, 205.5 × 500 cm, Museo della Città di Rimini"

  - title: Artistic Influences
    list:
      - "Giotto di Bondone — three-dimensionality, spatial coherence and emotional narrative"
      - "Giovanni Baronzio — Rimini School regional idioms and collaborative workshop culture"
      - "Neri da Rimini — Rimini School blend of Byzantine formality and emerging realism"
      - "Italo-Byzantine tradition — gold-ground panels, hieratic frontality and solemn compositions"
      - "Ravenna mosaics — timeless spirituality and radiant colour harmonies"
      - "Northern Gothic — delicate linear ornamentation, graceful figure elongation and filigree motifs"
      - "Franciscan theology — Christocentric humanity and affective devotion"
      - "Dominican didactic clarity — narrative legibility and scriptural scenes for lay education"

  - title: Innovations
    list:
      - Synthesis of Byzantine grandeur with Giottesque naturalism and progressive spatial depth
      - Overlapping figures and architectural motifs creating modest but deliberate illusionistic recession
      - Emotional expressiveness in sacred figures — subtle gestures conveying tenderness, wonder and devotion
      - Gradual softening of drapery from stylised Byzantine folds to naturalistic, weight-bearing forms
      - Narrative use of gaze and body angle to animate group compositions and guide the viewer's eye
      - Chromatic evolution from sharp medieval contrasts to balanced, modulated colour harmonies

  - title: Travels
    list:
      - "Bologna — university milieu, Gothic ecclesiastical architecture and local commissions"
      - "Florence — probable study of Giotto's frescoes at Santa Croce and the Badia"
      - "Papal States — ecclesiastical commissions in central Italy"
      - "Venice — Byzantine mosaics of St Mark's and Venetian colourism"
      - "Apennine hill towns — pilgrimage routes, convent commissions and rural patronage"

  - title: Related Artists
    list:
      - Giotto di Bondone (primary stylistic influence)
      - Giovanni Baronzio (Rimini School contemporary)
      - Neri da Rimini (Rimini School contemporary)
      - Pietro Cavallini (Roman proto-Renaissance parallels)
      - Duccio di Buoninsegna (Sienese parallel evolution)
---
