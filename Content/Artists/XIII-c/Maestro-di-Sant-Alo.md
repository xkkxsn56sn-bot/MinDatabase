...
subtitle: "Anonymous Tuscan-Umbrian painter active in the Spoletan sphere between late Duecento and early Trecento"
...
meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Maestro di Sant'Alò (conventional attribution name)"
      - label: "Primary role"
        value: "Anonymous painter of reliquary panels, crucifixes, and devotional works"
      - label: "Period"
        value: "Late XIII to early XIV century (Duecento-Trecento transition)"
      - label: "Primary center"
        value: "Spoleto and wider Umbrian ecclesiastical networks"
      - label: "Documentary status"
        value: "Attribution-defined corpus without secure civil identity"

  - title: "IDENTITY AND ATTRIBUTION"
    list:
      - "Notname derived from works associated with Sant'Alò in the Spoletan context"
      - "Corpus reconstructed through stylistic comparison across reliquary and crucifix panels"
      - "Seen as a key transitional master linking Italo-Byzantine inheritance and early Trecento naturalism"
      - "Associated with the autonomous Spoletan school active in the late Duecento"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Formation horizon"
        value: "Late XIII century workshop culture in central Italy"
      - label: "Core activity"
        value: "c. 1290-1315 in Spoleto, Trevi, and neighboring ecclesiastical sites"
      - label: "Late phase"
        value: "c. 1315-1325 with stronger early Trecento stylistic inflection"
      - label: "Biographical endpoints"
        value: "Birth and death unknown; chronology inferred from attributed works"

  - title: "PATRONAGE AND COMMISSIONS"
    list:
      - "Church and confraternal contexts linked to Sant'Alò in Spoleto"
      - "Benedictine institutions including San Paolo Inter Vineas"
      - "Parish churches and monastic settings in the Umbrian hinterland"
      - "Clerical and lay patrons investing in reliquary and liturgical imagery"
      - "Regional ecclesiastical networks tied to papal-governed central Italy"

  - title: "ARTISTIC PRACTICE"
    list:
      - "Tempera and gold/silver grounds on shaped and rectangular wooden supports"
      - "Production of stauroteche and reliquary-associated painted ensembles"
      - "Workshop methods combining precise linear drawing with layered pigment modeling"
      - "Refined white-lead highlight systems for drapery volume and facial articulation"
      - "Adaptation of monumental crucifix iconography to both urban and rural devotional settings"

  - title: "STYLE"
    list:
      - "Gold-ground Italo-Byzantine structure with progressive volumetric naturalization"
      - "Measured emotional pathos and increasingly individualized physiognomy"
      - "Integration of local Spoletan conventions with Cimabuesque-Giottesque impulses"
      - "Careful balance between liturgical solemnity and narrative legibility"
      - "High material finish through precious metal grounds and ornamental detail"
  ...
  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "One of the clearest transitional voices between Umbrian Duecento convention and Trecento renewal"
      - "Important witness to reliquary-image devotion in central Italy"
      - "Key contributor to the artistic identity of the Spoletan school"
      - "Demonstrates regional reinterpretation of major Tuscan innovations"
...
The silvery background, now altered and marked by time, was an integral part of the original visual effect: it multiplied the image’s luminosity and gave the cross an almost liturgical, solemn, and precious character. The presence of red lacquer on the inner edge of the frame, still partially visible, suggests that the work was conceived as a finished object even in its marginal details, not merely as a central image.
The reverse side, painted with a faux red marbling effect, further indicates a two-sided display, likely placed on a partition or in a position that allowed viewing from both sides.
...
The obverse of the reliquary features a complex “single-scene” Crucifixion, in which every part of the small cross is used to densely arrange figures and symbols related to the Passion and the reliquary’s function. It depicts a *Christus patiens*: Christ is dead or dying, his body exhausted and his head bowed, at the center of the shaped cross.
The background is entirely gilded, with punched decoration along the edge; cabochon-cut colored glass beads are set into the corners of the shape, transforming the cross into a small precious object, halfway between a painting and a liturgical jewel.
...
The cruciform halo, with punched decoration along the rim, sets the head apart from the gold background and makes it the true focal point of the entire visual composition: it is toward the reclined face that the gaze of the faithful and that of the other figures ideally converge.
...
In this way, the upper part of the recto is not a mere “decorative crest,” but the true theological heart of the object: the presence of the relics is physically concentrated there, while beneath it unfolds the pictorial narrative of the Passion.
