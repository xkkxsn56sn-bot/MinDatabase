---
layout: entry
title: "Vigoroso da Siena"
subtitle: "Cimabuesque Painter of the Duecento"
dates: "active 1276–1293"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Vigoroso da Siena (name as recorded in Sienese Biccherna registers)"
      - label: "Origin"
        value: "Unknown; probably Florence or central Tuscany; naturalized citizen of Siena from 1276"
      - label: "Primary role"
        value: "Panel painter; decorator of communal administrative registers"
      - label: "Period"
        value: "Italian Duecento; Cimabuesque tradition"
      - label: "Documented activity"
        value: "1276 (citizenship tax, Biccherna) to 31 December 1293 (payment for podestà register cover)"
      - label: "Residence in Siena"
        value: "Contrada di San Donato, terzo di Camollia"

  - title: "BIOGRAPHICAL LIMITS"
    list:
      - "No known surname, birth record, or death certificate survives"
      - "Not a native Sienese; place of origin unestablished by documentary evidence"
      - "Birth estimated c. 1240–1251 on the basis of Sienese legal majority requirements for citizenship"
      - "Father possibly named Claudio, or described as 'the lame man' (claudus), per an ambiguous 1281 Biccherna reference"
      - "No wife, children, siblings, or other kin mentioned in any surviving document"
      - "Death date unknown; probably c. 1295, inferred from cessation of archival references after 1293"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Birth"
        value: "Unknown; c. 1240–1251 (scholarly estimate)"
      - label: "1276"
        value: "Pays citizenship tax to the Comune di Siena; already recorded as pictor"
      - label: "1280"
        value: "Goods confiscated for an unspecified legal condemnation"
      - label: "1281"
        value: "Fined fifty lire; guarantor Ranuccio Fortis de' Montanini of the Sienese merchant class"
      - label: "1291"
        value: "Signs and dates the Dossale di Santa Giuliana, Perugia (primary autograph work)"
      - label: "January 1292"
        value: "Receives nine soldi for decorating covers of Biccherna register of the camerlengo and provveditori"
      - label: "July 1292"
        value: "Receives ten soldi for the same type of communal register work"
      - label: "31 December 1293"
        value: "Receives ten soldi for decorating the podestà's register cover with the official's coat of arms"
      - label: "Death"
        value: "Unknown; probably c. 1295 (no further archival trace after 1293)"

  - title: "PATRONAGE"
    list:
      - "Comune di Siena (Biccherna): repeated commissions for decoration of official administrative register covers, 1292–1293"
      - "Cistercian monastery of Santa Giuliana, Perugia: altarpiece commission (Dossale di Santa Giuliana, 1291)"
      - "Patronage of the dossale possibly connected to Cardinal John of Toledo's foundational influence on Santa Giuliana"
      - "Collaboration with a painter named Rinforzato in 1293 (document cited by Guglielmo della Valle)"
      - "Subsequent Biccherna payment involving Petruccio di Dietisalvi for a panel with Rinaldo da Spoleto's coat of arms"

  - title: "ARTISTIC PROFILE"
    list:
      - "Deepest and most direct Cimabuesque formation of any painter active in Siena during the Duecento"
      - "Formation achieved outside Siena, probably in Florence or in direct proximity to Cimabue's workshop"
      - "Non-native artistic identity preserved after arrival in Siena; no fundamental transformation of style in the Sienese period"
      - "Possible miniaturist, based on attributions by Bellosi (Uffizi drawings, Cini Foundation illumination)"
      - "Technical virtuosity in chiaroscuro modelling and white-highlight hatching described as 'modellato finissimo e trasparente'"

  - title: "STYLE"
    list:
      - "Elongated figure proportions derived from Cimabue's works of the 1270s–1280s (Santa Croce Crucifix; Louvre Maestà)"
      - "Finely hatched lead-white highlights applied with near-calligraphic brushwork"
      - "Chromatic palette: raspberry reds, muted 'putrid green', pale enamel pink — paralleled in Sienese contemporaries"
      - "Gold ground treated as a metaphysical field of divine light, not merely decorative"
      - "Residual Italo-Byzantine archaisms: strict frontality, gold chrysography in drapery, hieratic Virgin"
      - "Formal precocity in the polyptych silhouette of the Perugia dossale, with five differentiated apical cusps"
      - "Reflectographic examination (1986) revealed thick but ordered, clean preparatory underdrawing"

  - title: "PRINCIPAL WORKS"
    list:
      - "Dossale di Santa Giuliana (Madonna and Child Enthroned with Saints), 1291, tempera on poplar panel, 233 × 153 cm, Galleria Nazionale dell'Umbria, Perugia (inv. no. 32) — sole signed and dated autograph work"
      - "Five partially coloured drawings on parchment, Gabinetto dei Disegni e delle Stampe, Uffizi, Florence (inv. 1E, 2E, 5E, 6E, 7E) — attributed by Bellosi, questioned by Marrone"
      - "Illuminated initial 'M' with the Twelve Apostles, Fondazione Giorgio Cini, Venice (inv. 55) — attributed by Bellosi, status debated"
      - "Biccherna register covers (1292–1293, Siena) — documentary record, no surviving examples identified"

  - title: "INFLUENCES AND DIALOGUES"
    list:
      - "Cimabue: dominant formative influence, especially works datable to the 1270s–early 1280s"
      - "Italo-Byzantine tradition: pre-Cimabuesque substratum discernible in archaizing elements of the dossale"
      - "Sienese chromatic environment: secondary assimilation of palette conventions from Rinaldo da Siena and Guido di Graziano"
      - "Relationship with Duccio di Buoninsegna: contemporaneous but apparently no direct dialogue"
      - "Guido da Siena and the 'guidesca' tradition: conspicuously absent from Vigoroso's pictorial grammar"
      - "Cistercian devotional culture: relevant to the commission and iconographic programme of the Santa Giuliana dossale"

  - title: "GEOGRAPHIC ACTIVITY"
    pairs:
      - label: "Formation"
        value: "Probably Florence or central Tuscany (hypothesis of Luciano Bellosi, unconfirmed by documents)"
      - label: "Primary base"
        value: "Siena (from 1276; contrada di San Donato, terzo di Camollia)"
      - label: "Documented commission outside Siena"
        value: "Cistercian monastery of Santa Giuliana, Perugia (1291 dossale, probably executed in Siena and transported)"
      - label: "Attributed works"
        value: "Uffizi drawings (Florence); Fondazione Cini illumination (Venice) — attributions debated"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Singular case of unmediated Cimabuesque formation within the otherwise guidesca-dominated Sienese painting milieu"
      - "The Dossale di Santa Giuliana is one of the earliest Duecento polyptych-silhouette altarpieces, anticipating Trecento formal complexity"
      - "Important evidence for the geographic circulation of Florentine pictorial ideas in late 13th-century central Italy"
      - "Documentary record illustrates the precarious social and civic position of non-native artisans in medieval Siena"
      - "Collaboration with Rinforzato (1293) provides a rare glimpse into workshop partnership practices in Sienese civic painting"
...
The Altarpiece of Saint Juliana (1291) by Vigoroso da Siena is the only work by the artist that is both signed and dated with certainty, and is considered a masterpiece of 13th-century Italian painting. It is a tempera panel on a poplar wood support, housed at the National Gallery of Umbria in the Palazzo dei Priori in Perugia.
The work is executed in tempera on poplar panel, with a supporting structure consisting of three crossbars nailed to the side panels and the top and bottom edges. The perimeter frame is crafted separately and attached to the panel on the front side.
...
- Saint Mary Magdalene (on the left), depicted with her traditional attributes, in elegant robes, likely holding the jar of ointments.

- Saint John the Baptist (on the left), wearing a camel-hair cloak and holding a scroll with the prophetic inscription.
  
- Saint John the Evangelist (on the right), with the Gospel book, depicted as the beloved young apostle.
  
- Saint Juliana of Nicomedia (on the right), depicted in regal robes with a crown, a saint of great devotional significance for the Cistercian community of the Monastery of Saint Juliana in Perugia, formally established in 1253.
