...
subtitle: "Anonymous Pisan panel painter of the mid‑ to late Duecento, probably to be identified with Ugolino di Tedice"
dates: "active c. 1251–1277; certainly dead before 1286"

meta:
  - title: Identity
    pairs:
      - label: Conventional name
        value: Master of San Martino (Maestro di San Martino)
      - label: Name origin
        value: Named after the Madonna di San Martino altarpiece made for the church of San Martino in Cinzica, Pisa
      - label: Historical status
        value: Anonymous; no medieval document names him under this conventional designation
      - label: Probable true identity
        value: Ugolino di Tedice, identified by Luciano Bellosi on the basis of physiognomic and technical analogies
      - label: Basis of identification
        value: Shared cheek-notch between the sleeping Joachim in the Madonna di San Martino and the suffering Christ on the Hermitage Crucifix signed "Ugolinus"
      - label: Acceptance of identification
        value: Broadly endorsed in scholarship; not universally accepted
      - label: Occupation
        value: Panel painter (pictor)
      - label: Origin
        value: Pisa (workshop and principal activity)

  - title: Chronology and documents
    pairs:
      - label: Conventional activity span
        value: c. 1251–1277, based on documents relating to Ugolino di Tedice if the identification is accepted
      - label: Documentary attestations
        value: Pisa, 1273 and 1277 (records naming Ugolino di Tedice as painter)
      - label: Terminus ante quem for death
        value: 1286, when family archival evidence confirms he was no longer alive
      - label: Anonymous corpus construction
        value: Roberto Longhi reconstructed the core corpus from the Madonna di San Martino as its anchoring work

  - title: Family and workshop context
    pairs:
      - label: Family
        value: Belongs to the Tedice family of Pisan painters, comparable in importance to the Berlinghieri of Lucca
      - label: Elder brother
        value: Enrico di Tedice, panel painter in Byzantine mode, documented in Pisa in 1254
      - label: Son
        value: Ranieri di Ugolino, who continued the workshop tradition; his cross dated c. 1290 reflects the Giunta-derived models of the paternal workshop and a knowledge of Cimabue
      - label: Workshop location
        value: Probably the Kinzica district of Pisa, south of the Arno, the same neighbourhood as San Martino in Cinzica
      - label: Workshop practice
        value: Multi-generational transmission of cartoon designs, preparatory techniques, pigment recipes, and compositional conventions

  - title: Signed and attributed works
    pairs:
      - label: Eponymous work
        value: Madonna di San Martino, c. 1260–1270, tempera on panel, 162 × 125 cm; Museo Nazionale di San Matteo, Pisa (formerly in the church of San Martino in Cinzica)
      - label: Anchoring signed work
        value: Crucifix signed "Ugolinus", c. 1250–1260, tempera on poplar panel, 90 × 62 cm; State Hermitage Museum, Saint Petersburg
      - label: Further attributed works
        value: Sant'Anna in trono con Maria bambina e due angeli; Madonna col Bambino, church of San Biagio in Cisanello, Pisa; small Christ Blessing; small Madonna and Child; all Museo Nazionale di San Matteo, Pisa
      - label: Possible cross-medium attribution
        value: Miniatures in the Pisan Exultet scroll (Exultet 3, Museo dell'Opera della Primaziale Pisana), proposed by Enzo Carli in 1958
      - label: Longhi additional attribution
        value: Small panel with a monk before Saint Francis, Johnson Collection, Philadelphia Museum of Art (Franciscan commission)
      - label: Longhi additional attribution
        value: Madonna col Bambino e angeli, formerly Acton Collection, Florence, dated c. 1290
      - label: Medium
        value: Tempera on panel with gold ground; wood support prepared with gesso following standard Pisan practice
      - label: Geographic distribution
        value: Principal works concentrated in Pisa (Museo Nazionale di San Matteo) and one signed crucifix in the Hermitage

  - title: Style and artistic profile
    pairs:
      - label: Signature technique
        value: Strigilature luminose — fine strigil-like luminous brushstrokes on drapery, landscapes, and flesh highlights, producing a gold-tinted radiance without precedent in Pisan painting
      - label: Relationship to Giunta Pisano
        value: Transforms Giunta's expressive filiform flesh modeling into a more decorative, luminous system; indebted to the Giuntesque Christus patiens crucifix tradition
      - label: Treatment of the Virgin
        value: Warm, modulated colorism on the face; gentle melancholy without heavy Byzantine contours; anticipates the humanizing tendencies of the late Duecento
      - label: Narrative capacity
        value: Eleven apocryphal scenes (Protoevangelium of James) in the Madonna di San Martino show exceptional narrative vivacity and compositional inventiveness
      - label: Relationship to Nicola Pisano
        value: Responsive to the classical revival in Nicola's Baptistery pulpit of 1260; figures show physical weight and spatial credibility derived from sculptural classicism
      - label: Relationship to Cimabue
        value: Mutual awareness with Cimabue; the Christ Child in the Madonna di San Martino echoes the Louvre Maestà type; chronological priority between the two remains debated
      - label: Limits of innovation
        value: Did not succeed in departing from Byzantine canons as radically as Cimabue; local ecclesiastical demand may have favoured stylistic continuity
      - label: Color
        value: Rich, jewel-like tempera in deep crimsons, muted azurites, and warm ochres, characteristic of Pisan panel painting of the third quarter of the century

  - title: Artistic context and influences
    pairs:
      - label: Primary influence
        value: Giunta Pisano — filiform flesh modeling and expressive Christus patiens type
      - label: Byzantine neo-Hellenic current
        value: Analogies with Constantinopolitan neo-classical figures, including Vatican cod. gr. 1158; accessed through imported icons and illuminated manuscripts
      - label: Sculptural influence
        value: Nicola Pisano's Baptistery pulpit, Pisa (1260) — volume, spatial credibility, classical figure types
      - label: Cross-regional connection (hypothesis)
        value: Longhi identified the Master with the Third Master of Anagni, implying activity within papal Lazio fresco culture; not universally accepted
      - label: Late influence absorbed
        value: Cimabue's Pisan Maestà; possibly papal Roman networks via Longhi's Anagni hypothesis
      - label: Position in historiography
        value: Recognized by Longhi as one of the greatest masters of the Duecento, despite remaining within Byzantine canons and without Cimabue's supra-regional reach

  - title: Patronage
    pairs:
      - label: Principal patron institution
        value: Church of San Martino in Cinzica, Pisa — Marian and hagiographic commission, affiliated with the canons of the Cathedral of Santa Maria
      - label: Probable broader patron base
        value: Pisan parish churches and ecclesiastical institutions; Museo Nazionale di San Matteo panels derive from various urban or suburban churches
      - label: Franciscan commission
        value: Small panel with a monk before Saint Francis (Johnson Collection, Philadelphia) implies mendicant patronage
      - label: Possible Opera del Duomo connection
        value: Exultet 3 attribution would link the painter to the liturgical workshops of the Pisan Primatial complex
      - label: Geographic scope of patronage
        value: Largely confined to Pisa and its immediate territory; no documented supra-regional commissions, unlike Cimabue

  - title: Thematic keywords
    list:
      - "Anonymous master, conventional designation"
      - "Identification with Ugolino di Tedice (Bellosi hypothesis)"
      - "Pisan school of panel painting, mid‑ to late Duecento"
      - "Strigilature luminose — signature technique"
      - "Giuntesque tradition and its transformation"
      - "Byzantine neo‑Hellenic reception in Tuscany"
      - "Madonna di San Martino polyptych"
      - "Apocryphal Marian narrative (Protoevangelium of James)"
      - "Nicola Pisano and sculptural classicism in Pisan painting"
      - "Relationship to Cimabue"
      - "Third Master of Anagni (Longhi hypothesis)"
      - "Tedice family workshop dynasty"
      - "Precursor of late Duecento Italo-Gothic transition"
  ...
  - title: Related entries
    links:
      ...
      - title: "Enrico di Tedice"
        url: "/Content/Artists/XIII%20century/Enrico%20di%20Tedice.md"
      - title: "Ranieri di Ugolino"
        url: "/Content/Artists/XIII%20century/Ranieri%20di%20Ugolino.md"
      - title: "Giunta Pisano"
...
author: "Master of San Martino (Maestro di San Martino)"
role: "Anonymous Pisan panel painter, possibly to be identified with Ugolino di Tedice"
dates_detail: "Active c. 1251–1277 if identified with Ugolino di Tedice; certainly dead before 1286"
birth_place: "Pisa (presumed, if identified with Ugolino di Tedice)"
death_place: "Pisa (presumed), before 1286"
period: "XIII century"

key_works:
  - "Madonna di San Martino, c. 1260–1270, tempera on panel, 162 × 125 cm, Museo Nazionale di San Matteo, Pisa"
  - "Crucifix signed 'Ugolinus', c. 1250–1260, Hermitage Museum, Saint Petersburg (anchoring attributed work)"
  - "Sant'Anna in trono con Maria bambina e due angeli, Museo Nazionale di San Matteo, Pisa"
  - "Madonna col Bambino, church of San Biagio in Cisanello, Pisa"
  - "Small Christ Blessing and small Madonna and Child, Museo Nazionale di San Matteo, Pisa"

tradition: "Pisan school of panel painting; Giuntesque Christus patiens and Marian altarpiece tradition; neo‑Hellenic Byzantine current in central Italian Duecento art"
artistic_style: "Strigilature luminose on drapery and flesh; warm, psychologically nuanced Virgin types; exceptional narrative vivacity in apocryphal Marian scenes; tempera on panel with gold ground following Pisan Duecento workshop practice"
...
thematic_keywords:
  ...
  - "Byzantine neo‑Hellenic reception"
  - "Madonna di San Martino"
  - "Apocryphal Marian narrative"
  - "Third Master of Anagni hypothesis"
  - "Precursor of Cimabue"
  - "Tedice family workshop"
...
The scholarship of Longhi further posited an important connection between the Maestro di San Martino and the so-called *Terzo Maestro di Anagni* (Third Master of Anagni), the painter responsible for the cycle of frescoes in the crypt of Anagni Cathedral; Longhi believed the two to be the same artist, a view that, if accepted, would place the Pisan painter's early career in the context of papal Rome and the sophisticated fresco culture of the Lazio region, though this identification has not won universal assent. The influence of the early Cimabue is also unmistakable in the Maestro's mature works, particularly in the compositional structure of his Marian altarpieces and in the treatment of the Christ Child, and the relationship between the two painters, whether one preceded the other, or whether they developed in parallel, remains one of the central interpretative challenges in the study of late Duecento Pisan painting.
