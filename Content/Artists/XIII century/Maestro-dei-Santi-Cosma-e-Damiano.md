...
subtitle: "Anonymous Pisan-Sienese panel painter in the orbit of Giunta Pisano"
dates: "c. 1240 - c. 1270"
...
meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Maestro dei Santi Cosma e Damiano (conventional attribution name)"
      - label: "Primary role"
        value: "Panel painter of Marian devotional imagery in tempera and gold"
      - label: "Period"
        value: "Mid-XIII century (Duecento)"
      - label: "Primary centers"
        value: "Pisa and Siena, with circulation across Tuscan devotional contexts"
      - label: "Documentary status"
        value: "Anonymous corpus defined by style; possible identification with Gilio di Pietro remains debated"

  - title: "IDENTITY AND ATTRIBUTION"
    list:
      - "Notname established around the Madonna linked to Santi Cosma e Damiano in Pisa"
      - "Also referenced as Master of the Madonna of Saints Cosmas and Damian"
      - "Proposed civil identification with Gilio di Pietro (Luciano Bellosi) is influential but not universally accepted"
      - "Corpus remains grounded in connoisseurship, iconography, and workshop-style analysis"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Probable birth horizon"
        value: "Second quarter of XIII century, likely in Pisa or nearby territory (hypothetical)"
      - label: "Core activity"
        value: "c. 1240-1270 across Pisan-Sienese devotional and civic commissions"
      - label: "Documentary anchor if equated with Gilio"
        value: "Sienese references between 1247 and 1261, including Biccherna activity"
      - label: "Possible death horizon"
        value: "Possibly Siena, 1261, only under the Gilio di Pietro hypothesis"

  - title: "PATRONAGE AND COMMISSIONS"
    list:
      - "Church of Santi Cosma e Damiano, Pisa, for the Madonna del Patrocinio context"
      - "Carmelite church of San Niccolo al Carmine, Siena, for the Madonna dei Mantellini tradition"
      - "Sienese Biccherna civic office through the 1258 Frate Ugo tablet (if tied to Gilio di Pietro)"
      - "Private and semi-private devotional patrons for small-format Marian panels"
      - "Ecclesiastical and communal institutions favoring conservative Italo-Byzantine imagery"

  - title: "ARTISTIC PRACTICE"
    list:
      - "Tempera and gold leaf on panel with dense chrysography and punched halos"
      - "Serial adaptation of Marian half-length formulas for varying scales and settings"
      - "Workshop repetition of Giuntesque facial and drapery motifs with local inflections"
      - "Strong emphasis on icon-like frontality and symbolic gold-ground sacral space"
      - "Controlled variation between public liturgical and intimate devotional formats"

  - title: "STYLE"
    list:
      - "Conservative Italo-Byzantine language rooted in Pisan maniera greca"
      - "Giuntesque line systems, strigil-like folds, and incisive facial typologies"
      - "Hierarchy and frontal symmetry prioritized over deep spatial construction"
      - "Selective softening toward affective Marian tenderness in Sienese-related works"
      - "Transitional profile between strict icon formalism and later Gothic naturalization"

  - title: "KEY WORKS"
    list:
      - "Madonna del Patrocinio, Santi Cosma e Damiano, Pisa, c. 1260-1270"
      - "Madonna dei Mantellini, San Niccolo al Carmine / Pinacoteca Nazionale, Siena, c. 1260-1270"
      - "Madonna and Child with Two Angels, inv. 1574, Museo Nazionale di San Matteo, Pisa, c. 1260"
      - "Madonna and Child with Two Angels, inv. 1575, Museo Nazionale di San Matteo, Pisa, c. 1260"
      - "Madonna and Child, Fogg Art Museum (Harvard), c. 1260-1270"
      - "Virgin and Child, Galleria Regionale della Sicilia, Palermo (attributed)"
      - "Saint Mary Magdalen, Yale University Art Gallery (attributed)"
      - "Biccherna cover of Frate Ugo, Archivio di Stato, Siena, 1258, under Gilio di Pietro attribution"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Defines a key anonymous node linking Pisan Giuntesque tradition and Sienese Marian devotion"
      - "Illustrates how conservative icon formulas persisted during stylistic transition in XIII-century Tuscany"
      - "Central case study for attribution debates between connoisseurship and archival identity"
      - "Important witness to the devotional and institutional image economy of Pisa and Siena"
  ...
  - title: "RELATED ENTRIES"
    links:
      ...
      - title: "Maestro di San Martino"
        url: "/Content/Artists/XIII%20century/Maestro%20di%20San%20Martino.html"
...
The artist, likely a workshop pupil of Giunta, worked during a transitional period toward the Gothic style, employing archaic features such as elongated proportions and emphatic gestures that foreshadow the more fluid style of Ugolino di Nerio or Cimabue.
Possibly originating from Pisan devotional contexts, it attests to the vitality of panel painting in medieval Tuscany, influenced by Mediterranean exchanges.
...
This image, a variant of the Maestà odigitria, distinct from the previous one, features a less curved throne and coarser details, confirming the master’s serial production in the Giunto workshop in Pisa.

The Virgin Mary sits on a simple throne, wearing a heavy dark blue mantle with vertical, jagged folds that fall stiffly, surmounted by a golden veil and a cruciform halo, while she points to her Son with her left hand in the Odigitria pose. The Infant Jesus, on her right knee, blesses with his right hand raised and holds a book or scroll, with plump limbs and his gaze directed toward his mother, surrounded by an elliptical halo. Two floating angels at the upper sides, with broad wings and red-yellow robes, adore the sacred pair, creating axial symmetry that guides the devout gaze toward the theological center.
This composition reflects Pisan Byzantine models, emphasizing Marian royalty and the Christological mission, a common feature in portable icons for private worship or processions in 13th-century mercantile Pisa.
...
The Virgin Mary is depicted in half-length within faded golden halos, wearing a heavy black-blue mantle and a fragmentary red robe, nursing the Child at her right breast in the glykophilousa pose (sweet kiss), while her left hand supports the Son’s head.
 Christ, chubby and blessing, turns his face toward the Marian milk—a Eucharistic symbol—with a small cruciferous halo and crossed legs in a judging gesture. Greek letters (MP ΘY) identify the Theotokos, while the absence of a throne emphasizes a protective intimacy, typical of ecclesiastical patronage.
