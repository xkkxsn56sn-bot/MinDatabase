...
subtitle: "Anonymous Romano-Campanian fresco master active in XIII-century Anagni"
dates: "active c. 1225-1255"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Maestro di San Pietro in Vineis (conventional attribution name)"
      - label: "Primary role"
        value: "Anonymous fresco painter working in ecclesiastical narrative programs"
      - label: "Period"
        value: "XIII century, first half to mid-century"
      - label: "Primary center"
        value: "Anagni (Lazio), in the Romano-Campanian artistic corridor"
      - label: "Documentary status"
        value: "Identified through stylistic attribution; no secure civil identity preserved"

  - title: "IDENTITY AND ATTRIBUTION"
    list:
      - "Notname derived from the church of San Pietro in Vineis at Anagni"
      - "Corpus established through fresco style and iconographic coherence"
      - "Often discussed in relation to the Anagni cathedral workshop milieu"
      - "Possible relation to the Terzo Maestro di Anagni remains debated"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Activity bracket"
        value: "c. 1225-1255, corresponding to first-half XIII-century campaigns"
      - label: "Historical frame"
        value: "Pontifical and episcopal prominence of Anagni in the age of Gregory IX"
      - label: "Workshop context"
        value: "Likely participation in multi-hand fresco enterprises in the Anagni area"
  ...
  - title: "PATRONAGE AND COMMISSIONS"
    list:
      - "Clarissan community of San Pietro in Vineis in Anagni"
      - "Probable episcopal patronage orbit linked to Anagni cathedral projects"
      - "Wider papal-curial cultural milieu active in XIII-century Anagni"
      - "Franciscan devotional environment emphasizing Passion imagery"
      - "Institutional ecclesiastical patrons rather than private courtly patrons"

  - title: "ARTISTIC PRACTICE"
    list:
      - "Buon fresco on wet intonaco in narrative church cycles"
      - "Workshop-based execution with differentiated hands across programs"
      - "Strong use of linear contour and tonal modulation for expressive faces"
      - "Compositions organized in shallow narrative registers for liturgical readability"
      - "Integration of Byzantine-derived conventions into local central Italian practice"

  - title: "STYLE"
    list:
      - "Romano-Campanian synthesis of Byzantine structure and growing emotional immediacy"
      - "Plastic, weighty figures compared to more rigid earlier mannera greca schemes"
      - "Warm chromatic range with controlled highlight-shadow modeling"
      - "Drapery that balances decorative rhythm and bodily indication"
      - "Heightened Passion pathos aligned with Franciscan spirituality"

  - title: "KEY WORKS"
    list:
      - "Passion of Christ cycle, San Pietro in Vineis, Anagni, c. 1225-1255"
      - "Deposizione nel Sepolcro (Deposition in the Tomb), c. 1255, fresco, San Pietro in Vineis, Anagni"
      - "Bacio di Giuda (Kiss of Judas), c. 1255, fresco, San Pietro in Vineis, Anagni"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Key anonymous witness to XIII-century central Italian fresco culture"
      - "Important bridge between Roman-Byzantine inheritance and emerging proto-Gothic expressivity"
      - "Essential for understanding the Anagni workshop constellation"
      - "Contributes to mapping Franciscan-era devotional imagery before later Tuscan transformations"
  ...
  - title: "RELATED ENTRIES"
    links:
      ...
      - title: "Maestro Aula della Curia"
        url: "/Content/Artists/XIII%20century/Maestro%20Aula%20della%20Curia.html"
