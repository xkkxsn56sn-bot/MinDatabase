...
subtitle: "Anonymous fresco painter of the Romano-Campanian tradition, active in Anagni"
...
meta:
  ...
  - title: "LOCATION"
    list:
      - "Anagni, Lazio (primary)"
      - "Central Italy (probable wider itinerary)"

  - title: "DOCUMENTED ACTIVITY"
    pairs:
      - label: "Designation"
        value: "Nome di convenzione derived from the church of San Pietro in Vineis, Anagni"
      - label: "Active"
        value: "First half of the 13th century (notizie prima metà sec. XIII)"
      - label: "Possible identification"
        value: "Possibly identical with, or a direct follower of, the Terzo Maestro di Anagni"
      - label: "Technique"
        value: "Buon fresco (pigment applied to wet intonaco)"

  - title: "PATRONAGE"
    list:
      - "Clarissan community of San Pietro in Vineis, Anagni"
      - "Bishop of Anagni (probable, for the cathedral context)"
      - "Papal court milieu of Gregory IX (1227–1241)"

  - title: "KEY WORKS"
    list:
      - "Passion of Christ cycle, church of San Pietro in Vineis, Anagni, c. 1225–1255"
