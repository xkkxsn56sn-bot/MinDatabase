...
meta:
  - title: Identity
    pairs:
      - label: Notname
        value: Master of Saints Cosmas and Damian (Maestro dei Santi Cosma e Damiano)
      - label: Also known as
        value: Master of the Madonna of Saints Cosmas and Damian
      - label: Possible civil name
        value: Gilio di Pietro (proposed by Luciano Bellosi; debated)
      - label: Born
        value: Unknown; probably Pisa or contado, second quarter of 13th century
      - label: Died
        value: Possibly Siena, 1261 (if identified with Gilio di Pietro)
      - label: Nationality
        value: Italian (Pisan–Sienese)
      - label: Active period
        value: c. 1240 – c. 1270
      - label: Media
  ...
  - title: School & Training
    pairs:
      - label: School
        value: Pisan school; maniera greca
      - label: Training
        value: Workshop of Giunta Pisano or closely related Pisan atelier
      - label: Style
        value: Italo-Byzantine; conservative Giuntesque idiom with Sienese inflections
      - label: Notname coined by
        value: Edward B. Garrison, 1949

  - title: Patrons
    list:
      - Church of Santi Cosma e Damiano, Pisa — Madonna del Patrocinio, c. 1260–1270
      - Carmelite church of San Niccolò al Carmine, Siena — Madonna dei Mantellini, c. 1260–1270
      - Sienese Biccherna (communal financial office) — Biccherna cover, 1258 (as Gilio di Pietro)
      - Private and semi-private lay patrons — smaller devotional Madonnas (Fogg, Palermo)

  - title: Key Works
    list:
      - Madonna del Patrocinio (Madonna and Child) — church of Santi Cosma e Damiano, Pisa, c. 1260–1270
      - Madonna dei Mantellini — San Niccolò al Carmine, Siena (now Pinacoteca Nazionale, Siena), c. 1260–1270
      - Madonna and Child with Two Angels (inv. 1574, 87.6 × 50.2 cm) — Museo Nazionale di San Matteo, Pisa, c. 1260
      - Madonna and Child with Two Angels (inv. 1575, 85.4 × 56 cm) — Museo Nazionale di San Matteo, Pisa, c. 1260
      - Madonna and Child (64 × 44 cm) — Fogg Art Museum, Harvard University, Cambridge MA, c. 1260–1270
      ...
      - Biccherna cover (Frate Ugo) — Archivio di Stato, Siena, 1258 (as Gilio di Pietro)

  - title: Artistic Influences
    list:
      - Giunta Pisano — primary model for facial typologies, chrysography, strigil drapery patterns, and Christus patiens emotionalism
      - Byzantine maniera greca — frontal half-length Virgin and Child schemes, gold grounds, abstract symbolic space
      - Pisan maritime imports — Eastern Mediterranean icons, mosaics, and illuminated manuscripts via Crusader trade
      - Sienese Marian devotion — emerging Eleousa tenderness and affective piety (Guido da Siena, Dietisalvi di Speme)
      - Master of San Martino (Ugolino di Tedice) — closely related Pisan workshop idiom

  - title: Related Artists
    links:
      - title: Giunta Pisano (primary model and probable workshop origin)
        url: /Content/Artists/XIII%20century/Giunta%20Pisano.html
      - title: Master of San Martino (closely related Pisan peer)
        url: /Content/Artists/XIII%20century/Maestro%20di%20San%20Martino.html
      - title: Ugolino di Tedice (Pisan contemporary)
        url: /Content/Artists/XIII%20century/Ugolino%20di%20Tedice.html
      - title: Guido da Siena (Sienese contemporary)
        url: /Content/Artists/XIII%20century/Guido%20da%20Siena.html
      - title: Dietisalvi di Speme (Sienese contemporary)
        url: /Content/Artists/XIII%20century/Dietisalvi%20di%20Speme.html
      - title: Cimabue (successor)
