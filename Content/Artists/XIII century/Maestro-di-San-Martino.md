...
subtitle: "Anonymous Pisan master, often identified with Ugolino di Tedice"
dates: "active c. 1250-1290 (attribution-based chronology)"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Maestro di San Martino (conventional notname)"
      - label: "Probable identity"
        value: "Frequently identified with Ugolino di Tedice (hypothesis)"
      - label: "Primary role"
        value: "Panel painter in the Pisan Duecento tradition"
      - label: "Primary center"
        value: "Pisa and its ecclesiastical orbit"
      - label: "Period"
        value: "XIII century"
      - label: "Documentary status"
        value: "Attribution-defined corpus; identity reconstructed through stylistic and archival comparison"

  - title: "IDENTITY AND ATTRIBUTION"
    list:
      - "Notname derived from the Madonna of San Martino in Cinzica (Pisa)"
      - "Luciano Bellosi proposed identification with Ugolino di Tedice"
      - "Identification supported by physiognomic correspondences with the signed Hermitage Crucifix"
      - "Attribution remains influential but not universally accepted"
      - "Corpus formation strongly shaped by Roberto Longhi's connoisseurial reconstruction"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Early horizon"
        value: "c. 1250-1265, within the mature legacy of Giunta Pisano"
      - label: "Main phase"
        value: "c. 1265-1280, including major Marian commissions in Pisa"
      - label: "Late horizon"
        value: "c. 1280-1290, with works showing stronger dialogue with Cimabue and proto-naturalist trends"
      - label: "Documentary anchors"
        value: "If identified with Ugolino di Tedice: documented 1251-1277; deceased before 1286"

  - title: "FAMILY AND WORKSHOP CONTEXT"
    list:
      - "Likely linked to the Tedice workshop dynasty of Pisa"
      - "Possible kinship network includes Enrico di Tedice and Ranieri di Ugolino"
      - "Workshop practice implies transmission of models, panel preparation methods, and pigment recipes"
      - "Artistic profile reflects a specifically Pisan urban and ecclesiastical production context"

  - title: "PATRONAGE AND COMMISSIONS"
    list:
      - "Church of San Martino in Cinzica (Pisa)"
      - "Church of Sant'Anna (Pisa)"
      - "Possible Franciscan and confraternal devotional contexts"
      - "Likely commissions connected to cathedral-affiliated clergy and urban parish institutions"
      - "Probable participation in the liturgical visual culture of the Opera del Duomo environment"

  - title: "ARTISTIC PRACTICE"
    list:
      - "Tempera and gold on wooden panels"
      - "Gold-ground Marian altarpieces with narrative side scenes"
      - "Devotional crucifix production within Giuntesque traditions"
      - "Possible manuscript-related work (attribution debated)"
      - "Sophisticated surface finishing with incisions, gilding, and luminous brush highlights"

  - title: "STYLE"
    list:
      - "Giuntesque foundation reworked through heightened luminosity and narrative expressiveness"
      - "Characteristic strigilature luminose in drapery, landscape accents, and flesh highlights"
      - "Warm chromatic modulation and less rigid contouring than many contemporary Byzantine-derived models"
      - "Strong emotional tenor in faces, especially in Marian and Passion imagery"
      - "Selective assimilation of classicalizing volume associated with Nicola Pisano's sculptural milieu"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Giunta Pisano"
      - "Byzantine neo-Hellenic visual culture"
      - "Nicola Pisano and the Pisan sculptural classicizing current"
      - "Early Cimabue in Pisa"
      - "Possible stylistic kinship with the Third Master of Anagni (identity debated)"

  - title: "KEY WORKS"
    list:
      - "Madonna di San Martino, c. 1270, Museo Nazionale di San Matteo, Pisa"
      - "Saint Anne Enthroned with the Infant Mary and Two Angels, Museo Nazionale di San Matteo, Pisa"
      - "Crucifix signed 'Ugolinus', c. 1250-1260, State Hermitage Museum, Saint Petersburg"
      - "Cristo Benedicente (fragment), Museo Nazionale di San Matteo, Pisa"
      - "Monk before Saint Francis, c. 1285 (attributed), Philadelphia Museum of Art, Johnson Collection"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Key mediator between mature Italo-Byzantine Pisan painting and later Duecento renewal"
      - "Essential case for attribution studies linking named and anonymous masters"
      - "Important witness to Pisan Marian and Passion devotion in panel form"
      - "Central to debates on pre-Cimabuesque and proto-naturalist developments in Tuscany"
...
[Roberto Longhi](/scholars.html#longhi-roberto), the scholar who did most to define the painter's canonical corpus, attributed to him a small panel depicting a monk before Saint Francis, now in the Johnson Collection at the Philadelphia Museum of Art, which implies a Franciscan commission and thereby connects the Maestro to the thriving culture of mendicant patronage that shaped so much of Duecento art in central Italy. A further work attributed by Longhi is a *Madonna col Bambino e angeli* formerly in the Acton Collection in Florence, a panel that critics from Caleca onward have dated to approximately 1290 and that implies a patron from the circles of the Florentine or Tuscan nobility capable of acquiring a prestigious Pisan altarpiece for a private or semi-private devotional setting.

The church of San Biagio in Cisanello, a suburban parish of Pisa, provided the provenance for a Madonna with Child that some scholars, including [Cuppini](/scholars.html#cuppini-luciano), have attributed to the Maestro, though [Carli](/scholars.html#carli-enzo) later expressed reservations about this attribution on stylistic grounds, noting the painting's markedly archaic, Coppo-influenced character. The possible attribution of miniatures in a Pisan Exultet scroll (*Exultet 3* of the Museo dell'Opera della Primaziale Pisana) to the same hand, proposed by Carli in 1958, would indicate that the painter also worked within the liturgical production of the Pisan Opera del Duomo, the administrative body responsible for the fabric and furnishings of the cathedral.
