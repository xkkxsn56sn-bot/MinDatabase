---
layout: entry
title: "Maestro di Faenza"
subtitle: "Anonymous Duecento painter active between Faenza and Bologna"
dates: "Active c. 1260-1290 (probable peak around 1280)"

meta:
  - title: "IDENTITY"
    pairs:
      - label: "Name"
        value: "Conventional notname: Maestro di Faenza"
      - label: "Named by"
        value: "Edward Garrison (1949), from the Faenza panel"
      - label: "Status"
        value: "Anonymous painter reconstructed through attributed corpus"
      - label: "Origin"
        value: "Probably Emilia-Romagna (Faenza-Bologna orbit)"
      - label: "Chronology"
        value: "Late XIII century; generally dated to the last quarter of the Duecento"
  ...
  - title: "BIOGRAPHICAL DATA"
    pairs:
      ...
      - label: "Death"
        value: "Unknown; no documentary evidence"
      - label: "Family"
        value: "Unknown; no secure archival references to parents, marriage, or descendants"
      - label: "Workshop"
        value: "Not documented; stylistic consistency suggests workshop context or close circle"

  - title: "GEOGRAPHY OF ACTIVITY"
    list:
      - "Faenza - principal reference point; eponymous panel now in civic collection"
      - "Bologna - strong stylistic relation to contemporary illumination and panel language"
      - "Umbria-Romagna corridor - broader devotional and artistic network"
      - "Possible links to Assisi-related Franciscan visual culture"

  - title: "PATRONS AND COMMISSION CONTEXT"
    list:
      - "Likely ecclesiastical or mendicant patrons rather than courtly aristocratic patronage"
      - "Probable Augustinian context for the Faenza panel (hypothesis tied to San Giovanni Evangelista)"
      - "Commissions shaped by liturgical and didactic devotional functions"
      - "Possible donor allusion via inclusion of Saint Peter in the Crucifixion register"

  - title: "MEDIA AND TECHNIQUE"
    list:
      - "Tempera on panel"
      - "Gold-ground devotional panel tradition"
      - "Compact narrative formats"
      - "Structured register-based composition"

  - title: "STYLE"
    list:
      - "Transitional language between Byzantine formal order and late Duecento emotional naturalism"
      - "Severe, linear figuration with controlled pathos"
      - "Narrative compression with clear iconographic hierarchy"
      - "Early spatial experimentation (figures interacting with frame divisions)"
      - "Strong relation to Bolognese manuscript culture"

  - title: "INFLUENCES"
    list:
      - "Giunta Pisano and the Christus patiens model"
      - "Bolognese miniature painting of the late XIII century"
      - "Byzantine iconographic inheritance adapted to mendicant devotional needs"
      - "Regional Emilia-Romagna and Umbrian visual circulation"

  - title: "MAIN WORKS"
    list:
      - "Crucifixion and Ascension of Saint John the Evangelist, c. 1280, tempera on panel, Pinacoteca Comunale di Faenza"
      - "Nativity of Christ, 1275-85, tempera and gold on panel, Pinacoteca Nazionale di Bologna (attribution debated)"
      - "Deposition from the Cross, 1275-85, tempera and gold on panel, Pinacoteca Nazionale di Bologna"
      - "Lamentation over the Dead Christ, 1275-85, tempera on panel, Pinacoteca Nazionale di Bologna"

  - title: "ATTRIBUTION NOTES"
    list:
      - "Corpus historically linked to Luciano Cuppini's reconstruction of a Bolognese panel group"
      - "Part of the Bolognese material has been reassigned in later scholarship to the Master of Forli"
      - "Attribution remains partly open; consensus strongest around the Faenza panel"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Important witness to late Duecento transitions in central-northern Italian panel painting"
      - "Key example of interaction between panel painting and manuscript visual culture"
      - "Relevant to the spread of affective Passion iconography in mendicant contexts"
...
The scene of the Crucifixion occupies the upper register of the panel. At the center is Christ on the cross, depicted in the tradition of the 13th-century Christus Patiens, with his body yielding to the weight of death, clearly influenced by the style of Giunta Pisano, whom the painter regards with conscious stylistic admiration.
On either side of the cross are the Three Marys and Saint John the Evangelist, canonical figures in medieval Crucifixion scenes. The entirely unusual presence of Saint Peter—who plays no narrative role in this Gospel episode—is generally interpreted by critics as an explicit reference to the panel’s patron, who thus intended to include his patron saint in the sacred image.

Noteworthy is the spatial effect created by the figures in this upper register: their figures step on the red frame that divides the two levels of the panel, suggesting a hint of depth and spatial realism that is quite early in the context of late 13th-century Italian painting. 
At the upper edges of the scene, mourning angels are visible, though unfortunately partially mutilated since the panel was cut by several centimeters at the top and bottom margins at an unknown date.
...
The style of the Faenza panel, however, appears more mature than that of the Bolognese panels attributed to the anonymous master, and this led [Giovanni Valagussa](/scholars.html#valagussa-giovanni-francesco-maria) (2002) to date it to the years around 1280, a phase in which the artist had already assimilated the teachings of Giunta Pisano.

[Anna Tambini](/scholars.html#tambini-strocchi-anna) has hypothesized, without finding documentary confirmation, that the panel comes from the old Augustinian church of San Giovanni Evangelista in Faenza, built between 1266 and 1290, a dedication that would perfectly explain the choice of the apocryphal episode of the Ascension as the work’s main theme. The panel entered the public collections of Faenza in 1884 through a bequest from the Civil Hospital.
...
John’s position, leaning forward with his body almost stretched out over the sarcophagus to draw closer to the Master’s face, conveys a physical and visceral pain of rare intensity given the panel’s very small dimensions.
