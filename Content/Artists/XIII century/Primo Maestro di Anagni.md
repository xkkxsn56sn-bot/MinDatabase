...
subtitle: "Anonymous Roman-Lazian fresco painter; Maestro delle Traslazioni of the Crypt of San Magno, Anagni Cathedral"
dates: "Active c. 1231–1255 (conventional) or c. 1072–1104 (Boskovits)"

meta:
  - title: "PERIOD"
    list:
      - "XI–XII century (Boskovits dating: episcopate of Bishop Pietro da Salerno, c. 1072–1104)"
      - "XIII century (conventional dating: episcopate of Bishop Alberto of Anagni, c. 1231–1255)"

  - title: "ROLE"
    list:
      - "Fresco painter, Roman-Lazian school"
      - "Master of the hagiographic and cosmological cycles, Crypt of San Magno"
      - "Head of an independent workshop active in central Lazio"

  - title: "LOCATION"
    list:
      - "Anagni Cathedral, Anagni (Frosinone), Lazio — primary site"
      - "Probable formation in Rome and the Roman Campagna"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Unknown; possibly late XI century (Boskovits) or late XII century (conventional)"
      - label: "Death"
        value: "Unknown; after completion of the Anagni crypt commission"

  - title: "PATRONAGE"
    pairs:
      - label: "Primary patron (Boskovits)"
        value: "Bishop Pietro da Salerno, Diocese of Anagni, c. 1072–1104"
      - label: "Primary patron (conventional)"
        value: "Bishop Alberto of Anagni, c. 1231–1255"
      - label: "Institutional patron"
        value: "Chapter of the Cathedral of Santa Maria Assunta, Anagni"
      - label: "Broader context"
        value: "Papal orbit of Anagni; the city of origin of four medieval popes, including Gregory IX (1227–1241)"

  - title: "KEY WORKS"
    list:
      - "Life and Translations of Saint Magnus — hagiographic fresco cycle, Crypt of San Magno, Anagni Cathedral (in situ)"
      - "Macrocosmo e Microcosmo — cosmological vault programme, second vault, Crypt of San Magno, Anagni Cathedral (in situ)"
      - "Hippocrates and Galen composition — Crypt of San Magno, Anagni Cathedral (in situ)"
      - "Apsidal frescoes — Crypt of San Magno, Anagni Cathedral (in situ)"
...
The procession of the body from Fondi, where Magnus died, to Veroli, where it was first interred with honour, fills the second scene with a richly populated processional composition in which the draped bier, carried on the shoulders of attendants, is accompanied by a crowd of mourners and celebrants whose differentiated physiognomies, including a remarkable group of women who have attracted scholarly attention as perhaps the earliest representation of women as an autonomous social group at a public event in Italian painting, speak to the Primo Maestro's talent for crowd characterization. 