...
subtitle: "Painter from Arezzo active between Assisi, Rome, Naples, Aversa, and Montevergine"
dates: "c. 1265 - after 1313"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Montano d'Arezzo"
      - label: "Primary role"
        value: "Panel painter and fresco painter"
      - label: "Period"
        value: "XIII century, late Duecento and early Trecento"
      - label: "Primary centers"
        value: "Arezzo, Assisi, Rome, Naples, Aversa, Montevergine"
      - label: "Documentary status"
        value: "Sparse archival references, with career reconstructed mainly from payments and attributed works"

  - title: "IDENTITY AND BIOGRAPHICAL LIMITS"
    list:
      - "Born in Arezzo, probably in the second half of the 1260s"
      - "No secure record of family background, apprenticeship, or patronymic survives"
      - "Early formation is inferred from stylistic links to Aretine, Assisan, and Roman painting"
      - "The documentary record becomes substantial only once he enters Angevin patronage in Naples"
      - "The date, place, and cause of death remain unknown"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Birth"
        value: "c. 1265-1269, Arezzo"
      - label: "Assisi phase"
        value: "Early 1280s, likely study of the Basilica of San Francesco campaigns"
      - label: "Naples, Minutolo chapel"
        value: "Late 1290s or early 1300s, earliest major Neapolitan work"
      - label: "San Lorenzo Maggiore"
        value: "c. 1300-1307, Marian fresco cycle in the right transept"
      - label: "Montevergine and Philip of Taranto"
        value: "1310, documented payment and feudal reward"
      - label: "Last known trace"
        value: "1313, Angevin records relating to property matters"

  - title: "PATRONAGE AND COMMISSIONS"
    list:
      - "Angevin court in Naples, especially Charles II of Anjou and Philip of Taranto"
      - "Archbishop Filippo Minutolo for the funeral chapel in Naples cathedral"
      - "Franciscan environment at San Lorenzo Maggiore in Naples"
      - "Royal and princely commissions at Castel Nuovo, Castel dell'Ovo, Aversa, and Montevergine"
      - "Local Dominican or lay patronage in Arezzo, especially San Domenico"

  - title: "ARTISTIC FORMATION"
    list:
      - "Aretine training shaped by the memory of Cimabue and earlier local painting"
      - "Assisi exposure to the Upper Basilica and to the visual culture of the Franciscan chantier"
      - "Roman contact with Cavallinian painting and classicizing fresco idioms"
      - "Neapolitan work shaped by Angevin ceremonial demands and mendicant devotion"
      - "A career defined by mobility between regional centers rather than by a single workshop tradition"

  - title: "STYLE AND ICONOGRAPHY"
    list:
      - "Combination of Italo-Byzantine solemnity with emerging volumetric naturalism"
      - "Measured architectural settings and controlled narrative clarity"
      - "Softer modeling and richer chromatic effects in the Neapolitan works"
      - "Attention to Marian iconography, funerary themes, and courtly sacred imagery"
      - "Strong mediation between Tuscan linearity, Assisan narrative experimentation, and Roman classicism"

  - title: "KEY WORKS"
    list:
      - "Madonna of Montevergine, c. 1296-1310, tempera and gold leaf on panel, Santuario di Montevergine, Mercogliano"
      - "Frescoes of the Minutolo chapel, Naples cathedral, late 1290s or early 1300s"
      - "Nativity, c. 1306-1307, fresco, Basilica of San Lorenzo Maggiore, Naples"
      - "Dormitio Virginis, c. 1306-1307, fresco, Basilica of San Lorenzo Maggiore, Naples"
      - "Lost chapels in Castel Nuovo and Castel dell'Ovo, 1305-1306"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Important mediator of central Italian pictorial language in Angevin Naples"
      - "Key figure for the transfer of Assisan and Roman innovations to the southern kingdom"
      - "One of the painters who helped shape a local Angevin visual language before Giotto's Neapolitan phase"
      - "Representative of the mobility and transregional exchange that defined late Duecento painting"
...
The documented career of Montano emerges clearly only once he is already active in the orbit of the Angevin court in Naples, revealing nothing about his eventual return to Arezzo or the circumstances of his death. Archival records from the Angevin chancery describe him as "magister Montanus pictor" and later as "fidelis" and "familiaris", indicating a close personal and professional relationship with the royal family. In 1305 he received payments from King Charles II<a href="../../../endnotes.html#fn-charles-ii-anjou" class="footnote"><sup>1</sup></a> for the painting of two chapels in Castel Nuovo, while in 1306 he decorated two chapels in Castel dell’Ovo, works that are now lost but attest to his prestige at court. In 1308 he was paid for a painted crucifix and for the decoration of the refectory and chapter house of the church of San Ludovico in Aversa, again on royal commission. A document from 1310 records that he worked for Philip of Taranto<a href="../../../endnotes.html#fn-philip-i-taranto" class="footnote"><sup>2</sup></a>, brother of King Robert<a href="../../../endnotes.html#fn-robert-anjou" class="footnote"><sup>3</sup></a>, particularly in the decoration of Philip’s chapel in his Neapolitan palace and of a chapel in the sanctuary of Montevergine, for which he received feudal properties, a reward underscoring his status. His name appears one last time in the Angevin registers in 1313, in connection with property matters, after which all trace of him disappears and neither the place nor the cause of his death is recorded.
...
The Madonna of Montevergine by Montano d'Arezzo is one of the most impressive and significant panel paintings of Southern Angevin art, most likely dating from around 1296–1310, and is part of the documented works commissioned by the Angevin court at the Irpinia abbey.
Documentary sources attest that in 1310 Montano d'Arezzo, described as a “familiar” of Philip of Anjou, Prince of Taranto, received payment for the execution of paintings both in the chapel of the prince’s Neapolitan residence and at the Abbey of Montevergine (*in ecclesia Beate Marie de Monte Virginis*).

The historian [Pierluigi Leone de Castris](/scholars.html#leone-de-castris-pierluigi) has proposed a date for the panel around 1296/1297, placing the commission within the sphere of influence of Philip of Anjou. Although no document explicitly mentions the panel—the contract concerns the decoration of a chapel—Giovanni Antonio Summonte suggested as early as 1601 that Montano might also have created the altarpiece at the same time, and this attribution is now almost unanimously accepted by critics. The work was placed in the Angevin noble chapel, built in the last decade of the 13th century.
