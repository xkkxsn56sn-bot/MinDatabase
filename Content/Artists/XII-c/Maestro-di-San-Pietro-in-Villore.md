...
subtitle: "Anonymous Tuscan–Umbrian Panel Painter"
dates: "Active ca. 1175–1200"

meta:
  - title: "IDENTITY"
    pairs:
      - label: "Name variants"
        value: "Master of San Pietro in Villore; Maestro della Croce di Villore; Umbro-Sienese Master"
      - label: "Field"
        value: "Romanesque panel painting; monumental painted crucifix (tavola cruciforme)"
      - label: "Attribution status"
        value: "Anonymous master named after principal attributed work; possible workshop identity (maestranza); no documentary identification"
  ...
  - title: "CHRONOLOGY"
    pairs:
      - label: "Estimated lifespan"
        value: "Born ca. 1145–1155 (southern Tuscany or Spoleto area; conjectural), died after ca. 1200 (not documented)"
      - label: "Activity window"
        value: "ca. 1175–1200 (last quarter of the twelfth century, based on stylistic dating)"
  ...
  - title: "LOCATION"
    list:
      - "Southern Tuscany — Crete Senesi and Val d'Orcia borderland (principal area of activity)"
      - "San Giovanni d'Asso and surroundings, Province of Siena"
      - "Spoleto area, Umbria (possible origin or formative training ground; conjectural)"

  - title: "KEY WORKS"
    list:
      - "Croce dipinta (Christus triumphans), late XII century — tempera and gold on oak panel prepared with canvas, 177 × 116.5 × 12 cm (Museo Diocesano di Palazzo Borgia, Pienza; from the church of San Pietro in Villore, San Giovanni d'Asso)"
      - "Crucifix, late XII century — tempera on panel (Museo Civico e Diocesano d'Arte Sacra, Montalcino; from the Abbey of Sant'Antimo)"

  - title: "PATRONAGE"
    list:
      - "Church of San Pietro in Villore, San Giovanni d'Asso (principal commission; church itself completed in the context of Count Paltonieri di Forteguerra's submission to Siena, 1151)"
      - "Abbey of Sant'Antimo, Montalcino (probable second commission, if the Sant'Antimo crucifix attribution is accepted)"
      - "Ecclesiastical institutions of the Sienese contado and the monastic network of the Val d'Orcia"

  - title: "STYLE"
    list:
      - "Christus triumphans iconography — living, open-eyed Christ sovereign on the cross, before the turn toward Christus patiens"
      - "Strict frontal hieratic composition with rigid, symmetrical leg and foot placement on a distinct suppedaneum"
      - "Four full-length standing figures in lateral panels (rather than busts): Mary of Cleophas gathering Christ's blood in a chalice, Virgin Mary, John the Evangelist, Mary Magdalene"
      - "Cimasa with two flying angels displaying the blessing Redeemer in a clypeus — iconographic programme extending the cross into a vision of the Ascension"
      - "Half-length angels at the terminals of the horizontal arms"
      - "Strongly graphic manner: incisive, structurally primary contour line; linear articulation of anatomy; ornamental treatment of beard and perizoma"
      - "Luminous, vivid chromatic language: transparent veils of paint, chromatic contrasts in draperies and angels; translucent loincloth"
      - "Synthesis of monumental hieratic authority and unexpectedly delicate pictorial refinement — described by early writers as 'notably cordial'"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Spoleto school — active dialogue with Umbro-Spoletan traditions; close affinity with the Porziano Cross (Treasury Museum, Basilica of San Francesco, Assisi)"
      - "Alberto Sozio's signed Spoletan cross of 1187 — key comparative work for technique and iconographic culture"
      - "Central Italian Romanesque panel-painting tradition bridging Tuscany and Umbria"
      - "Distant antecedent of the Maestro di Tressa and the early Sienese Duecento tradition"
      - "Broader lineage leading toward Margarito d'Arezzo and the mature Duecento painted-cross culture"

  - title: "HISTORICAL SIGNIFICANCE"
    list:
      - "Among the earliest surviving examples of the Christus triumphans type in southern Tuscany"
      - "Key early node in the formation of the Sienese panel-painting tradition"
      - "Villore crucifix first securely documented in situ in 1813 (Ettore Romagnoli); transferred to Pienza Museo Diocesano in 1998 following conservation at the Pinacoteca di Siena"
      - "The iconographic motif of blood gathered in a chalice — clarified through comparison with the Porziano Cross — reflects a sophisticated theological programme centred on Eucharistic typology"
...
<figure>
 <img src="/Images/Maestro-San-Pietro-in-Villore/maestro-san-pietro-in-villore-01.jpg" alt="Christ Triumphant">
