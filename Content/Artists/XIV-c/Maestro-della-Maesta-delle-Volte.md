...
subtitle: "Anonymous Umbrian fresco painter; civic Marian image specialist"
dates: "Active c. 1310–1335"

meta:
  - title: "PERIOD"
    list:
      - "XIV century — first to second quarter (c. 1310–1335)"
      - "Early Trecento; transitional between Italo-Byzantine hieraticism and Giottesque plasticity"
      - "Commission for the eponymous Maestà recorded 1297; stylistic execution placed c. 1310–1320"

  - title: "ROLE"
    list:
      - "Fresco painter, Umbrian school"
      - "Specialist in public civic Marian images and urban devotional shrines"
      - "Local workshop master active in Perugia and the surrounding contado"
      - "Probable painter of portable panels and confraternal images in the Perugian district"

  - title: "LOCATION"
    list:
      - "Perugia, Umbria — principal base of activity; eponymous work in Via Maestà delle Volte"
      - "Oratory of the Maestà delle Volte (under vault of the Palazzo del Podestà), Perugia"
      - "Perugian contado: Valfabbrica, Sant'Egidio, Pieve Pagliaccia, Sant'Angelo (stylistically related works)"
      - "Possible exposure to Assisi (Basilica of San Francesco fresco cycles, Lower Church)"
      - "Active within the network of Umbrian communes: Spoleto, Assisi, Siena"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Unknown; inferred c. 1270s–1290s, likely in Perugia or the Umbrian region"
      - label: "Death"
        value: "Unknown; after 1335 (construction of oratory); possibly during or after the Black Death of 1348"

  - title: "TRAINING & INFLUENCES"
    list:
      - "Giottesque formation — structural debt to Giotto's Assisi cycles (Lower Church, San Francesco)"
      - "Sienese refinement — iconographic dependence on Duccesque prototypes, particularly the Maestà in the Palazzo Pubblico, Siena (as noted by Lunghi)"
      - "Byzantine iconographic heritage — adoption of the Theotokos Enthroned / Hodegetria Marian type"
      - "Stylistic affinity with Marino di Elemosina (Valdiponte Madonna comparisons; Scarpellini)"
      - "Part of the loose sodality of 'Maestri del 1310' — Umbro-Spoletine painters mediating Giottesque innovations for regional audiences"
      - "Proximity to the Maestro della Madonna di Perugia; debated overlaps and distinctions (Boskovits)"
      - "Possible awareness of the Maestro Espressionista di Santa Chiara, though his own manner is more restrained"

  - title: "PATRONAGE"
    pairs:
      - label: "Primary patron"
        value: "Communal authorities of Perugia — civic magistrates (priors) and/or cathedral chapter; commission linked to the decoration of the Palazzo del Podestà area, c. 1297–1320"
      - label: "Devotional context"
        value: "Public civic Marian shrine; apotropaic function — image painted under dark vault to deter malefactors and protect passers-by"
      - label: "Confraternal patronage"
        value: "Lay confraternities and devotional companies; oratory erected 1335 around the fresco, institutionalising cultic focus"
      - label: "Mendicant milieu"
        value: "Franciscan and Dominican environments in Perugia; attribution of angels bringing bread to Saint Dominic (debated)"
      - label: "Contado patronage"
        value: "Rural parishes, monasteries, and local confraternities in the Perugian contado seeking urban Marian prototypes"
      - label: "Later patrons"
        value: "Agostino di Duccio added sculptural revetment 1470; oratory rebuilt after fire of 1534; further Renaissance framing in 1567"

  - title: "KEY WORKS"
    list:
      - "Maestà delle Volte (Madonna Enthroned with Child and Angels), c. 1310–1330 — fresco (largely sinopia visible), Oratory of the Maestà delle Volte, Via Maestà delle Volte, Perugia (eponymous work; in situ)"
      - "Angels bringing bread to Saint Dominic — Perugia, Dominican context; attribution debated in scholarship"
      - "Marian images in the Perugian contado (Valfabbrica, Sant'Egidio, Pieve Pagliaccia, Sant'Angelo) — attributed by Scarpellini and Todini; stylistic relationship contested"

  - title: "STYLE"
    list:
      - "Enthroned Madonna type (Maestà); Theotokos Enthroned formulae inspired by Byzantine models reworked in Italian Gothic idiom"
      - "Monumental calm and centralized composition; celestial court of flanking angels"
      - "Modest volumetric articulation — more solid than Byzantine linearity, less robust than full Giottesque plasticity"
      - "Soft, somewhat schematic drapery folds; gentle, contemplative facial types with slightly elongated ovals"
      - "Spatial sensitivity to vault architecture — proportions and sight lines adjusted for oblique street-level viewpoint"
      - "Synthesis of Duccesque lyricism (Sienese elegance, colorism) and Assisi-derived Umbrian monumentality"
  ...
  - title: "KEY SCHOLARS"
    list:
      - "Pietro Scarpellini — related the Maestà delle Volte to Marian images in the Perugian contado; proposed grouping with Marino di Elemosina"
      - "Fabio Todini — co-attribution of contado Marian panels to the master's circle"
  ...
  - title: "RELATED ENTRIES"
    links:
      - title: "Maestro della Madonna di Perugia"
        url: "/Content/Artists/XIV-c/Maestro-della-Madonna-di-Perugia.html"
      - title: "Maestro delle Tempere Francescane"
        url: "/Content/Artists/XIV-c/Maestro-delle-Tempere-Francescane.html"
...
<figure>
  <img src="/Images/Maestro-della-Maesta-delle-Volte/maestro-della-maesta-delle-volte-01.jpg" alt="Madonna with the Child and angelic figures">
