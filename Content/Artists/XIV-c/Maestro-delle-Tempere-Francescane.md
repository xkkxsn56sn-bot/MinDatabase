...
subtitle: "Anonymous Neapolitan painter, \"Lorenzettian\" mediator between Giotto and the Sienese, visual interpreter of Franciscan Spiritual ideology at the Angevin court"
dates: "Active c. 1330–1345 (mid XIV century)"

meta:
  - title: "PERIOD"
    list:
      - "XIV century"
      - "Active mainly c. 1330–1345, with some works possibly extending into the 1350s"

  - title: "ROLE"
    list:
      - "Anonymous painter of panels and tempera-on-cloth works"
      - "Court painter working for the Angevin crown of Naples (King Robert of Anjou, Queen Sancia of Majorca)"
      - "Key mediator of Giottesque and Sienese innovations in the Neapolitan Trecento"
      - "Possible identification with Pietro Orimina, proposed by Ferdinando Bologna (1969)"

  - title: "LOCATION"
    list:
      - "Naples (base; Santa Chiara, San Domenico Maggiore, Castel Nuovo orbit)"
      - "Sardinia — Ottana, Nuoro (Pala di Ottana, former cathedral of San Nicola)"
      - "Basilicata — Colobraro (triptych, now Museo Diocesano Tursi-Lagonegro), Matera (Santa Lucia alle Malve fresco)"
      - "Campania (altarpieces for parish and collegiate churches)"
      - "Prague, National Gallery (portable tabernacle originally in Brno, bearing arms of Robert and Sancia)"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Unknown; possibly Naples (no archival source)"
      - label: "Death"
        value: "Unknown; probably after c. 1345–50 (no obituary or testamentary record; some catalogues propose c. 1382, but this is unattested)"

  - title: "DOCUMENTARY RECORD"
    pairs:
      - label: "Identity"
        value: "Anonymous; notname derived from four tempera-on-cloth paintings for Santa Chiara, Naples (1336), commissioned by King Robert of Anjou"
      - label: "Possible identification"
        value: "Pietro Orimina, documented 1328 for frescoes at Castel Nuovo (Ferdinando Bologna, 1969); hypothesis influential but not definitively proven"
      - label: "Datable commission"
        value: "Pala di Ottana — inscription allows dating to 1339–1344, during episcopate of Franciscan bishop Silvestro of Ottana and before Mariano IV became count of Arborea"
      - label: "Workshop context"
        value: "Scale of commissions presupposes a workshop of some size; related to the broader Orimina family milieu (Pietro and illuminator Cristoforo Orimina)"

  - title: "KEY WORKS"
    list:
      - "Four tempera-on-cloth panels for Santa Chiara, Naples (1336) — Madonna with Child between Mary Magdalene and Clare; Stigmatization of Saint Francis; Flagellation of Christ; Crucifixion with Robert of Anjou and Queen Sancia as donors — private collection"
      - "Pala di Ottana (Polyptych of San Nicola), 1339–44, tempera and gold on panel, 172 × 229 cm, former cathedral of San Nicola, Ottana (Nuoro, Sardinia)"
      - "Triptych: Madonna with Child, Saint John the Baptist, Saint John the Evangelist, Annunciation, Trinity, c. 1350, tempera on panel, 138 × 149 cm, Museo Diocesano Tursi-Lagonegro (formerly church of San Nicola, Colobraro)"
      - "Madonna of Humility with Saint Dominic and a donor, c. 1330–55, tempera on panel, Museo Nazionale di Capodimonte, Naples (formerly San Domenico Maggiore)"
      - "Madonna and Child, c. 1330–50, tempera on panel, 37 × 20 cm, private collection"
      - "Fresco fragment (head of a saint), rock church of Santa Lucia alle Malve, Matera"
      - "Portable tabernacle / polyptych with arms of Robert of Anjou and Queen Sancia, National Gallery, Prague (originally Brno)"
---
...
<figure>
  <img src="/Images/Maestro-delle-Tempere-Francescane/maestro-delle-tempere-francescane-05.jpg" alt="Madonna and Child between Saints Francis and Clare">
...
<figure>
  <img src="/Images/Maestro-delle-Tempere-Francescane/maestro-delle-tempere-francescane-02.jpg" alt="Ottana polyptych depicting Saints Francis and Nicholas and their respective stories">
...
At the foot of the throne are Bishop Silvestro and the young Mariano IV in prayerful and devout attitudes.
The two side registers constitute the richest and most fascinating narrative part of the polyptych. The left panel features eight scenes from the life and miracles of St. Francis, while the right panel features the same number of scenes from the life of St. Nicholas. 
...
<figure>
  <img src="/Images/Maestro-delle-Tempere-Francescane/maestro-delle-tempere-francescane-03.jpg" alt="Madonna of Humility with Saint Dominic and a donor">
...
<figure>
  <img src="/Images/Maestro-delle-Tempere-Francescane/maestro-delle-tempere-francescane-04.jpg" alt="Madonna and Child">
