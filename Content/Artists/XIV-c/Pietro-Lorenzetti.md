---
layout: entry
title: "Pietro Lorenzetti"
subtitle: "Sienese master of Trecento narrative painting, emotional drama, and early spatial experimentation"
dates: "c. 1280-1290 - 1348"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Pietro Lorenzetti (Petruccio di Lorenzo; Petrus quondam Lorenzetti; Petrus Laurentii)"
      - label: "Primary role"
        value: "Painter of fresco cycles, polyptychs, devotional panels, and predella narratives"
      - label: "Period"
        value: "Trecento Siena and central Italy, XIV century"
      - label: "Primary centers"
        value: "Siena, Assisi, Arezzo, Cortona, Pistoia"
      - label: "Documentary span"
        value: "From the 1306 record of Petruccio di Lorenzo to the securely dated Birth of the Virgin (1342)"

  - title: "IDENTITY AND FAMILY"
    list:
      - "Born in Siena in the late thirteenth century, probably between 1280 and 1290"
      - "Known as the brother of Ambrogio Lorenzetti, with joint work documented in 1335"
      - "Patronymic naming conventions later produced the modern surname Lorenzetti"
      - "No securely documented wife or children in surviving records"
      - "Family reconstruction depends heavily on inscriptions and sparse archival traces"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Birth"
        value: "Probably c. 1280-1290, Siena"
      - label: "Earliest documentary trace"
        value: "1306, as Petruccio di Lorenzo in Sienese records"
      - label: "First major dated anchor"
        value: "Arezzo polyptych for Guido Tarlati, 1320"
      - label: "Major mature commissions"
        value: "Assisi Passion cycle; Carmine altarpiece (1329); multiple late devotional and narrative works"
      - label: "Last securely documented work"
        value: "Birth of the Virgin, 1342, Siena Cathedral context"
      - label: "Death"
        value: "Generally placed in 1348, Siena, during the Black Death"

  - title: "PATRONAGE"
    list:
      - "Cardinal Napoleone Orsini at the Lower Basilica of San Francesco, Assisi"
      - "Guido Tarlati, bishop of Arezzo, patron of the 1320 high-altarpiece polyptych"
      - "Carmelite Order in Siena, commission for San Niccolo al Carmine (signed and dated 1329)"
      - "Opera del Duomo of Siena, including the 1342 Birth of the Virgin"
      - "Franciscan and diocesan contexts in Pistoia and Cortona"
      - "Multiple regional commissions now dispersed across Italian and international collections"

  - title: "STYLE"
    list:
      - "Dramatic narrative intensity combined with close observation of gesture and emotion"
      - "Synthesis of Sienese color and line with Giottesque monumentality"
      - "Strong sculptural plasticity often linked to the example of Giovanni Pisano"
      - "Innovative interior construction and proto-perspectival spatial logic"
      - "Refined handling of light, atmosphere, and temporal suggestion in narrative cycles"
      - "High technical sophistication in both fresco and panel formats"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Duccio di Buoninsegna and the Sienese workshop tradition"
      - "Giovanni Pisano and sculptural models of expressive physical form"
      - "Giotto and Florentine monumental narrative structure"
      - "Simone Martini and Sienese courtly refinement"
      - "Earlier thirteenth-century devotional expressionism in Tuscan and Umbrian contexts"

  - title: "TRAVELS AND GEOGRAPHY"
    pairs:
      - label: "Permanent base"
        value: "Siena throughout his documented career"
      - label: "Longest external campaign"
        value: "Assisi, roughly from the mid-1310s into the early 1320s"
      - label: "Other active centers"
        value: "Arezzo, Cortona, and Pistoia"
      - label: "Mobility profile"
        value: "Regionally active painter with commissions across Tuscan and Umbrian networks"

  - title: "DEATH AND LEGACY"
    list:
      - "Likely died in the 1348 plague that also ended Ambrogio Lorenzetti's career"
      - "Key figure in the first great phase of Sienese Trecento painting"
      - "Central to later debates on pre-Renaissance narrative and spatial innovation"
      - "Oeuvre survives largely in fragmented and dispersed altarpiece components"
      - "Continues to be reconstructed through connoisseurship, archival work, and technical study"
...
<p align="center">SANCTVS · ANTONIVS · AbS ·</p>
...
<p align="center">"Ascendit Elyas per turbinem in celum: Heliseus a[utem] videbat et clamabat: Pater mi, pater mi, currus…"</p>

In English:

<p align="center">"Elijah ascended into heaven by a whirlwind; and Elisha saw it and cried: My father, my father, the chariot…"</p>
...
The surviving gables contain half-length Evangelists, each accompanied by his symbol: Mark with the lion, John with the eagle, and Luke with the ox. The pinnacle of Matthew (with the angel) is lost. [Mario Salmi](/scholars.html#salmi-mario) further identified the central crowning Blessing Redeemer in a tondo now in a private collection.
