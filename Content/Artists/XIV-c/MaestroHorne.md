---
layout: entry
title: "Master of the Horne Triptych (Maestro del Trittico Horne)"
subtitle: "Anonymous Florentine Trecento painter in the orbit of the Master of Saint Cecilia"
dates: "Active early XIV century (mainly c. 1310-1330, attribution-based)"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Master of the Horne Triptych (Maestro del Trittico Horne), conventional notname"
      - label: "Primary role"
        value: "Anonymous painter of Florentine devotional panel paintings"
      - label: "Period"
        value: "Early Trecento (XIV century)"
      - label: "Main area"
        value: "Florence and Tuscan contado (Pescia, San Casciano in Val di Pesa, Pian del Mugnone)"
      - label: "Media"
        value: "Tempera and gold on panel"

  - title: "DOCUMENTARY STATUS"
    list:
      - "No securely identified personal name in surviving records"
      - "No documented birth, family registry, marriage contract, or testament"
      - "No secure death notice or burial record"
      - "Chronology reconstructed through stylistic comparison and dating of attributed works"
      - "Activity generally placed in the first half of the fourteenth century, with a strong concentration in the 1310s-1320s"

  - title: "ATTRIBUTION HISTORY"
    list:
      - "Initially grouped within the school of the Master of Saint Cecilia in early twentieth-century scholarship"
      - "Raimond van Marle and Bernard Berenson treated key works as linked to the Cecilia orbit"
      - "Richard Offner isolated an autonomous hand and coined the notname 'Master of the Horne Triptych' in the Corpus tradition"
      - "Klara Steinweg and later scholars expanded and refined the attributed corpus"
      - "Miklós Boskovits proposed identifying the group with a late phase of the Master of Saint Cecilia (possibly Gaddo Gaddi), a debated hypothesis"
      - "Recent scholarship and diagnostics continue to treat the authorship question as open"

  - title: "WORKSHOP AND PROFESSIONAL CONTEXT"
    list:
      - "Produced within the Florentine bottega system governed by the Arte dei Medici e Speziali"
      - "Likely close to the workshop culture around the Master of Saint Cecilia"
      - "Output profile suggests repeated production of small-to-medium devotional images for private and minor ecclesiastical patrons"
      - "Replicative compositional strategies indicate workshop-based adaptation of successful Madonna prototypes"

  - title: "PATRONAGE CONTEXT"
    list:
      - "Conventual settings (e.g., Maddalena convent at Pian del Mugnone)"
      - "Urban church contexts in Florence (e.g., Santo Stefano al Ponte)"
      - "Rural parishes in the Florentine contado (e.g., San Colombano a Bibbione, now San Casciano museum context)"
      - "Portable devotional panels compatible with lay domestic devotion"
      - "Corpus profile aligns with private-piety markets studied for Trecento Tuscany"

  - title: "STYLE"
    list:
      - "Close dependence on the Master of Saint Cecilia with softened Giottesque vocabulary"
      - "Compact enthroned Madonna formats, repeated with controlled variation"
      - "Lyrical, miniaturist tendency: refined line, decorative gold-ground handling, intimate devotional tone"
      - "Physiognomic consistency across corpus (elongated eyes, marked irises, pointed chin types, softly patterned drapery)"
      - "Moderate volumetric ambition relative to major Giottesque monumental painting"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Master of Saint Cecilia (primary immediate matrix)"
      - "Giotto's Florentine revolution, mediated through second-generation workshop practice"
      - "Sienese linear and chromatic refinement"
      - "Proximity to Florentine miniaturist culture connected with Pacino di Bonaguida"

  - title: "GEOGRAPHIC RANGE"
    pairs:
      - label: "Primary center"
        value: "Florence"
      - label: "Documented/attributed Tuscan nodes"
        value: "Pescia; Pian del Mugnone (Caldine); San Casciano in Val di Pesa"
      - label: "Modern collection dispersal"
        value: "Florence, Venice, Switzerland, Brussels provenance history, Detroit (for related tabernacle attribution)"
      - label: "Mobility profile"
        value: "No secure evidence of long-distance artist travel; corpus suggests predominantly local/regional production"

  - title: "PRINCIPAL ATTRIBUTED WORKS"
    list:
      - "Madonna and Child between Two Female Saints (eponymous Horne panel), Museo Horne, Florence"
      - "Madonna Enthroned with Child, Museo Civico, Pescia"
      - "Madonna from the Maddalena convent, Pian del Mugnone"
      - "Saint Peter Martyr, Santo Stefano al Ponte, Florence (historical attribution context)"
      - "Madonna and Child, Museo Giuliano Ghelli, San Casciano in Val di Pesa (from San Colombano a Bibbione)"
      - "Additional Madonnas and related small devotional works in historical private collections (including Cini provenance)"
...
scholars:
  ...
  - title: "Nardinocchi, Elisabetta"
    url: "/scholars.html#nardinocchi-elisabetta"
  - title: "Offner, Richard"
    url: "/scholars.html#offner-richard"
  - title: "Pasut, Francesca Rosa"
    url: "/scholars.html#pasut-francesca-rosa"
  - title: "Schmidt, Victor Michael"
    url: "/scholars.html#schmidt-victor-michael"
  - title: "Sirén, Osvald"
    url: "/scholars.html#siren-osvald"
  - title: "Steinweg, Klara"
    url: "/scholars.html#steinweg-klara"
...
The master shows a clear debt to the Master of Santa Cecilia—in the treatment of the garments, in the punched-out decorations of the halos, in the volumetric construction of the figures—updated by Sienese influences, visible in the relative softness of the Virgin’s face and in the chromatic refinement.
