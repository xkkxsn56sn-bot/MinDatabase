...
subtitle: "Bolognese painter-illuminator of the Trecento active between manuscript culture, courtly commissions, and monumental fresco cycles"
dates: "Documented c. 1355–1369; b. probably early XIV century (Bologna?); d. unknown, likely after 1369"

meta:
  - title: "PERIOD"
    list:
      - "XIV century"
      - "Middle to late Trecento (with documented activity from the 1350s to 1369)"

  - title: "IDENTITY"
    pairs:
      - label: "Name"
        value: "Andrea de' Bartoli, also known in the sources and signatures as Andrea da Bologna"
      - label: "Attribution issue"
        value: "Traditional identification of Andrea de' Bartoli with the signed Andrea da Bologna corpus remains debated in scholarship"
      - label: "Primary fields"
        value: "Manuscript illumination, panel painting, monumental fresco decoration"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Undocumented; generally placed in Bologna in the first quarter of the XIV century"
      - label: "Death"
        value: "Undocumented; last secure record connected to activity in 1369, with death often inferred in the 1370s or early 1380s"

  - title: "DOCUMENTARY RECORD"
    pairs:
      - label: "First documented activity"
        value: "c. 1355 (early professional horizon), with clearer documentary presence from 1359 in connection with Albornoz patronage"
      - label: "Last secure reference"
        value: "1369"
      - label: "Core archival context"
        value: "Collegio di Spagna and related Albornoz networks; later reconstructions by modern archival scholarship"

  - title: "PATRONS"
    list:
      - "Cardinal Egidio Albornoz — principal patronal axis"
      - "Federico Alvarez (Albornoz's nephew) — commissioner connected to the Assisi cycle"
      - "Cardinal Androin de la Roche — patronal continuity after Albornoz"
      - "Visconti court context at Pavia"
  ...
  - title: "KEY LOCATIONS"
    list:
      ...
      - "Marche (Corridonia and related Adriatic-Marchigian orbit)"

  - title: "KEY WORKS"
    list:
      - "Illuminations for the 'Canzone delle Virtu e delle Scienze' (with Bartolomeo de' Bartoli), Musee Conde, Chantilly, c. 1358-1368"
      - "Crucifix, c. 1370, tempera and gold on panel, Museo della Citta 'Luigi Tonini', Rimini"
      - "Our Lady of Humility, signed and dated 1372, Pinacoteca Parrocchiale, Corridonia"
      - "Virgin and Child with Angels (attributed), c. 1360, Pinacoteca Nazionale di Bologna"
      - "The Archangel Michael, c. 1355-1359, private collection"
      - "Christ Blessing fresco, c. 1365, Castello Visconteo, Pavia"
      - "Fresco cycle of Saint Catherine, c. 1368, Chapel of Saint Catherine, Lower Church of San Francesco, Assisi"

  - title: "ARTISTIC PROFILE"
    list:
      - "Synthesis of Bolognese Gothic refinement and neo-Giottesque volumetric/narrative ambitions"
      - "Strong carryover from manuscript practice: detail density, ornamental borders, and gold-ground sophistication"
      - "Adaptive handling across media: miniature, panel, and architectural fresco"
      - "Devotional iconography paired with courtly ceremonial and heraldic registers"

  - title: "INFLUENCES & COMPARANDA"
    list:
      - "Vitale da Bologna"
      ...
      - "Tommaso da Modena"
      - "Jacopo Avanzi"
      - "Bolognese manuscript illumination traditions"
      - "Byzantine pictorial survivals filtered through Trecento naturalism"

  - title: "LEGACY"
    list:
      - "Crucial witness to artistic mobility across ecclesiastical and courtly patronage systems in Trecento Italy"
      - "Central to debates on identity and corpus formation between documentary and stylistic methods"
      - "Key figure for studying transfer between manuscript idioms and monumental painting"

scholars:
  - title: "Filippini, Francesco"
    url: "/scholars.html#filippini-francesco"
...
The integration of his work into major ecclesiastical complexes like Assisi and the Collegio di Spagna ensured its preservation and continued visibility to subsequent generations of artists and patrons. Modern art historical scholarship has gradually reconstructed Andrea's career and significance through careful documentary research, particularly the work of [Francesco Filippini](/scholars.html#filippini-francesco) in the early twentieth century, who rediscovered and published crucial archival documents. The uncertain circumstances of his death reflect the broader challenges of documenting medieval artistic careers, where personal information was often considered less important than the works themselves and their ecclesiastical or civic functions.
...
- The sun ("clothed with the sun") appears as the golden radiate sun-face embroidered on the red gown at the Virgin's breast.

- The moon ("the moon under her feet") is the silver crescent at the lower left, beneath the hem of her mantle.
