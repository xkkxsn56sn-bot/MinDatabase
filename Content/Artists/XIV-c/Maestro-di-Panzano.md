...
subtitle: "Anonymous Sienese panel painter of the late Trecento, active in the Sienese contado and Val d'Arbia"
dates: "c. 1340s – c. 1400"

meta:
  - title: "PERIOD"
    list:
      - "XIV century"
      - "Late Trecento Sienese painting"

  - title: "ROLE"
    list:
      - "Anonymous panel painter (conventional name derived from the triptych at Panzano in Chianti)"
      - "Itinerant master serving rural parish churches, mendicant convents, and private patrons"
      - "Follower and close derivative of Luca di Tommè"

  - title: "LOCATION"
    list:
      - "Siena, Tuscany (probable base and area of formation)"
      - "Panzano in Chianti, Tuscany (namesake work)"
      - "Montalcino, Tuscany (dated commission, 1382)"
      - "Val d'Arbia and Sienese contado (broader area of activity)"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "c. 1340s, probably in or near Siena (conjectural)"
      - label: "Activity"
        value: "c. 1360 – c. 1400"
      - label: "Dated anchor"
        value: "Madonna with Child between Saints Ansanus and Lawrence, 1382, Museo Civico e Diocesano, Montalcino"
      - label: "Death"
        value: "Unknown; terminus post quem c. 1400 by convention of latest datable works"

  - title: "KEY WORKS"
    list:
      - "Triptych of the Mystic Marriage of Saint Catherine with Saints Peter and Paul (namesake work), c. 1390, tempera on panel, Pieve di San Leolino, Panzano in Chianti"
      - "Madonna with Child between Saints Ansanus and Lawrence (signed and dated 1382), Museo Civico e Diocesano, Montalcino"
      - "Madonna and Child Enthroned with Saints, c. 1380–1400, tempera and gold on panel, Walters Art Museum, Baltimore"
      - "Madonna in Majesty with Road to Calvary, Crucifixion, and Annunciation in tondo (triptych), Matthiesen Gallery, London"
      - "Annunciation with Saints Nicholas of Tolentino and others (Augustinian commission)"
      - "San Michele arcangelo, Madonna, Cristo, San Giovanni evangelista (predella fragment), Italian national cultural heritage catalogue"

  - title: "ARTISTIC PROFILE"
    list:
      - "Warm, intimate figure style combining Sienese elegance with gentle psychological humanism"
      - "Triptych format with central Maestà and lateral saints, inherited from Luca di Tommè"
      - "Rich palette of carmines, ultramarine blues, and gilded punched grounds with geometric tooling"
      - "Sinuous linear drapery in the tradition of Simone Martini; partial adoption of Lorenzettian spatial recession in throne compositions"
      - "Characteristic motif of the animated Christ Child grasping the Virgin's veil or holding his own foot"
      - "High-quality punzonatura on gold haloes recalling Sienese goldsmith tradition"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Luca di Tommè (primary and immediate, c. 1355–1389): volume, facial types, triptych composition"
      - "Duccio di Buoninsegna: foundational grammar of the enthroned Maestà"
      - "Simone Martini: sinuous linear rhythms, punched gold grounds, refined color harmonies"
      - "Pietro Lorenzetti: architectural throne with three-dimensional recession"
      - "Ambrogio Lorenzetti: psychological differentiation of subsidiary figures and flanking angels"

  - title: "PATRONS"
    list:
      - "Parish church of San Leolino, Panzano in Chianti (triptych, c. 1390)"
      - "Civic institution or confraternity, Montalcino (dated panel, 1382)"
      - "Augustinian Hermits (Annunciation with Saint Nicholas of Tolentino)"
      - "Private lay patrons and rural confraternities in the Sienese contado"

  - title: "SCHOLARLY RECEPTION"
    pairs:
      - label: "Isolated by"
        value: "Bernard Berenson, 1930 (separated from the corpus of Paolo di Giovanni Fei)"
      - label: "Key study"
        value: "D. Boucher de Lapparent, Revue du Louvre, March 1978"
      - label: "Catalogue entries"
        value: "Federico Zeri, Fondazione Zeri, Bologna (indispensable)"
      - label: "Name source"
        value: "Triptych at Pieve di San Leolino, Panzano in Chianti (topographic convention)"

  - title: "RELATED ENTRIES"
    links:
      - title: "Paolo di Giovanni Fei"
        url: "/Content/Artists/XIV-c/Paolo-di-Giovanni-Fei.html"
...
<figure>
  <img src="/Images/Maestro-di-Panzano/maestro-di-panzano-01.jpg" alt="Triptych of the Mystic Marriage of Saint Catherine with Saints Peter and Paul">
...
<figure>
  <img src="/Images/Maestro-di-Panzano/maestro-di-panzano-02.jpg" alt="Madonna and Child Enthroned with Saints">
...
<figure>
  <img src="/Images/Maestro-di-Panzano/maestro-di-panzano-03.jpg" alt="Madonna with Child between Saints Ansanus and Lawrence">
...
<figure>
  <img src="/Images/Maestro-di-Panzano/maestro-di-panzano-05.jpg" alt="Saint Nicholas of Tolentino">
...
<figure>
  <img src="/Images/Maestro-di-Panzano/maestro-di-panzano-04.jpg" alt="Madonna con Bambino in trono con San Giovanni Battista, Sant'Antonio Abate, San Pietro e Santa Caterina d'Alessandria">
