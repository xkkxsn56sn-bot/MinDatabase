...
subtitle: "Most prolific Florentine painter-illuminator of the early Trecento, leading exponent of the tendenza miniaturistica"
dates: "Documented c. 1302–1347 (fl. early XIV century)"

meta:
  - title: "PERIOD"
    list:
      - "XIV century"
      - "Early Trecento Florence, active across the first half of the fourteenth century"

  - title: "ROLE"
    list:
      - "Florentine painter and manuscript illuminator"
      - "Leading exponent of the tendenza miniaturistica (Richard Offner)"
      - "Prolific workshop director producing panels, choir books, and secular manuscripts"
      - "First Florentine illuminator to transfer Giotto's spatial conception systematically to the page"

  - title: "LOCATION"
    list:
      - "Florence (entire career, never documented outside the city)"
      - "Satellite hinterland: Badia di Settimo and Santa Maria a Impruneta (nearby destinations)"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Florence, c. 1280 (traditional scholarly estimate; no surviving document)"
      - label: "Death"
        value: "Unknown; probably Florence, after 1347 (no obituary or testamentary record found)"

  - title: "DOCUMENTARY RECORD"
    pairs:
      - label: "First document"
        value: "20 February 1303 — dissolution of partnership with Tambo di Serraglio; Pacino already described as publicus artifex in arte pictorum"
      - label: "Guild registration"
        value: "Enrolled in the matricola of the Arte dei Medici e degli Speziali c. 1329–30"
      - label: "Career span"
        value: "c. 1302–1347, approximately half a century of documented and attributable activity"

  - title: "KEY WORKS"
    list:
      - "Polyptych with Crucifixion and Saints (signed; commissioned by Simon Presbyter of San Firenze), c. 1310–19, Galleria dell'Accademia, Florence"
      - "Albero della Vita (Tree of Life), c. 1305–10, tempera and gold on panel, 248 × 151 cm, Galleria dell'Accademia, Florence — commissioned for the Clarissan convent of Monticelli"
      - "Laudario della Compagnia di Sant'Agnese (scattered leaves: Morgan Library, New York; Louvre, Paris; National Gallery of Art, Washington)"
      - "Corali G and Q with historiated initials, Archivio di Santa Croce, Florence (Franciscan choir books)"
      - "Antiphonaries for Santa Maria a Impruneta and Badia di Settimo"
      - "Approximately twenty-five illuminated copies of Dante's Divina Commedia"
      - "Illustrated vernacular manuscripts including copies of Valerius Maximus and Giovanni Villani's Nuova Cronica"
      - "Ordinamenti e statuti della Compagnia di Via San Gallo, 1317 (miniature)"

  - title: "ARTISTIC PROFILE"
    list:
      - "Tendenza miniaturistica: intimate scale of narration, multiple small-format scenes organized on a clearly ordered surface"
      - "Flat figure construction with shallow parallel drapery folds; volume suggested through tonal modulation rather than bold chiaroscuro"
      - "Warm palette: ochres, azurite blues, vermilion reds, with lavish gold ground, halos, and decorative tooling"
      - "Calm, slightly melancholic physiognomies with open eyes and soft expressivity"
      - "Sophisticated multi-scene compositional armatures (e.g., tree structure in Albero della Vita)"
      - "Progressive absorption of Gothic elegance and Bernardo Daddi's tenderness in later output (1320s–1330s)"
      - "Manuscript illumination achieves highest refinement: fluency in historiated medallions integrated within foliate borders"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Maestro di Santa Cecilia (identified with Gaddo Gaddi by Boskovits) — primary formal model for figure construction and tonal transitions"
      - "Giotto di Bondone — mediated influence on spatial composition and psychological individualization, transmitted through the Giottesque ambient"
      - "Cimabue — Byzantine-Italo heritage filtered through the generation of the Maestro di Santa Cecilia"
      - "Byzantine icon painting — gold ground conventions, hieratic frontality, decorative textile patterns"
      - "Bernardo Daddi — growing influence from c. 1325, introducing lightness of touch and tenderness of expression"

  - title: "PATRONS"
    list:
      - "Franciscan convent of Santa Croce, Florence (choir books, antiphonaries, and possible stained glass collaboration)"
      - "Clarissan convent of Monticelli, Florence (Albero della Vita)"
      - "Compagnia di Sant'Agnese, Santa Maria del Carmine, Florence (Laudario)"
      - "Benedictine community of the Badia di Settimo, near Florence (choir books)"
      - "Simon Presbyter of San Firenze, Florence (signed polyptych)"
      - "Lay confraternity of Via San Gallo, Florence (Ordinamenti, 1317)"
      - "Lay educated readers and collectors (Dante copies, Valerius Maximus, Villani)"

  - title: "WORKSHOP COLLABORATORS"
    list:
      - "Master of the Dominican Effigies — most significant collaboration; complementary style of compact compositions and swarthy figural types; joint work on Laudario and Impruneta antiphonaries"
      - "Maestro Daddesco — collaborative partner for select manuscript projects"
      - "Master of the Codex of Saint George — professional association for specific commissions"
      - "Matteo di Pacino — possible son or close relative; active after the Black Death of 1348; shows strong stylistic debts to the Pacinesque tradition (hypothesis, not documented)"

  - title: "KEY PHASES"
    list:
      - "Training in late Duecento Florence within the Maestro di Santa Cecilia circle (c. 1290s)"
      - "First documented activity: partnership with Tambo di Serraglio dissolved 1303"
      - "Major panel production and Franciscan patronage: Albero della Vita and Santa Croce choir books (c. 1305–20)"
      - "Expansion into secular manuscript illumination: Laudario, Dante copies, vernacular texts (c. 1315–40)"
      - "Guild registration in Arte dei Medici e degli Speziali c. 1329–30"
      - "Late workshop production under growing Daddesque influence, extending to c. 1347"

  - title: "THEMATIC KEYWORDS"
    list:
      - "Tendenza miniaturistica"
      - "Early Trecento Florentine painting"
      - "Franciscan and Clarissan patronage"
      - "Manuscript illumination and panel painting"
      - "Laudario and confraternal devotion"
      - "Albero della Vita / Lignum Vitae"
      - "Dante Divina Commedia illustration"
      - "Arte dei Medici e degli Speziali"
      - "Workshop organization and collaborative production"
