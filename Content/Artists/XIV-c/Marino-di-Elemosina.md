...
subtitle: "Umbrian painter active in Perugia, author of a refined Marian Maesta for the abbey of San Paolo di Valdiponte"
...
meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Marino di Elemosina (also cited as Marino d'Elemosina; signature: Marinus P.)"
      - label: "Role"
        value: "Umbrian panel painter active in Perugia; possible overlap with miniature culture"
      - label: "Period"
        value: "Early Trecento (late Duecento to early XIV-century transition)"
      - label: "Documentary status"
        value: "Sparse record; securely tied to one major Marian panel and civic restoration notice"

  - title: "CHRONOLOGY"
    pairs:
      - label: "First attestation"
        value: "c. 1309-1310, payment for restoration work in Palazzo dei Priori, Perugia"
      - label: "Signed evidence"
        value: "Marinus P. on Saint Paul's sword in the Maesta"
      - label: "Main work"
        value: "Madonna in trono col Bambino tra i santi Paolo, Pietro Celestino e quattro angeli"
      - label: "Date range in debate"
        value: "Commonly c. 1313, with arguments for an earlier dating near c. 1295"

  - title: "LOCATIONS"
    list:
      - "Perugia (primary documented center)"
      - "Palazzo dei Priori, Perugia (documented restoration activity)"
      - "Abbey of San Paolo di Valdiponte, Civitella Benazzone (original destination of principal panel)"
      - "Galleria Nazionale dell'Umbria, Perugia (current location of principal panel)"

  - title: "PATRONAGE PROFILE"
    list:
      - "Communal patronage: Perugian civic institutions"
      - "Monastic patronage: San Paolo di Valdiponte"
      - "Ecclesiastical networks linked to cathedral and convent contexts"
      - "Institutional commissions prioritized doctrinal clarity and liturgical usability"

  - title: "STYLE SUMMARY"
    list:
      - "Maesta structure balancing hieratic frontality and affective exchange"
      - "Byzantine residues with early Giottesque volumetric awareness"
      - "Sienese chromatic refinement filtered through Umbrian legibility"
      - "Materially attentive surfaces: gold ground, drapery rhythm, ornamental precision"
      - "Miniature-like descriptive detail in facial and textile treatment"

  - title: "INFLUENCE FIELD"
    list:
      - "Assisi pictorial grammar as structural regional matrix"
      - "Sienese inputs: Duccio and related currents"
      - "Umbrian workshop circulation between panel painting and illumination"
      - "Selective adaptation rather than direct imitation"

  - title: "HISTORIOGRAPHICAL NOTES"
    list:
      - "Biography depends on connoisseurship and institutional records"
      - "Identity and chronology remain open to technical and archival revision"
      - "Iconography of the right-hand monastic saint affects dating arguments"
      - "Best read as a provisional but historically useful artistic personality"
