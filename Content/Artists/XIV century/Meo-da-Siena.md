...
layout: entry
title: "Meo da Siena"
subtitle: "Sienese-trained panel painter, the most sought-after altarpiece painter in early Trecento Perugia"
dates: "Active c. 1310–before 1334; documented in Perugia 1319"

meta:
  - title: "PERIOD"
    list:
      - "XIV century"
      - "Early Trecento, first three decades"

  - title: "ROLE"
    list:
      - "Panel painter of Sienese formation active in Perugia"
      - "Specialist in polyptych altarpiece production for Umbrian ecclesiastical patrons"
      - "Mediator between Sienese Ducciesque inheritance and Umbrian devotional culture"

  - title: "IDENTITY"
    pairs:
      - label: "Full name"
        value: "Meo di Guido da Siena"
      - label: "Alternative name"
        value: "Bartolomeo Guarnieri (probable but unconfirmed)"
      - label: "Born"
        value: "Siena; date unknown"
      - label: "Died"
        value: "Unknown place; before 1334"
      - label: "Documented"
        value: "Perugia, 10 January 1319 (catasto of Porta San Pietro)"

  - title: "LOCATION"
    list:
      - "Siena (origin and training)"
      - "Perugia (principal center of activity from c. 1310–1319 onward)"
      - "Contado of Perugia: Mugnano / Megnano (property recorded in the 1319 catasto)"
      - "San Paolo a Monticelli, near Perugia (attributed frescoes)"

  - title: "KEY WORKS"
    list:
      - "Polittico di Montelabate (only signed work), c. 1320, Galleria Nazionale dell'Umbria, Perugia"
      - "Madonna col Bambino no. 23, c. 1325–30, Galleria Nazionale dell'Umbria, Perugia"
      - "Madonna col Bambino no. 24, c. 1308–10, Galleria Nazionale dell'Umbria, Perugia"
      - "Triptych: Madonna and Child, the Redeemer, and saints, Museo Capitolare, Perugia"
      - "Double-sided altar retable, 1330 or 1333, Städel Museum, Frankfurt am Main"
      - "Frescoes, San Paolo a Monticelli, near Perugia (attributed)"

  - title: "STYLE"
    pairs:
      - label: "Formation"
        value: "Ducciesque — unanimously recognised from Cavalcaselle onward"
      - label: "Virgin type"
        value: "Byzantine Hodegetria, adapted to Sienese Gothic polyptych format"
      - label: "Figural types"
        value: "Standardized devotional types with selective characterization (e.g. thick-haired St John the Evangelist, orientalizing St Emilian)"
      - label: "Format"
        value: "Multi-panel polyptych with Gothic architectural framework of trefoil cusps and ogival arches"
      - label: "Technique"
        value: "Tempera and gold leaf on panel; stamped and engraved halos; embossed silver ornament"
      - label: "Development"
        value: "Early work close to Duccio–Segna; later panels (1320s) reflect exchange with Perugian illuminators and Lorenzetti–Martini structural models"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Duccio di Buoninsegna — primary formal inheritance; Ducciesque matrix"
      - "Segna di Bonaventura — post-Duccio Sienese refinement for devotional contexts"
      - "Pietro Lorenzetti — polyptych architecture (Pieve d'Arezzo model, c. 1320)"
      - "Simone Martini — multi-panel design and elevated ecclesiastical finish (Santa Caterina, Pisa)"
      - "Perugian manuscript illuminators — exchange with local workshop culture"
      - "Byzantine iconographic memory — Hodegetria Virgin type; possible knowledge of painted cycles at Assisi"

  - title: "PATRONS"
    list:
      - "Benedictine abbey of Santa Maria di Valdiponte (Montelabate), near Perugia — principal commission site"
      - "Benedictine abbey of San Pietro, Perugia — high-altar retable (now Städel, Frankfurt)"
      - "Church of San Domenico, Perugia — pentaptych no. 25"
      - "Church of San Domenico Vecchio, Perugia — triptych (now Museo Capitolare)"
      - "Church of Santa Maria della Misericordia, Perugia — dossal fragment (panel no. 24)"
      - "Individual donor attested on panel no. 24"

  - title: "KEY PHASES"
    list:
      - "Sienese formation in Ducciesque tradition (pre-1310)"
      - "Arrival in Perugia: earliest presence debated (c. 1310, or shortly before 1319)"
      - "Montelabate polyptych and principal ecclesiastical commissions (c. 1318–1320)"
      - "Mature Perugian production and exchange with local illuminators (1320s)"
      - "Final documented activity: Frankfurt retable, 1330 or 1333"

  - title: "THEMATIC KEYWORDS"
    list:
      - "Sienese panel painting in Umbria"
      - "Early Trecento Perugia"
      - "Ducciesque formation"
