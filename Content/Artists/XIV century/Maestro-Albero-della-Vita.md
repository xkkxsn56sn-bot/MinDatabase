---
layout: entry
title: "Maestro dell'Albero della Vita"
subtitle: "Anonymous Bergamasque painter of the early Trecento, author of the monumental Tree of Life in Santa Maria Maggiore at Bergamo"
dates: "Active c. 1342–1347 (fl. first half of the XIV century)"

meta:
  - title: "PERIOD"
    list:
      - "XIV century"
      - "First half of the Trecento, centered on the second quarter of the fourteenth century"

  - title: "ROLE"
    list:
      - "Anonymous wall painter active in Bergamo and its territory"
      - "Author of the largest and most complex Lignum Vitae iconographic program known in Italian Trecento painting"
      - "Painter of theological and monumental fresco cycles for major ecclesiastical patrons in the Po Valley"

  - title: "LOCATION"
    list:
      - "Bergamo (principal center of activity)"
      - "Santa Maria Maggiore, Bergamo (main surviving monument)"
      - "Sant'Agostino, Bergamo (attributed Trinity)"
      - "Convent of San Francesco, Bergamo (attributed frescoes)"
      - "Church of the Santissima Trinità, Fiobbio, territory of Albino (attributed work)"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Unknown; probably Bergamo or its territory (no surviving document)"
      - label: "Death"
        value: "Unknown; probably Bergamo, after 1347 (no obituary or testamentary record found)"

  - title: "DOCUMENTARY RECORD"
    pairs:
      - label: "Conventional name"
        value: "Maestro Albero della Vita — modern scholarly designation derived from the fresco of the Tree of Life in Santa Maria Maggiore, Bergamo"
      - label: "Earliest secure reference"
        value: "c. 1342 — probable start of the Tree of Life commission; work certainly in existence by 1364, when mentioned in the basilica's account books"
      - label: "Main commission date"
        value: "1347 — associated with the completion of the Tree of Life, according to the donor inscription linked to Guidino de' Suardi"
      - label: "Patron"
        value: "Guidino de' Suardi, son of Tetualdo Suardi, resident near the piazza of the cathedral and Santa Maria Maggiore; documented in 1349, already dead by 1353"
      - label: "Catalog record"
        value: "Anonymous painter active in the first half of the fourteenth century, characterized by a refined culture rich in Lombard and Emilian elements (official Lombardy cultural catalog)"

  - title: "KEY WORKS"
    list:
      - "Tree of Life (Lignum Vitae), c. 1342–1347, fresco, 690 × 360 cm, southern transept wall, Basilica of Santa Maria Maggiore, Bergamo — the defining and name-giving work"
      - "Last Supper, c. 1342–1347, fresco, left transept, Basilica of Santa Maria Maggiore, Bergamo (attributed)"
      - "Trinity, fresco, Sant'Agostino, Bergamo (attributed)"
      - "Frescoes associated with the convent of San Francesco, Bergamo (attributed)"
      - "Frescoes in the church of the Santissima Trinità, Fiobbio, territory of Albino (attributed)"

  - title: "ARTISTIC PROFILE"
    list:
      - "Refined Lombard-Emilian pictorial culture: rooted in the Po Valley tradition of realism and narrative force rather than in mere Tuscan dependence"
      - "Monumental lower register: large, calm, volumetrically solid saints rendered as stable devotional presences"
      - "Narrative upper register: agile, cursive medallion scenes with vivid everyday detail and expressive immediacy"
      - "Textualized pictorial language: inscription and image structurally fused; cartouches quoting Bonaventure are essential to the composition, not decorative"
      - "Memory-mnemonic architecture: the Tree of Life organizes theology, narrative, and inscription into a single ordered visual system for devotional memorization"
      - "Possible regional Giottesque influence, reinterpreted in a Bergamasque-Lombard idiom rather than directly imported from Florence"
      - "Dual working register within the Tree of Life: hypothesized separate phases of c. 1342 and c. 1347, with later a secco additions in the donor zone and seventeenth-century repainting of the inscription"

  - title: "INFLUENCES"
    list:
      - "Bonaventure of Bagnoregio, Lignum Vitae — explicit textual and iconographic source mandated by the patron"
      - "Franciscan devotional culture and the broader tradition of Trecento mendicant piety"
      - "Medieval mnemonic culture and manuscript diagram tradition (arboreal theological diagrams)"
      - "Lombard and Emilian Trecento painting of the Po Valley (primary formal context)"
      - "Broad Giottesque currents, absorbed and re-elaborated within a regional northern Italian idiom"

  - title: "PATRONAGE & CONTEXT"
    pairs:
      - label: "Primary patron"
        value: "Guidino de' Suardi — Bergamasque nobleman who commissioned the Tree of Life and required the painter to follow Bonaventure's Lignum Vitae minutely"
      - label: "Institutional setting"
        value: "Santa Maria Maggiore, Bergamo — the city's civic basilica, hub of lay patronage, devotional display, and communal self-representation in the Trecento"
      - label: "Devotional program"
        value: "Franciscan meditation on the Passion; image-text catechesis designed to imprint sacred history on the memory of the faithful"

  - title: "LINKS"
    links:
      - title: "Basilica of Santa Maria Maggiore, Bergamo"
        url: ""
...
Compared to the narrative tondos above, the figurative language of the lower register is more plastic, more static, and almost sculptural, with saints rendered as stable, authoritative presences rather than as actors in an episode.
The frame also contributes to the effect: on the left and at the bottom, the fresco is enclosed by a decorative band featuring polylobed frames, central flowers, and leaf motifs arranged around a cross.

On the left side of the lower register, one can recognize Saint Clare, Saint Francis, and the Virgin Mary.
St. Francis is particularly significant because he holds a scroll bearing the phrase “EGO STIGMATA DOMINI IESU IN CORPORE MEO PORTO,” which underscores his mystical identification with the suffering Christ and reinforces the Franciscan imprint of the entire iconographic program.
...
This upper section thus belongs to the realm of fulfillment, no longer to mere earthly narration, and concludes the meditative journey conceived by fourteenth-century Franciscanism.
