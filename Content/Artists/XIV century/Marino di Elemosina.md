---
layout: entry
title: "Marino di Elemosina"
subtitle: "Umbrian painter active in Perugia, author of a refined Marian Maestà for the abbey of San Paolo di Valdiponte"
dates: "Documented c. 1309–1313 (fl. early XIV century)"

meta:
  - title: "PERIOD"
    list:
      - "XIV century"
      - "Early Trecento Umbria; transitional phase between Duecento Italo-Byzantine conventions and early Giottesque renewal"

  - title: "ROLE"
    list:
      - "Umbrian panel painter active in Perugia"
      - "Possible miniaturist (debated conflation with the Primo maestro dei corali di San Lorenzo)"
      - "Restorer of painted decorations in the Palazzo dei Priori, Perugia"

  - title: "LOCATION"
    list:
      - "Perugia (only documented city of activity)"
      - "Abbey of San Paolo di Valdiponte, Civitella Benazzone (site of principal commission)"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Unknown; probably Perugia or contado, last decades of the XIII century (no surviving document)"
      - label: "Death"
        value: "Unknown; no obituary or testamentary record has been identified"

  - title: "DOCUMENTARY RECORD"
    pairs:
      - label: "First document"
        value: "c. 1309–1310 — payment for restoration of painted decorations in the Palazzo dei Priori, Perugia"
      - label: "Signature"
        value: "\"Marinus P.\" on the sword of Saint Paul in the Maestà; P. traditionally expanded as Perusinus"
      - label: "Career span"
        value: "Attested c. 1309–1313; archival trail silent thereafter"

  - title: "KEY WORKS"
    list:
      - "Madonna in trono col Bambino tra i santi Paolo, Pietro Celestino e quattro angeli (Maestà), c. 1313, tempera on panel, 151 × 233 cm, Galleria Nazionale dell'Umbria, Palazzo dei Priori, Perugia — original commission for the high altar of San Paolo di Valdiponte"
      - "Restoration of painted decorations, Palazzo dei Priori, Perugia, c. 1310 (not independently extant)"

  - title: "ARTISTIC PROFILE"
    list:
      - "Maestà-type composition balancing residual Byzantine hieraticism with nascent Giottesque plasticity"
      - "Bambino marciante typology for the Christ Child"
      - "Refined chromatic range with gold ground, embroidered red veil, and delicate drapery description"
      - "Expressive heads and careful rendering of liturgical attributes"
      - "Stylistic hybridity: Sienese elegance (Duccio, Meo di Guido) inflected by Cimabue's Assisi frescoes and early Umbrian Giottismo"
      - "Affinity with contemporary Perugian miniature culture in ornamental detail and descriptive treatment of faces"
      - "Described by Treccani as 'less academic, more expressive and descriptive' relative to contemporaries"

  - title: "PATRONS"
    list:
      - "Commune of Perugia — restoration of painted decoration in the Palazzo dei Priori, c. 1310"
      - "Abbey of San Paolo di Valdiponte (later Badia Celestina), Civitella Benazzone — Marian high altarpiece, c. 1313"
      - "Possible connection to the cathedral chapter of San Lorenzo, Perugia (debated)"

  - title: "ARTISTIC INFLUENCES"
    list:
      - "Duccio di Buoninsegna — Madonna dei domenicani for San Domenico, Perugia (Galleria Nazionale dell'Umbria, same room as the Maestà)"
      - "Cimabue — fresco cycles in the Upper Church of San Francesco, Assisi"
      - "Meo di Guido — Montelabate polyptych and Perugian panel paintings"
      - "Giunta Pisano — Italo-Byzantine crucifix tradition across the Umbrian sphere"
      - "Early Giotto — plastic modelling and spatial coherence, mediated through Umbrian followers"
      - "Local Perugian illuminators — miniature tradition (possible dual practice as panel painter and miniaturist)"

  - title: "KEY PHASES"
    list:
      - "Civic employment: restoration work in the Palazzo dei Priori under the commune of Perugia, c. 1309–1310"
      - "Monastic commission: Maestà for the high altar of San Paolo di Valdiponte, c. 1313"
      - "Archival silence thereafter; no further documented works or commissions"

  - title: "THEMATIC KEYWORDS"
    list:
      - "Maestà — Virgin Enthroned with Child"
      - "Bambino marciante"
      - "Umbrian Trecento painting"
      - "Benedictine and Celestine monastic patronage"
      - "Byzantine–Giottesque synthesis"
      - "Civic art in communal Perugia"
      - "Panel painting and miniature culture in central Italy c. 1300"
      - "Saint Peter Celestine — post-canonisation iconography (after 1313)"
---
