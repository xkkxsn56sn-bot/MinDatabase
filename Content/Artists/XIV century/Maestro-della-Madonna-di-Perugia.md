...
meta:
  - title: "PERIOD"
    list:
      - "XIV century — second quarter (c. 1320–1345)"
      - "Early Trecento; transitional between Italo-Byzantine and Giottesque idiom"

  - title: "ROLE"
    list:
      - "Panel painter, Umbrian school"
      - "Specialist in portable devotional images, particularly Marian half-length panels"
      - "Independent workshop master active in Perugia and the wider Umbrian region"

  - title: "LOCATION"
    list:
      - "Perugia, Umbria — principal base of activity"
      - "Probable familiarity with Assisi (Basilica of San Francesco fresco cycles)"
      - "Active within the network of Umbrian communes: Spoleto, Orvieto, Assisi"
      - "Possible exposure to Sienese workshops or Sienese-trained painters"

  - title: "BIRTH & DEATH"
    pairs:
      - label: "Birth"
        value: "Unknown; inferred c. 1290s, possibly in Perugia, Umbria, or Siena"
      - label: "Death"
        value: "Unknown; after c. 1345; possibly during or after the Black Death of 1348"

  - title: "TRAINING & INFLUENCES"
    list:
      - "Giottesque formation — strong structural debt to Giotto's Assisi cycles (Lower Church, San Francesco)"
      - "Sienese refinement — linear elegance, colourism, and ornamental detail descending from Duccio and followers"
      - "Byzantine iconographic heritage — adoption of the Pelagonitissa / Vzygranie Mladentsa Marian type"
      - "Stylistic proximity to Puccio Capanna and Meo da Siena (Christie's attribution essay)"
      - "Possible awareness of the Maestro delle Tempere Francescane (Boskovits); later nuanced by Conti"

  - title: "PATRONAGE"
    pairs:
      - label: "Devotional context"
        value: "Mendicant and lay confraternal milieu of early Trecento Perugia; Franciscan spirituality"
      - label: "Eponymous panel provenance"
        value: "Later housed in a 16th-century tabernacle with shutters of Saints Francis and Clare; Accademia di Belle Arti, Perugia, before entering the Galleria Nazionale dell'Umbria"
      - label: "Broader patronage"
        value: "Portable panels for private devotion, domestic oratories, conventual cells, and confraternal altars"
      - label: "Civic context"
        value: "Communal Perugia; Palazzo dei Priori milieu; Marian imagery as civic identity"

  - title: "KEY WORKS"
    list:
      - "Madonna di Perugia (Virgin and Child playing), c. 1320–1340 — tempera and gold on panel, 32.3 × 23.5 × 3 cm, Galleria Nazionale dell'Umbria, Palazzo dei Priori, Perugia (eponymous work; in situ)"
      - "Four Saints panel (tavoletta) — Vatican collections; attributed by Alessandro Conti; standing saints in slender format"
      - "Von Kaufmann triptych (Crucifixion with saints and Annunciation) — lost / dispersed; attributed by Fabio Todini and Federico Zeri"
      - "Umbrian portable triptych, c. 1335 — stylistically between Puccio Capanna and Meo da Siena; Christie's comparison with von Kaufmann triptych"

  - title: "STYLE"
    list:
      - "Half-length Marian panels with gold ground; Pelagonitissa / Vzygranie Mladentsa iconographic type"
      - "Soft, rounded physiognomies with almond-shaped eyes and small refined mouths conveying contemplative affect"
      - "Deep blues and reds contrasted with delicately hatched flesh tones"
      - "Rhythmically folded drapery synthesising Comnenian and Gothic elements ('Abito del Primo Trecento')"
      - "Precise halo punchwork and jewelled borders; ornamental sophistication at small scale"
      - "Solid, pyramidal figure construction echoing Giottesque monumentality at miniature scale"

  - title: "KEY SCHOLARS"
    list:
      - "Miklós Boskovits — initial stylistic reconstruction of the master's oeuvre; proposed affinities with the Maestro delle Tempere Francescane and Neapolitan connections"
      - "Alessandro Conti — reassessment dismissing 'contorti sentieri napoletani'; situates master within Umbrian and Sienese frame; attributes Vatican tavoletta"
      - "Fabio Todini — attribution of the von Kaufmann triptych to the master"
      - "Federico Zeri — co-attribution of the von Kaufmann triptych"
      - "Victor Lazarev — foundational research on the Byzantine Pelagonitissa / Vzygranie Mladentsa prototypes"
      - "Fabio Zappasodi — analysis of the chin-grasping gesture and its affective and theological significance"

  - title: "RELATED ENTRIES"
    links:
      - title: "Maestro della Maestà delle Volte"
        url: "/Content/Artists/XIV%20century/Maestro%20della%20Maesta%20delle%20Volte.html"
      ...
      - title: "Giuliano da Rimini"
        url: "/Content/Artists/XIII%20century/Giuliano%20da%20Rimini.html"
---
