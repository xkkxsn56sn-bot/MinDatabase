---
layout: entry
title: "Maestro di Cesi (Master of Cesi)"
subtitle: "Anonymous Umbrian painter active in the Spoletan Duchy at the turn of the 14th century"
dates: "Active c. 1290-1320 (core documented point: Cesi dossal, 1308)"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Name"
        value: "Maestro di Cesi (modern conventional designation; anonymous historical personality)"
      - label: "Primary role"
        value: "Painter of panel works and painted crucifixes in southern Umbria"
      - label: "Main cultural orbit"
        value: "Spoleto and the Valnerina (Spoletan Duchy), with formative dependence on Assisi models"
      - label: "Securely dated work"
        value: "Dossal of 1308, Santa Maria Assunta, Cesi"
      - label: "Biographical status"
        value: "No documentary name; profile reconstructed through stylistic and contextual analysis"

  - title: "IDENTITY AND LIMITS"
    list:
      - "Anonymous painter identified by a conventional notname, derived from the dated panel at Cesi"
      - "No known data for personal name, birth, death, workshop lineage, or documented contracts"
      - "Attribution framework built from the 1308 dossal and extended through connoisseurship"
      - "Should not be confused with Bartolomeo Cesi (Bologna, 1556-1629), an unrelated early modern painter"
  ...
  - title: "CHRONOLOGY"
    pairs:
      ...
      - label: "Documentary anchor"
        value: "1308 inscription on the Cesi dossal (with donor Domina Elena)"
      - label: "Core production phase"
        value: "Early Trecento (late Duecento formation to first quarter of the 14th century)"
      - label: "Historical context"
        value: "Post-Cimabue/early-Giotto visual climate in Umbria, with strong Assisi diffusion"

  - title: "ARTISTIC PROFILE"
    list:
      - "Assisi-oriented formation, combining Cimabuesque monumentality with early Giottesque spatial accents"
      - "Persistent archaising current linked to Roman-Cavallinian visual habits"
      - "Hybrid language: conservative iconicity and selective modernizing naturalism"
      - "Strong devotional orientation in commissions tied to female patronage and monastic settings"

  - title: "WORKSHOP AND PRACTICE"
    list:
      - "Likely active within integrated local botteghe where painting and carved polychrome production could overlap"
      - "Panel painting in tempera and gold as principal medium"
      - "Connoisseurial tradition suggests recurring collaboration with sculptural workshop hands"

  - title: "KEY WORKS"
    list:
      - "Dossal, 1308, Santa Maria Assunta, Cesi (Terni)"
      - "Triptych from Santa Maria della Stella (now Musee Marmottan, Paris), c. 1300"
      - "Christus triumphans Crucifix, c. 1300-1324, Museo Nazionale del Ducato, Spoleto"
      - "Madonna and Child enthroned with Saint Augustine and saints (attributed), Galleria Nazionale dell'Umbria, Perugia"

  - title: "PROVENANCE AND RECEPTION"
    list:
      - "Core corpus reconstructed through 20th-century connoisseurship and exhibition history"
      - "Cesi dossal: theft, recovery (1965), return (1968), major restoration campaign (2013)"
      - "Triptych: documented Spoletan origin, 19th-century dispersal, modern re-identification in France"
      - "Attribution history intersects the broader 'question of Assisi' debate"
...
scholars:
  ...
  - title: "Angiola Maria Romanini"
    url: "/scholars.html#romanini-angiola-maria"
  - title: "Bruno Zanardi"
    url: "/scholars.html#zanardi-bruno"
  - title: "Emma Simi Varanelli"
    url: "/scholars.html#simi-varanelli-emma"
  - title: "Federico Zeri"
    url: "/scholars.html#zeri-federico"
  - title: "Giovanni Previtali"
    url: "/scholars.html#previtali-giovanni"
  - title: "Giuseppe Sordini"
    url: "/scholars.html#sordini-giuseppe"
  - title: "Marilyn Aronberg Lavin"
    url: "/scholars.html#lavin-marilyn-aronberg"
  - title: "Millard Meiss"
...
## A note on the name, and on the possibility of a "biography"
...
One further, earlier moment in the panel's public history deserves emphasis, because it is the point at which the modern critical study of the painter effectively began. The dossal was shown at the *Mostra di Antica Arte Umbra*, the great exhibition of early Umbrian art held at Perugia in 1907. It was largely on the basis of that exhibition, and of the photographic campaigns (Alinari and others) that accompanied it, that the first generation of connoisseurs — [Sirén](/scholars.html#siren-osvald), [van Marle](/scholars.html#van-marle-raimond), and their contemporaries — came to grips with the panel and began the long argument about its authorship.
...
A fourth work regularly given to the Maestro di Cesi by [Federico Zeri](/scholars.html#zeri-federico) but recently debated, is preserved in the Galleria Nazionale dell'Umbria at Perugia: a *Madonna and Child enthroned with Saint Augustine and saints*, measuring roughly 95 × 93 cm. Unlike the three works discussed so far, this is not a single large field but an *altarolo portatile* — a small, portable altarpiece composed of numerous compartments, a densely populated object for private or conventual devotion.
