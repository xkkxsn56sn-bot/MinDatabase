...
subtitle: "Carolingian theologian, abbot, archbishop, and creator of the figured poems of De laudibus sanctae crucis"
dates: "Mainz, c. 780 - Mainz, 4 February 856"

meta:
  - title: "CORE DATA"
    pairs:
      - label: "Full name"
        value: "Rhabanus Maurus Magnentius"
      - label: "Primary roles"
        value: "Benedictine monk, theologian, encyclopedist, manuscript author, Archbishop of Mainz"
      - label: "Honorific"
        value: "Praeceptor Germaniae (Teacher of Germany)"
      - label: "Main artistic contribution"
        value: "Integration of text and image in Carolingian carmina figurata"
      - label: "Principal artistic center"
        value: "Fulda scriptorium, with major manuscript witnesses in Vienna and Monte Cassino"
  ...
  - title: "CHRONOLOGY"
    pairs:
      ...
      - label: "Early formation"
        value: "Oblate at Fulda (c. 790-791), later advanced study with Alcuin at Tours"
      - label: "Major masterpiece"
        value: "De laudibus sanctae crucis (c. 813-814; deluxe Vienna witness c. 830-840)"
      - label: "High office"
        value: "Archbishop of Mainz (from 847)"
      - label: "Death"
        value: "4 February 856, Mainz"

  - title: "FAMILY AND SOCIAL BACKGROUND"
    list:
      - "Born to Frankish aristocratic parents Waluran and Waltrat"
      - "Noble background facilitated access to elite Carolingian educational networks"
      - "Family patronage and status supported long-term scholarly and scriptorial formation"

  - title: "PATRONAGE NETWORK"
    list:
      - "Archbishop Otgar of Mainz as major ecclesiastical patron and recipient-context for De laudibus"
      - "Imperial support under Louis the Pious, including politically charged devotional imagery"
      - "Fulda monastic leadership (including Abbot Ratger) as institutional enablers of study and production"
      - "Broader monastic and episcopal demand across the Carolingian world for copies and transmission"

  - title: "ARTISTIC PROFILE"
    list:
      - "Pioneer of figured poetry (carmina figurata) as visual theology"
      - "Complex page design: script grids, layered textual readings, symbolic color programs"
      - "Integration of prose exegesis (declaratio figurae) with visual composition"
      - "Author portrait and donor imagery as part of Carolingian political-theological rhetoric"

  - title: "STYLE AND TECHNIQUE"
    list:
      - "Use of multiple scripts (including uncial and capital forms) for hierarchical visual emphasis"
      - "Precise geometric planning of pages to encode both semantic and symbolic content"
      - "Close coordination of text, image, and material execution in high-status codices"
      - "Strong influence on later medieval manuscript design and devotional reading practices"

  - title: "INTELLECTUAL AND ARTISTIC INFLUENCES"
    list:
      - "Alcuin of York and Carolingian school culture"
      - "Patristic exegesis and biblical allegorical traditions"
      - "Classical pattern-poetry heritage and Carolingian rhetorical training"
      - "Byzantine and Insular visual traditions mediated through monastic book culture"

  - title: "MAJOR WORKS"
    pairs:
      - label: "De laudibus sanctae crucis"
        value: "Twenty-eight figured poems with prose expositions; core work for Carolingian visual-textual synthesis"
      - label: "De universo (De rerum naturis)"
        value: "Encyclopedic compilation with extensive miniature cycles in major manuscript traditions"

  - title: "TRAVELS AND GEOGRAPHIES"
    list:
      - "Study journey to Tours (c. 802-803) for advanced formation"
      - "Pilgrimage to Jerusalem (c. 817) with likely exposure to eastern Christian visual culture"
      - "Administrative and ecclesiastical mobility across the Carolingian Empire as abbot and archbishop"
      - "Transmission footprint from Fulda to major centers including Vienna, Saint Gall, and Monte Cassino"

  - title: "LEGACY"
    list:
      - "Approx. eighty manuscript copies of De laudibus from the ninth to twelfth centuries"
      - "Central figure for the study of Carolingian manuscript page design, theology, and pedagogy"
      - "Enduring impact on the history of medieval book art through text-image integration"
...
scholars:
  - title: "J.-P. Migne"
    url: "/scholars.html#migne-jacques-paul"
  - title: "Michel Perrin"
    url: "/scholars.html#perrin-michel-jean-louis"
  - title: "Bernhard Bischoff"
    url: "/scholars.html#bischoff-bernhard"
  - title: "Rosamond McKitterick"
    url: "/scholars.html#mckitterick-rosamond"
  - title: "Peter Godman"
    url: "/scholars.html#godman-peter"
  - title: "David Ganz"
    url: "/scholars.html#ganz-david-michael"
---
...
Scholarship on Rhabanus Maurus has been built first of all on major editorial traditions that made his texts accessible. The foundational printed corpus remains [J.-P. Migne](/scholars.html#migne-jacques-paul)'s *Patrologia Latina* (especially vols. 107-112 for Rhabanus), still widely consulted for reference despite later critical advances. For the visual-textual poetics of *De laudibus sanctae crucis* (also known as *In honorem sanctae crucis*), studies by [Michel Perrin](/scholars.html#perrin-michel-jean-louis) and subsequent manuscript-based work on the Vienna codex tradition have emphasized how figured poems must be read as designed pages, not merely as transcribed verses. At the same time, codicological and paleographical research in the line of [Bernhard Bischoff](/scholars.html#bischoff-bernhard), especially in *Latin Palaeography: Antiquity and the Middle Ages*, has clarified the scriptorial environment in which Rhabanus's books were produced and copied.

Historical interpretation has been strongly shaped by scholars of Carolingian intellectual and political culture. [Rosamond McKitterick](/scholars.html#mckitterick-rosamond), in works such as *The Carolingians and the Written Word* and *History and Memory in the Carolingian World*, situates Rhabanus within broader programs of reform, textual authority, and institutional memory. More recent scholarship integrates art history, manuscript studies, and theology to reassess Rhabanus as both author and visual strategist. [Peter Godman](/scholars.html#godman-peter) in *Poetry of the Carolingian Renaissance* and *Poets and Emperors: Frankish Politics and Carolingian Poetry* highlights the political-literary dimensions of Carolingian poetic production that frame Rhabanus's figured compositions. Studies of Carolingian book culture by scholars such as [David Ganz](/scholars.html#ganz-david-michael) and catalog-driven manuscript research in Vienna, Fulda, and Monte Cassino have further refined questions of transmission, workshop practice, and reception. The dominant view today is that Rhabanus should be read through a combined lens: editorially grounded in textual traditions, historically located in Carolingian reform networks, and materially interpreted through the manuscript page as a medium of theology, pedagogy, and power.
...
<figure class="figure--right">
  <img src="/Images/Rhabanus/rhabanus-02.jpg" alt="Carmina Figurata">
...
The sophisticated visual differentiation in his manuscripts employed *caroline minuscule*<a href="/endnotes.html#fn-caroline-minuscule" class="footnote"><sup>4</sup></a> for prose explanations while utilizing multiple script styles within the figured poems themselves, creating complex layered meanings. His artistic technique involved the precise arrangement of letters to create visual patterns that functioned simultaneously as text to be read and images to be contemplated, requiring exceptional planning and execution skills. The integration of symbolic colors in his illuminated manuscripts followed theological principles, employing the four colors mentioned in Exodus—hyacinth, purple, linen, and scarlet—to convey spiritual meanings.
...
<figure>
  <img src="/Images/Rhabanus/rhabanus-01.jpg" alt="Rhabanus, Alcuin and Otgar in De Laudibus sanctae crucis">
...
<figure>
  <img src="/Images/Rhabanus/rhabanus-03.jpg" alt="The building of the Tower of Babel - De Universo">
