---
layout: entry
title: "The Maestro di Santa Cecilia and Gaddo Gaddi"
subtitle: "The Question of a Single Identity: historiography, documentary evidence, and the current state of the debate"
dates: "Debate ongoing since the late XIX century; pivotal contributions 1983–2024"

meta:
  - title: "TYPE"
    list:
      - "Scholarly essay — interdisciplinary attribution study"
      - "Historiographical survey of a contested identification in early Florentine painting"

  - title: "SUBJECT"
    list:
      - "Possible identification of the anonymous Maestro di Santa Cecilia with the documented painter Gaddo di Zenobi Gaddi"
      - "Methodological tensions between stylistic reconstruction of anonymous masters and documentary attestation of named historical figures"
      - "Reconstruction of the Florentine artistic milieu around 1300 and its relationship to Giotto's circle"

  - title: "ARTISTS DISCUSSED"
    pairs:
      - label: "Maestro di Santa Cecilia"
        value: "Anonymous Florentine master, notname derived from the Uffizi dossale (inv. 449); active c. 1300–1327; key collaborator in the Assisi Franciscan cycle"
      - label: "Gaddo Gaddi (Gaddo di Zenobi)"
        value: "Documented Florentine painter and mosaicist; progenitor of the Gaddi dynasty; enrolled in Arte dei Medici e Speziali before 1320 and attested to 1327–28; no securely attributed work identified"
      - label: "Taddeo Gaddi"
        value: "Son of Gaddo; principal heir of the Giottesque tradition in mid-Trecento Florence; mentioned in connection with the 1327 guild document"
      - label: "Agnolo Gaddi"
        value: "Grandson of Gaddo; mentioned for the broader implications of the identification for the Gaddi dynasty"
      - label: "Giotto di Bondone"
        value: "Central referent for the stylistic formation and workshop context of both the Maestro and Gaddo"
      - label: "Cimabue"
        value: "Earlier attribution of the Santa Cecilia dossale (Vasari, 1550 ed.); mentioned as a formative influence on Gaddo per Vasari"
      - label: "Bernardo Daddi"
        value: "Florentine contemporary whose early formation reflects key debts to the Maestro di Santa Cecilia"
      - label: "Pietro Cavallini"
        value: "Proposed as an alternative identification by Parronchi (1994); hypothesis not widely accepted"
      - label: "Buonamico Buffalmacco"
        value: "Proposed as identification by Venturi (1907–08) and Sirén (1924); chronologically untenable with current dating"
      - label: "Francesco da Pisa"
        value: "Caleca's (1986) alternative attribution for the Florentine baptistery and cathedral mosaics previously assigned to Gaddo"
      - label: "Filippo Rusuti"
        value: "Documentarily established author of the Santa Maria Maggiore façade mosaics, displacing Vasari's attribution to Gaddo"

  - title: "KEY WORKS DISCUSSED"
    list:
      - "Saint Cecilia Enthroned with Eight Scenes from Her Life (dossale), c. 1300–1304, Uffizi Galleries, Florence (inv. 449) — the namepiece; diagnostic investigations by Opificio delle Pietre Dure revealed earlier underpaint layer"
      - "Franciscan narrative cycle (left wall), Upper Basilica of San Francesco, Assisi — Maestro credited with completion under Giotto's supervision"
      - "Saint Margaret with Scenes from Her Life and Madonna Enthroned, Santa Margherita a Montici, Arcetri, Florence"
      - "Saint Peter Enthroned (dated 1307), formerly San Pier Maggiore, now Santi Simone e Giuda, Florence — the same church where Gaddo is documented in 1327–28"
      - "Saint John the Baptist, Christ Church, Oxford"
      - "Coronation of the Virgin mosaic, lunette above interior entrance, Santa Maria del Fiore, Florence — attributed to Gaddo by Vasari"
      - "Madonna and Child with Two Angels, San Remigio, Florence — assigned to Gaddo by Boskovits (1974–76)"
      - "Three painted crucifixes (Galleria dell'Accademia, Florence; San Stefano at Paterno; Fogg Art Museum, Cambridge MA) — Boskovits's Gaddo group; Fogg Crucifix reassigned to Corso di Buono by Bellosi"

  - title: "DOCUMENTARY SOURCES"
    pairs:
      - label: "1303 document (Bietti Favi 1983)"
        value: "Notarial act dissolving partnership between Pacino di Bonaguida and Tambo di Serraglio — broader context of Florentine guild professional associations"
      - label: "1327/28 document, San Pier Maggiore"
        value: "Payment to 'Gaddo dipintore' for 'braccioli' (armrests) for the altar of San Pietro — the founding archival link between Gaddo and the Maestro's institutional sphere (Bietti Favi 1983)"
      - label: "Arte dei Medici e Speziali immatriculation (pre-1320)"
        value: "Confirms Gaddo's active guild membership by 1320 and disproves Vasari's death date of 1312 (Hueck 1972)"
      - label: "Guild roll 1327 (Dell'Ancisa Spogli)"
        value: "Lists Gaddo and Taddeo in the popolo of San Pier Maggiore — authenticity disputed by Hueck, accepted by Mather"
      - label: "Vasari, Vite (1550 and 1568)"
        value: "Primary biographical source for Gaddo; credits him with wide-ranging mosaic activity in Florence, Rome, Arezzo, and Pisa; most claims substantially rejected by modern scholarship"

  - title: "PRINCIPAL SCHOLARLY CONTRIBUTIONS"
    pairs:
      - label: "Bietti Favi (1983)"
        value: "'Gaddo Gaddi: un'ipotesi,' Arte cristiana — founding documentary argument for the identification; established the Gaddo hypothesis on archival footing"
      - label: "Boskovits (1974, 1976)"
        value: "Proposed Gaddo corpus around Cimabuesque-Gothic works including San Remigio Madonna and three crucifixes; did not endorse identification with Maestro but provided the stylistic comparanda"
      - label: "Hueck (1972)"
        value: "Critical study of Florentine painters' guild records; established immatriculation chronology; raised doubts over the Dell'Ancisa 1327 document"
      - label: "Offner and Steinweg (1984 ed.)"
        value: "Critical corpus attribution of Saint Peter Enthroned to the Maestro di Santa Cecilia"
      - label: "Bellosi (1985)"
        value: "'La pecora di Giotto' — engaging the Maestro di Santa Cecilia with cautious distance from the Gaddo identification; reassigned Fogg Crucifix to Corso di Buono"
      - label: "Caleca (1986)"
        value: "Rejected Gaddo as reliable artistic personality; attributed Florentine mosaics to Francesco da Pisa — the most technically formidable objection to the identification"
      - label: "Longhi (1948)"
        value: "'Giudizio sul Duecento' — isolated a 'Penultimo Maestro' group in Florentine baptistery mosaics, seen by subsequent scholars as a precursor to the Santa Cecilia style"
      - label: "Chiodo, Sonia (2024)"
        value: "'From Giotto's rib: a critical and artistic profile of the Maestro della Santa Cecilia (alias Gaddo Gaddi),' Imagines 10, Uffizi Galleries — most authoritative recent synthesis; parenthetical 'alias Gaddo Gaddi' signals institutional endorsement; integrates new Opificio technical data; shifts scholarly balance decisively toward the identification"
      - label: "Hilling, Anna Marie (2024)"
        value: "Technical article on Opificio delle Pietre Dure non-invasive analyses of the Santa Cecilia panel, Imagines 10 — provides scientific substrate for Chiodo's arguments"

  - title: "COMPETING IDENTIFICATION HYPOTHESES"
    list:
      - "Gaddo Gaddi (Bietti Favi 1983; Chiodo 2024) — currently predominant hypothesis"
      - "Buonamico Buffalmacco (Venturi 1907–08; Sirén 1924) — chronologically untenable with c. 1300 dating of dossale"
      - "Pietro Cavallini (Parronchi 1994) — requires undocumented Florentine activity; stylistic affinities not accepted by specialists"
      - "Stefano Fiorentino (Frey, late XIX c.) — legendary figure; no secure documentary or visual foundation"
      - "Isaac Master / Gaddo (Mather 1932) — would place Gaddo at summit of early Florentine painting; not accepted in current literature"
      - "Maestro del Trittico Horne — most recent alternative hypothesis (Italian Wikipedia summary); identified as early Giotto follower"

  - title: "ARGUMENTS FOR THE IDENTIFICATION"
    list:
      - "1327/28 document links 'Gaddo dipintore' to San Pier Maggiore — the same church associated with the Maestro's Saint Peter Enthroned (1307)"
      - "Gaddo's documented activity well into the 1320s is chronologically consistent with the Maestro's reconstructed career"
      - "Stylistic affinities between the Boskovits Gaddo group and the Maestro: shared Cimabuesque formation, openness to Giottesque spatial innovation, ornamental surface interest"
      - "Possible shared participation in the Assisi frescoes: Crowe and Cavalcaselle detected Gaddo's hand in the stripping-of-Francis scene"
      - "Mosaic origins plausibly account for certain surface and ornamental qualities in the Santa Cecilia dossale noted by Venturi and Toesca"
      - "Vasari's death date of 1312 disproved by guild records, removing the principal chronological obstacle"
      - "Opificio analysis reveals earlier underpaint layer, pushing the panel's dating toward c. 1300 and extending the master's career range"
      - "Institutional endorsement: Uffizi Galleries, Sonia Chiodo (2024), Imagines 10"

  - title: "ARGUMENTS AGAINST THE IDENTIFICATION"
    list:
      - "No documentarily attested work by Gaddo Gaddi exists as a fixed stylistic reference point — the identification cannot be verified by the most reliable method"
      - "The two categories conflated — formal personality (Maestro) and historical identity (Gaddo) — are epistemologically distinct"
      - "Caleca (1986) reassigned Florentine mosaics to Francesco da Pisa, undermining the mosaic-based stylistic bridge"
      - "Vasari presents Gaddo primarily as mosaicist and Roman figure; the Maestro is reconstructed almost entirely as panel painter and fresco artist"
      - "Hueck's scepticism about the Dell'Ancisa 1327 document weakens the chronological framework"
      - "Fogg Crucifix (Boskovits Gaddo group) reassigned by Bellosi to Corso di Buono, reducing the Gaddo stylistic comparanda"
      - "Forty-plus years of debate since Bietti Favi (1983) without consensus is itself a sign that the evidence falls short of certainty"

  - title: "THEMATIC KEYWORDS"
    list:
      - "Anonymous masters and notnames in medieval art history"
      - "Connoisseurship and attribution methodology"
      - "Early Florentine Trecento painting"
      - "Giotto's circle and workshop"
      - "Franciscan narrative cycle, Assisi"
      - "Mosaic tradition and panel painting"
      - "Gaddi dynasty"
      - "Arte dei Medici e Speziali guild records"
      - "Technical examination and underpaint analysis"
      - "Vasarian hagiography and its limits"
...
role: "Interdisciplinary attribution study surveying the identification of the Maestro di Santa Cecilia with Gaddo Gaddi"
