...
meta:
  - title: "IDENTITY"
    pairs:
      - label: "Full dedication"
        value: "Santa Maria Assunta (Assumption of the Virgin)"
      - label: "Building type"
        value: "Cathedral basilica; mother church of the Diocese of Spoleto-Norcia"
      - label: "Liturgical status"
        value: "Active cathedral; episcopal see of Spoleto"

  - title: "PERIOD"
    list:
      - "XII century (Romanesque fabric)"
      - "XIII century (consecration and façade completion)"
      - "XV–XVII century (Renaissance portico, Lippi frescoes, Baroque remodelling)"

  - title: "CHRONOLOGY"
    pairs:
      - label: "Romanesque rebuilding"
        value: "Begun ca. 1175, after Frederick Barbarossa's destruction of the earlier cathedral (1155)"
      - label: "Consecrations"
        value: "Innocent III, 1198; solemn dedication under Honorius III, ca. 1207–1227"
      - label: "Façade mosaic"
        value: "Solsternus, 1207"
      - label: "Renaissance portico"
        value: "Ambrogio Barocci and collaborators, 1491–1504"
      - label: "Apse frescoes"
        value: "Filippo Lippi and workshop, ca. 1466–1469"
      - label: "Baroque remodelling"
        value: "Promoted by Urban VIII and Cardinal Francesco Barberini, XVII century"
      - label: "Late side-aisle pavement"
        value: "Matteo Rosso Balsimelli of Settignano, 1481"

  - title: "LOCATION"
    list:
      - "Piazza del Duomo, Spoleto, Umbria, Italy"
      - "Terraced platform at the foot of Colle Sant'Elia"
      - "Adjacent complex: bishop's palace, Sant'Eufemia, Diocesan Museum"

  - title: "ARCHITECTURE"
    pairs:
      - label: "Plan"
        value: "Latin cross with nave, two aisles, and transept"
      - label: "Style"
        value: "Romanesque (fabric); Renaissance (portico); Baroque (interior remodelling)"
      - label: "Façade"
        value: "Gabled, white and pink stone; three horizontal bands; multiple rose windows; ogival niches; central mosaic; Renaissance loggia at base"
      - label: "Bell tower"
        value: "Square tower built largely from spolia incorporating Roman and early medieval inscriptions"
      - label: "Interior pavement"
        value: "Cosmatesque nave floor (stone, porphyry, serpentine inlays); side-aisle lozenges, 1481"

  - title: "KEY ARTISTS AND WORKS"
    list:
      - "Solsternus — façade mosaic (Deësis: Christ, Virgin, Saint John), 1207 (in situ)"
      - "Alberto Sozio — painted Crucifix (Christus triumphans), 1187 (Diocesan Museum / cathedral complex)"
      - "Filippo Lippi and workshop (Fra Diamante, Filippino Lippi) — apse frescoes: Life of the Virgin (Coronation, Annunciation, Dormition, Nativity), 1466–1469 (in situ)"
      - "Pinturicchio — Eroli Chapel frescoes, 1497 (in situ)"
      - "Annibale Carracci — altarpiece, Madonna and Child with Saints Francis and Dorothea, late XVI century (in situ)"
      - "Byzantine icon (Haghiosoritissa type), XI–XII century — traditional gift of Barbarossa, 1185 (cathedral treasury)"
      - "Autograph letter of Saint Francis to Brother Leo (relics chapel)"

  - title: "PATRONAGE"
    list:
      - "Episcopal chapter of Spoleto (principal building patron)"
      - "Pope Innocent III (consecration, 1198)"
      - "Pope Honorius III (solemn dedication)"
      - "Frederick Barbarossa (donated Byzantine icon, 1185)"
      - "Pope Urban VIII and Cardinal Francesco Barberini (Baroque remodelling, XVII century)"
      - "Lorenzo de' Medici (commissioned Lippi's tomb, designed by Filippino)"

  - title: "STYLE"
    list:
      - "Central Italian Romanesque — regular ashlar in white and pink stone; flat planar façade with dense ornamental programme"
      - "Byzantine influence: Deësis mosaic; Haghiosoritissa icon; Cosmatesque pavement"
      - "Renaissance classicism: Barocci portico with pulpit balconies (1491–1504)"
      - "Florentine Quattrocento: Lippi's apse frescoes in buon fresco"
      - "Baroque interior: Barberini remodelling and Valadier high altar"
...
<figure>
  <img src="/Images/Spoleto-Cathedral/spoleto-cathedral-01.jpg" alt="Holy Icon">
